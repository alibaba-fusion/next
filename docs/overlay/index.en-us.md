...
| addKeyDownEventOnWrapper | close dialog by esc listener add on wrapper instead of document.body                                                                                                                                                                                          | Boolean             | false                                                                             |          |
| closeByOutSideClickEvents | custom canCloseByOutSideClick trigger events                                                                                                                                                                                      | Array             | ['click', 'touchend']                                                                             |          |
