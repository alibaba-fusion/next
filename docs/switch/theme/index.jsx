        ...
        return (
            <Demo title="Normal" demoFunction={demoFunction} onFunctionChange={this.onFunctionChange}>
                <Demo title="Normal">
                    ...
                    <DemoGroup label="Loading & Disabled Off">
                        <Switch checked={false} loading disabled {...props} />
                        <Switch checked={false} loading {...props} disabled size="small" />
                    </DemoGroup>
                    <DemoGroup label="On">
                    ...
                    <DemoGroup label="Disabled On  & Loading">
                        <Switch checked disabled loading {...props} />
                        <Switch checked disabled loading {...props} size="small" />
                    </DemoGroup>
                </Demo>
            </Demo>
        );
