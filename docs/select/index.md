...
| maxTagTextLength      | tag最多显示的字符数                                                                                                                                                                                                                                               | Number                                 | -                                             |
| maxTagCount           | 最多显示多少个 tag                                                                                                                                                                                                                                               | Number                                 | -                                             |
| maxTagPlaceholder     | 隐藏多余 tag 时显示的内容，在 maxTagCount 生效时起作用<br><br>**签名**:<br>Function() => void                                                                                                                                                                                 | Function                               | (selected, total) => `${selected} / ${total}` |
