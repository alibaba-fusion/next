...
const defaultTrigger = <Button className="btrigger" style={{margin: '5px'}}>Align Edge / 边缘对齐</Button>;
...
const Demo = () => (
    <div className="container">
        <Tooltip v2 trigger={defaultTrigger} align="bl" arrowPointToCenter={false}>
            Tooltip Tooltip
        </Tooltip>
