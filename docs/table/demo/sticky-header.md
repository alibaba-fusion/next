...
class App extends React.Component {
    ...
    render() {
        return (<div>
            ...
            <br />
            <div id="abc" style={{height: 300, background: 'purple', padding: 20, width: '100%', overflow: 'auto'}}>
                <Table affixProps={{container: this.state.container}} dataSource={this.state.dataSource} fixedHeader stickyHeader>
