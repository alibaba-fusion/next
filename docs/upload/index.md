...
| onError         | 可选参数，上传失败回调函数，参数为上传失败的信息、响应信息以及文件<br><br>**签名**:<br>Function(error: Object, xhr: Object, file: Object) => void<br>**参数**:<br>_error_: {Object} 错误信息<br>_xhr_: {Object} 请求对象<br>_file_: {Object} 文件                                            | Function        | func.noop |
