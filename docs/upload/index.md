...
| accept            | 接受上传的文件类型 (image/png, image/jpg, .doc, .ppt) 详见 <a href="https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/Input#attr-accept" target="_blank">input accept attribute</a>                                                                                                    | String          | -         |      |
...
| previewOnFileName | 点击文件名时触发 onPreview                                                                                                                                                                                                                                       | Boolean         | false     | 1.24 |
...
| itemRender   | 自定义成功和失败的列表渲染方式<br/><br/>**签名**:<br/>Function(file: File, obj: Object) => void<br/>**参数**:<br/>_file_: {File} 文件对象<br/>_obj_: {Object} {remove: 删除回调} | Function | -         | 1.21 |
