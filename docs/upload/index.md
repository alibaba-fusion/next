...
| beforeUpload    | 可选参数, 详见 [beforeUpload](#beforeUpload)<br><br>**签名**:<br>Function(file: Object, options: Object) => Boolean/Object/Promise<br>**参数**:<br>_file_: {Object} null<br>_options_: {Object} null<br>**返回值**:<br>{Boolean/Object/Promise} 返回值作用见demo<br> | Function        | func.noop |
