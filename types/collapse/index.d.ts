...
declare const CollapseWithPanel: import('../config-provider/types').ConfiguredComponentClass<
    ...
    {}
> & {
    Panel: import('../config-provider/types').ConfiguredComponentClass<
        PanelProps & import('../config-provider/types').ComponentCommonProps,
        {
