...
export default function ShellBase(props: { componentName?: string }): {
    new (props: ShellBaseProps): {
        ...
        context: any;
        setState<K extends keyof ShellState>(
            state:
                | ShellState
                | ((
                      prevState: Readonly<ShellState>,
                      props: Readonly<ShellBaseProps>
                  ) => ShellState | Pick<ShellState, K> | null)
                | Pick<ShellState, K>
                | null,
            callback?: (() => void) | undefined
        ): void;
        forceUpdate(callback?: (() => void) | undefined): void;
        readonly props: Readonly<ShellBaseProps> &
            Readonly<{
        ...
        shouldComponentUpdate?(
            ...
            nextState: Readonly<ShellState>,
            nextContext: any
        ): boolean;
        componentWillUnmount?(): void;
        componentDidCatch?(error: Error, errorInfo: React.ErrorInfo): void;
        getSnapshotBeforeUpdate?(
            prevProps: Readonly<ShellBaseProps>,
            prevState: Readonly<ShellState>
        ): any;
