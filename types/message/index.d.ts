...
declare const MessageProvider: import('../config-provider/types').ConfiguredComponentClass<
    import('./types').MessageProps & import('../config-provider/types').ComponentCommonProps,
        ...
        import('./types').MessageProps & import('../config-provider/types').ComponentCommonProps,
        {
            ...
            setState<K extends never>(
                state:
                    ...
                    | ((
                          prevState: Readonly<{}>,
                          props: Readonly<import('./types').MessageProps>
                      ) => {} | Pick<{}, K> | null)
                    | Pick<{}, K>
                    | null,
            ...
            readonly props: Readonly<import('./types').MessageProps> &
                Readonly<{
            ...
            shouldComponentUpdate?(
                nextProps: Readonly<import('./types').MessageProps>,
                nextState: Readonly<{}>,
                nextContext: any
            ): boolean;
            ...
            getSnapshotBeforeUpdate?(
                prevProps: Readonly<import('./types').MessageProps>,
                prevState: Readonly<{}>
            ): any;
            componentDidUpdate?(
                prevProps: Readonly<import('./types').MessageProps>,
...
> & {
    ...
    destory: () => void;
    withContext: <P extends import('./toast').WithContextMessageProps, C>(
        WrappedComponent: import('react').JSXElementConstructor<P> & C
    ) => (
        props: JSX.LibraryManagedAttributes<C, Omit<P, 'contextMessage'>>
