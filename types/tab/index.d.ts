...
declare const _default: import('../config-provider/types').ConfiguredComponentClass<
    TabProps & import('../config-provider/types').ComponentCommonProps,
    {
        ...
        context: any;
        setState<K extends 'activeKey'>(
            state:
                | import('./tab').TabState
                | ((
                      prevState: Readonly<import('./tab').TabState>,
                      props: Readonly<TabProps>
                  ) => import('./tab').TabState | Pick<import('./tab').TabState, K> | null)
                | Pick<import('./tab').TabState, K>
                | null,
            callback?: (() => void) | undefined
        ): void;
        forceUpdate(callback?: (() => void) | undefined): void;
        readonly props: Readonly<TabProps> &
            Readonly<{
        ...
        shouldComponentUpdate?(
            nextProps: Readonly<TabProps>,
            nextState: Readonly<import('./tab').TabState>,
            nextContext: any
        ): boolean;
        componentWillUnmount?(): void;
        componentDidCatch?(error: Error, errorInfo: import('react').ErrorInfo): void;
        getSnapshotBeforeUpdate?(
            prevProps: Readonly<TabProps>,
            prevState: Readonly<import('./tab').TabState>
        ): any;
...
> & {
    Item: {
        new (
            props: import('../tab/types').ItemProps | Readonly<import('../tab/types').ItemProps>
        ): {
            _actived: boolean;
            ...
            setState<K_1 extends never>(
                state:
                    ...
                    | ((
                          prevState: Readonly<{}>,
                          props: Readonly<import('../tab/types').ItemProps>
                      ) => {} | Pick<{}, K_1> | null)
                    | Pick<{}, K_1>
                    | null,
                callback?: (() => void) | undefined
            ...
            componentDidMount?(): void;
            shouldComponentUpdate?(
                nextProps: Readonly<import('../tab/types').ItemProps>,
                nextState: Readonly<{}>,
                nextContext: any
            ): boolean;
            componentWillUnmount?(): void;
            componentDidCatch?(error: Error, errorInfo: import('react').ErrorInfo): void;
            getSnapshotBeforeUpdate?(
                prevProps: Readonly<import('../tab/types').ItemProps>,
                prevState: Readonly<{}>
            ): any;
            componentDidUpdate?(
                prevProps: Readonly<import('../tab/types').ItemProps>,
        ...
        new (
            props: import('../tab/types').ItemProps,
            context: any
        ): {
            _actived: boolean;
            readonly props: import('../tab/types').TabItemProps;
    ...
    TabPane: import('../config-provider/types').ConfiguredComponentClass<
        import('../tab/types').ItemProps & import('../config-provider/types').ComponentCommonProps,
        {
            _actived: boolean;
            readonly props: import('../tab/types').TabItemProps;
            render(): import('react').JSX.Element | null;
