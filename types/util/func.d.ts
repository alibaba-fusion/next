...
export declare function makeChain<
    F extends
        | AnyFunction
        | {
              apply?: AnyFunction;
...
export declare function promiseCall<Value>(
    ret: Promise<Value>,
    success: (value: Value) => void,
    failure?: (reason: unknown) => void
): Promise<Value>;
export declare function promiseCall<SuccessResult = unknown, FailureResult = unknown>(
    ret: false,
    success: (data: false) => SuccessResult,
    failure?: (reason: false) => FailureResult
): FailureResult;
export declare function promiseCall<
    Value = unknown,
 ...
 */
export declare function invoke<Result = unknown>(
    target: unknown,
    method: string,
    args?: unknown[]
): Result | undefined;
export declare function renderNode<Result = unknown>(
 ...
 */
export declare function checkRangeDate(
 ...
 * 字符型日期转为dayjs类型
 */
export declare function getValueWithDayjs(
 ...
 */
export declare function checkValueWithDayjs(val: ConfigType, format: OptionType): Dayjs | null;
