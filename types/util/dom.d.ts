...
export declare function getStyle<K extends string>(
    node: HTMLElement,
    name: LikeCustomCSSStyleKey<K>
): string | number;
export declare function setStyle(node: undefined | null, name: unknown): false;
export declare function setStyle<K extends Record<string, unknown>>(
    node: HTMLElement,
    name: K & LikeCustomCSSStyle<K>
): void;
export declare function setStyle<K extends string>(
    node: HTMLElement,
    name: LikeCustomCSSStyleKey<K>,
    value: unknown
): void;
