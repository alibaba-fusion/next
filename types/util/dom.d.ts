...
export declare function getStyle<K extends CustomCSSStyleKey>(
    node: HTMLElement,
    name: K
): string | number;
export declare function setStyle(node: undefined | null, name: unknown): false;
export declare function setStyle(node: HTMLElement, name: Partial<CustomCSSStyle>): void;
export declare function setStyle(node: HTMLElement, name: CustomCSSStyleKey, value: unknown): void;
 ...
 * @returns parent
 */
export declare function getMatches(
    dom: Element | undefined | null,
    selector: string
): boolean | null;
/**
 ...
 * @returns parent
 */
export declare function getClosest(
    dom: HTMLElement | undefined | null,
    selector: string
): Element | null;
export declare function saveRef(
    ref:
        | string
        | ((ins: any) => any)
        | {
