 ...
 */
export declare function pickProps<P extends Record<string, unknown>>(
 ...
 */
export declare function pickAttrsWith<P extends Record<string, unknown>>(
    holdProps: P,
    prefix: string
): Partial<P>;
/**
...
export declare function isReactFragment(component: { type: typeof React.Fragment }): true;
