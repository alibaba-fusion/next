...
declare const _default: import('../config-provider/types').ConfiguredComponentClass<
    import('./types').TimePickerProps & import('../config-provider/types').ComponentCommonProps,
    {
        inputAsString: boolean;
        readonly props: Readonly<
            import('../util').RequiredSome<
                import('./types').TimePickerProps,
                | 'size'
                | 'rtl'
                | 'disabled'
                | 'format'
        ...
        onInputChange: (
            inputValue: string,
            e?: import('react').SyntheticEvent<Element, Event> | undefined,
        ...
        context: any;
        setState<K extends keyof import('./types').TimePickerState>(
            state:
                | import('./types').TimePickerState
                | ((
                      prevState: Readonly<import('./types').TimePickerState>,
                      props: Readonly<import('./types').TimePickerProps>
                  ) =>
                      | import('./types').TimePickerState
                      | Pick<import('./types').TimePickerState, K>
                      | null)
                | Pick<import('./types').TimePickerState, K>
                | null,
        ...
        shouldComponentUpdate?(
            nextProps: Readonly<import('./types').TimePickerProps>,
        ...
        getSnapshotBeforeUpdate?(
            prevProps: Readonly<import('./types').TimePickerProps>,
            prevState: Readonly<import('./types').TimePickerState>
        ): any;
        componentDidUpdate?(
            prevProps: Readonly<import('./types').TimePickerProps>,
