    ...
    Text: {
        new (
            ...
            TextProps & import('../config-provider/types').ComponentCommonProps,
            {
                ...
                readonly props: Readonly<TextProps> &
                    Readonly<{
                        children?: import('react').ReactNode;
                    }>;
                state: Readonly<{}>;
    ...
    Paragraph: {
        new (
            ...
            ParagraphProps & import('../config-provider/types').ComponentCommonProps,
            {
                ...
                forceUpdate(callback?: (() => void) | undefined): void;
                readonly props: Readonly<ParagraphProps> &
                    Readonly<{
                        children?: import('react').ReactNode;
                    }>;
                state: Readonly<{}>;
                ...
                componentDidMount?(): void;
                shouldComponentUpdate?(
                    nextProps: Readonly<ParagraphProps>,
                    nextState: Readonly<{}>,
                    nextContext: any
                ): boolean;
                componentWillUnmount?(): void;
                componentDidCatch?(error: Error, errorInfo: import('react').ErrorInfo): void;
                getSnapshotBeforeUpdate?(
                    prevProps: Readonly<ParagraphProps>,
                    prevState: Readonly<{}>
                ): any;
                componentDidUpdate?(
                    prevProps: Readonly<ParagraphProps>,
