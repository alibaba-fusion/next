    ...
    import('./types').CascaderSelectProps & import('../config-provider/types').ComponentCommonProps,
    {
        ...
        > &
            Pick<
                ...
                'setFocusValue'
            >;
        popup: import('../config-provider/types').ConfiguredComponent<
            import('../overlay').PopupProps &
                import('../config-provider/types').ComponentCommonProps,
            {
                overlay: {
                    ...
                    gatewayRef: {
                        ...
                        context: any;
                        setState<K_2 extends 'containerNode'>(
                            state:
                                ...
                                | ((
                                      ...
                                      | import('../overlay/types').GatewayState
                                      | Pick<import('../overlay/types').GatewayState, K_2>
                                      | null)
                                | Pick<import('../overlay/types').GatewayState, K_2>
                                | null,
                            callback?: (() => void) | undefined
                    ...
                    render(): import('react').JSX.Element;
                    context: any;
                    setState<K_3 extends keyof import('../overlay/types').OverlayState>(
                        state:
                            ...
                            | ((
                                  ...
                                  | import('../overlay/types').OverlayState
                                  | Pick<import('../overlay/types').OverlayState, K_3>
                                  | null)
                            | Pick<import('../overlay/types').OverlayState, K_3>
                            | null,
                        callback?: (() => void) | undefined
                        ...
                        setState<K_4 extends 'visible'>(
                            state:
                                ...
                                | ((
                                      ...
                                      | import('../overlay/types').PopupState
                                      | Pick<import('../overlay/types').PopupState, K_4>
                                      | null)
                                | Pick<import('../overlay/types').PopupState, K_4>
                                | null,
                            callback?: (() => void) | undefined
                        ...
                        ref: {
                            ...
                            overlay: {
                                ...
                                getAnimation(
                                    ...
                                    | string
                                    | boolean
                                    | import('../overlay/types').AnimationObjectType;
                                getAnimationByAlign(
                                    align: string | boolean | string[] | undefined
                                ): {
                                    in: string;
                                    out: string;
                                };
                                ...
                                setState<K_3 extends keyof import('../overlay/types').OverlayState>(
                                    state:
                                        ...
                                        | ((
                                              ...
                                              >,
                                              props: Readonly<
                                                  import('../overlay/types').OverlayV1Props
                                              >
                                          ) =>
                                              | import('../overlay/types').OverlayState
                                              | Pick<import('../overlay/types').OverlayState, K_3>
                        ...
                        saveRef(
                            ref: {
                                ...
                                overlay: {
                                    ...
                                    context: any;
                                    setState<
                                        K_3 extends keyof import('../overlay/types').OverlayState,
                                    >(
                                        state:
                                            | import('../overlay/types').OverlayState
                                            | ((
        ...
        render(): import('react').JSX.Element;
        context: any;
        setState<K_6 extends keyof import('./types').CascaderSelectState>(
            state:
                ...
                | ((
                      ...
                      | import('./types').CascaderSelectState
                      | Pick<import('./types').CascaderSelectState, K_6>
                      | null)
                | Pick<import('./types').CascaderSelectState, K_6>
                | null,
            callback?: (() => void) | undefined
                            ...
                            saveRef(
                                ref: {
                                    ...
                                    overlay: {
                                        ...
                                        setState<
                                            K_3 extends
                                                keyof import('../overlay/types').OverlayState,
                                        >(
                                            state:
                                                | import('../overlay/types').OverlayState
                                                | ((
