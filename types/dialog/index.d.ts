...
declare class Dialog extends React.Component<DialogProps> {
    ...
    static withContext: <P extends import('./show').WithContextDialogProps, C>(
...
declare const _default: import('../config-provider/types').ConfiguredComponentClass<
    DialogProps & import('../config-provider/types').ComponentCommonProps,
    Dialog,
    {}
> & {
    ...
    withContext: <P extends import('./show').WithContextDialogProps, C>(
        WrappedComponent: React.JSXElementConstructor<P> & C
    ) => (props: JSX.LibraryManagedAttributes<C, Omit<P, 'contextDialog'>>) => React.JSX.Element;
};
