...
export interface CloseableProps extends TagProps {
    /**
...
export interface SelectableProps extends TagProps {
    /**
     * 标签是否被选中，受控用法
...
export interface TagGroupProps extends React.HTMLAttributes<HTMLElement> {
    prefix?: string;
    rtl?: boolean;
}
