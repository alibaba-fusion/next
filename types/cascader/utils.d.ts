 ...
 */
export declare function forEachEnableNode(
 ...
 */
export declare function getCheckableParentNode(
    node: CascaderDataItemWithPosInfo,
    _p2n: P2n
): false | CascaderDataItemWithPosInfo;
/**
 * 过滤子节点的值
 * @param values - 子节点的值
 * @param _v2n - 节点信息
 ...
 * @returns 所有选中的值
 */
export declare function getAllCheckedValues(
