    ...
    AutoCompleteProps & import('../config-provider/types').ComponentCommonProps,
    {
        ...
        saveInputRef: (
            ref: import('../config-provider/types').ConfiguredComponent<
                InputProps & import('../config-provider/types').ComponentCommonProps,
                import('../input/input').default<InputProps>
            > &
                Pick<import('../input/input').default<InputProps>, 'focus' | 'getInputNode'>
        ) => void;
        focusInput(): void;
