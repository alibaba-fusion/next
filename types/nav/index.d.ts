...
declare const NavWithSubComponent: import('../config-provider/types').ConfiguredComponentClass<
    NavProps & import('../config-provider/types').ComponentCommonProps,
    {
        menu: Menu | null;
        getChildContext(): {
        ...
        getMenuRef: import('react').LegacyRef<Menu>;
        render(): import('react').JSX.Element;
        context: any;
        setState<K extends never>(
            state:
                | {}
                | ((prevState: Readonly<{}>, props: Readonly<NavProps>) => {} | Pick<{}, K> | null)
                | Pick<{}, K>
                | null,
