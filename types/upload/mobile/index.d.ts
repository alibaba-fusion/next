...
declare const Upload: import('../../config-provider/types').ConfiguredComponentClass<
...
> & {
    Card: import('../../config-provider/types').ConfiguredComponentClass<
        import('../types').CardProps & import('../../config-provider/types').ComponentCommonProps,
        {
            ...
            setState<K_1 extends keyof import('../types').CardState>(
                state:
                    ...
                    | ((
                          ...
                          props: Readonly<import('../types').CardProps>
                      ) =>
                          | import('../types').CardState
            ...
            forceUpdate(callback?: (() => void) | undefined): void;
            readonly props: Readonly<import('../types').CardProps> &
                Readonly<{
                    children?: import('react').ReactNode;
                }>;
            ...
            shouldComponentUpdate?(
                nextProps: Readonly<import('../types').CardProps>,
            ...
            componentDidCatch?(error: Error, errorInfo: import('react').ErrorInfo): void;
            getSnapshotBeforeUpdate?(
                prevProps: Readonly<import('../types').CardProps>,
                prevState: Readonly<import('../types').CardState>
            ): any;
            componentWillMount?(): void;
            UNSAFE_componentWillMount?(): void;
    ...
    List: import('../../config-provider/types').ConfiguredComponentClass<
        import('../types').ListProps & import('../../config-provider/types').ComponentCommonProps,
        {
            ...
            onSelect: (
                oldfile: import('../types').UploadFile,
        ...
        new (props: import('../types').CoreProps): {
            ...
            setState<K_3 extends never>(
                state:
                    ...
                    | ((
                          prevState: Readonly<{}>,
                          props: Readonly<import('../types').CoreProps>
                      ) => {} | Pick<{}, K_3> | null)
                    | Pick<{}, K_3>
                    | null,
                callback?: (() => void) | undefined
            ...
            forceUpdate(callback?: (() => void) | undefined): void;
            readonly props: Readonly<import('../types').CoreProps> &
                Readonly<{
                    children?: import('react').ReactNode;
                }>;
            state: Readonly<{}>;
            ...
            componentDidMount?(): void;
            shouldComponentUpdate?(
                nextProps: Readonly<import('../types').CoreProps>,
                nextState: Readonly<{}>,
                nextContext: any
            ): boolean;
            componentWillUnmount?(): void;
            componentDidCatch?(error: Error, errorInfo: import('react').ErrorInfo): void;
            getSnapshotBeforeUpdate?(
                prevProps: Readonly<import('../types').CoreProps>,
                prevState: Readonly<{}>
            ): any;
            componentDidUpdate?(
                prevProps: Readonly<import('../types').CoreProps>,
