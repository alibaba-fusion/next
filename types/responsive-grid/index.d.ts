...
declare class ResponsiveGrid extends Component<ResponsiveGridProps> {
    ...
    static Cell: import('../config-provider/types').ConfiguredComponentClass<
        CellProps & import('../config-provider/types').ComponentCommonProps,
        {
            ...
            readonly props: Readonly<CellProps> &
                Readonly<{
...
declare const _default: import('../config-provider/types').ConfiguredComponentClass<
    ResponsiveGridProps & import('../config-provider/types').ComponentCommonProps,
    ResponsiveGrid,
    {}
> & {
    _typeMark: string;
    Cell: import('../config-provider/types').ConfiguredComponentClass<
        CellProps & import('../config-provider/types').ComponentCommonProps,
        {
            render(): React.JSX.Element;
            context: any;
