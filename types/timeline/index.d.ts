...
declare const TimelineWithItem: import('../config-provider/types').ConfiguredComponentClass<
    import('./types').TimelineProps & import('../config-provider/types').ComponentCommonProps,
    {
        toggleFold(folderIndex: number, total: number): void;
        render(): import('react').JSX.Element;
        context: any;
        setState<K extends keyof import('./types').TimelineState>(
            state:
                | import('./types').TimelineState
                | ((
                      prevState: Readonly<import('./types').TimelineState>,
                      props: Readonly<import('./types').TimelineProps>
                  ) =>
                      | import('./types').TimelineState
                      | Pick<import('./types').TimelineState, K>
                      | null)
                | Pick<import('./types').TimelineState, K>
                | null,
        ...
        readonly props: Readonly<import('./types').TimelineProps> &
            Readonly<{
        ...
        shouldComponentUpdate?(
            nextProps: Readonly<import('./types').TimelineProps>,
            nextState: Readonly<import('./types').TimelineState>,
            nextContext: any
        ): boolean;
        componentWillUnmount?(): void;
        componentDidCatch?(error: Error, errorInfo: import('react').ErrorInfo): void;
        getSnapshotBeforeUpdate?(
            prevProps: Readonly<import('./types').TimelineProps>,
            prevState: Readonly<import('./types').TimelineState>
        ): any;
        componentDidUpdate?(
            prevProps: Readonly<import('./types').TimelineProps>,
