...
>(
    Component: C,
    options?: ConfigOptions<ComponentPropsWithoutRef<C>, K>
): ConfiguredComponentClass<
    React.ComponentPropsWithoutRef<C> & ComponentCommonProps,
    React.ComponentRef<C> extends never ? undefined : React.ComponentRef<C>,
    NonBlank<Pick<React.ComponentRef<C>, K>>
> &
    NonReactStatics<C>;
export { config };
