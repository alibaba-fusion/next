...
declare const _default: import('../config-provider/types').ConfiguredComponentClass<
    import('./types').RangeProps & import('../config-provider/types').ComponentCommonProps,
    {
        _moving: {
            start: number;
            end: number;
        ...
        > &
                ...
                Pick<
                    {
                        ...
                        onProcess: () => void;
                        tipRender: (
                            value: import('./types').RangeValueType
                        ) => import('./types').RangeValueType;
                        reverse: boolean;
                        pure: boolean;
            ...
            >;
        _marksToScales(
            marks: number | false | number[] | Record<number, string>
        ): number | false | number[];
        _calcScales(): number[];
        ...
        _end(): void;
        _move(
            e: import('react').MouseEvent<Element, MouseEvent> | import('react').TouchEvent<Element>
        ): void;
        ...
        _currentToValue(
            ...
            lastPosition: number,
            isFixedWidth: boolean
        ): import('./types').RangeValueType | undefined;
        handleLowerTooltipVisibleChange(visible: boolean): void;
        handleUpperTooltipVisibleChange(visible: boolean): void;
        render(): import('react').JSX.Element;
        context: any;
        setState<K extends keyof import('./types').RangeState>(
            state:
                | import('./types').RangeState
                | ((
                      prevState: Readonly<import('./types').RangeState>,
                      props: Readonly<import('./types').RangeProps>
                  ) => import('./types').RangeState | Pick<import('./types').RangeState, K> | null)
                | Pick<import('./types').RangeState, K>
                | null,
        ...
        shouldComponentUpdate?(
            nextProps: Readonly<import('./types').RangeProps>,
            nextState: Readonly<import('./types').RangeState>,
            nextContext: any
        ): boolean;
        componentWillUnmount?(): void;
        componentDidCatch?(error: Error, errorInfo: import('react').ErrorInfo): void;
        getSnapshotBeforeUpdate?(
            prevProps: Readonly<import('./types').RangeProps>,
            prevState: Readonly<import('./types').RangeState>
        ): any;
        componentDidUpdate?(
            prevProps: Readonly<import('./types').RangeProps>,
