...
declare const _default: import('../config-provider/types').ConfiguredComponentClass<
    StepProps & import('../config-provider/types').ComponentCommonProps,
    {
        ...
        context: any;
        setState<K extends keyof import('./types').StepState>(
            state:
                | import('./types').StepState
                | ((
                      prevState: Readonly<import('./types').StepState>,
                      props: Readonly<StepProps>
                  ) => import('./types').StepState | Pick<import('./types').StepState, K> | null)
                | Pick<import('./types').StepState, K>
                | null,
...
> & {
    Item: import('../config-provider/types').ConfiguredComponentClass<
        ItemProps<HTMLElement> & import('../config-provider/types').ComponentCommonProps,
        {
            ...
            _refHandlerCreator<
                Name extends 'container' | 'body' | 'title' | 'step' | 'tail' | 'stepNode',
            >(
                refName: Name
            ): (ref: any[Name]) => void;
            render(): import('react').JSX.Element;
