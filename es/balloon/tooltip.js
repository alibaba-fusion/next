...
var Tooltip = (_temp = _class = function (_React$Component) {
    ...
    Tooltip.prototype.render = function render() {
        var _props = this.props,
            ...
            rtl = _props.rtl,
            others = _objectWithoutProperties(_props, ['id', 'className', 'align', 'style', 'prefix', 'trigger', 'children', 'popupContainer', 'popupProps', 'popupClassName', 'popupStyle', 'triggerType', 'autoFocus', 'rtl']);
