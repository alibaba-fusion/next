...
export default function virtual(BaseComponent) {
    ...
    var VirtualTable = (_temp2 = _class = function (_React$Component) {
        ...
        VirtualTable.prototype.render = function render() {
            ...
            return React.createElement(BaseComponent, _extends({}, others, { dataSource: dataSource, entireDataSource: entireDataSource, components: components, fixedHeader: fixedHeader }));
        };
