...
var Header = (_temp2 = _class = function (_React$Component) {
    ...
    Header.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            pure = _props.pure,
            rtl = _props.rtl,
            others = _objectWithoutProperties(_props, ['prefix', 'className', 'children', 'component', 'colGroup', 'columns', 'locale', 'filterParams', 'onFilter', 'components', 'affixRef', 'headerCellRef', 'onSort', 'sort', 'onResizeChange', 'pure', 'rtl']);
        ...
        var header = columns.map(function (cols, index) {
            var col = cols.map(function (col, j) {
                ...
                var title = col.title,
                    ...
                    lock = col.lock,
                    others = _objectWithoutProperties(col, ['title', 'colSpan', 'sortable', 'resizable', 'dataIndex', 'filters', 'filterMode', 'width', 'align', 'alignHeader', 'className', '__normalized', 'lock']);
                ...
                if (col.children && col.children.length) {
                    ...
                    if (sortable) {
                        sortElement = React.createElement(Sort, { prefix: prefix,
                            dataIndex: dataIndex,
                    ...
                    if (filters) {
                        filterElement = filters.length ? React.createElement(Filter, { dataIndex: dataIndex,
                            filters: filters,
                            prefix: prefix,
                            locale: locale,
                            rtl: rtl,
