...
var Header = (_temp2 = _class = function (_React$Component) {
    ...
    Header.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            pure = _props.pure,
            others = _objectWithoutProperties(_props, ['prefix', 'className', 'children', 'component', 'colGroup', 'columns', 'locale', 'filterParams', 'onFilter', 'components', 'headerCellRef', 'onSort', 'sort', 'onResizeChange', 'pure']);
        ...
        var header = columns.map(function (cols, index) {
            var col = cols.map(function (col, j) {
                ...
                if (col.children && col.children.length) {
                    ...
                    if (resizable) {
                        resizeElement = React.createElement(Resize, { prefix: prefix, dataIndex: dataIndex, onChange: onResizeChange });
                    }
