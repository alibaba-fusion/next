        ...
        var header = columns.map(function (cols, index) {
            var col = cols.map(function (col, j) {
                ...
                var title = col.title,
                    ...
                    lock = col.lock,
                    others = _objectWithoutProperties(col, ['title', 'colSpan', 'sortable', 'resizable', 'dataIndex', 'filters', 'filterMode', 'filterMenuProps', 'width', 'align', 'alignHeader', 'className', '__normalized', 'lock']);
