...
var Row = (_temp2 = _class = function (_React$Component) {
    ...
    Row.prototype.render = function render() {
        ...
        var _props3 = this.props,
            ...
            others = _objectWithoutProperties(_props3, ['prefix', 'className', 'onClick', 'onMouseEnter', 'onMouseLeave', 'columns', 'Cell', 'getCellProps', 'rowIndex', 'record', '__rowIndex', 'children', 'primaryKey', 'cellRef', 'colGroup', 'pure', 'locale', 'expandedIndexSimulate', 'tableOuterWidth', 'rtl', 'wrapper']);
