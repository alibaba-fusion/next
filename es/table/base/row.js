...
var Row = (_temp2 = _class = function (_React$Component) {
    ...
    Row.prototype.renderCells = function renderCells(record) {
        ...
        return columns.map(function (child, colIndex) {
            ...
            var dataIndex = child.dataIndex,
                ...
                width = child.width,
                others = _objectWithoutProperties(child, ['dataIndex', 'align', 'alignHeader', 'width']);
            ...
            return React.createElement(Cell, _extends({ key: colIndex
            }, others, attrs, {
    ...
    Row.prototype.render = function render() {
        ...
        var _props3 = this.props,
            ...
            rtl = _props3.rtl,
            others = _objectWithoutProperties(_props3, ['prefix', 'className', 'onClick', 'onMouseEnter', 'onMouseLeave', 'columns', 'Cell', 'getCellProps', 'rowIndex', 'record', 'children', 'primaryKey', 'cellRef', 'colGroup', 'pure', 'locale', 'expandedIndexSimulate', 'rtl']);
