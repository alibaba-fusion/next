...
var Row = (_temp2 = _class = function (_React$Component) {
    ...
    Row.prototype.renderCells = function renderCells(record, rowIndex) {
        ...
        return columns.map(function (child, colIndex) {
            ...
            var dataIndex = child.dataIndex,
                ...
                style = child.style,
                others = _objectWithoutProperties(child, ['dataIndex', 'align', 'alignHeader', 'width', 'colSpan', 'style']);
    ...
    Row.prototype.render = function render() {
        ...
        var _props2 = this.props,
            ...
            others = _objectWithoutProperties(_props2, ['prefix', 'className', 'onClick', 'onMouseEnter', 'onMouseLeave', 'columns', 'Cell', 'getCellProps', 'rowIndex', 'record', 'children', 'primaryKey', 'cellRef', 'colGroup', 'pure', 'locale', 'expandedIndexSimulate', 'rtl', 'wrapper']);
