    ...
    var ExpandedTable = (_temp2 = _class = function (_React$Component) {
        ...
        function ExpandedTable() {
            ...
            return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
                ...
                var expandedIndex = expandedIndexSimulate ? index / 2 : index;
                var openRowKeys = _this.state.openRowKeys,
                    primaryKey = _this.props.primaryKey,
                    hasExpanded = openRowKeys.indexOf(record[primaryKey]) > -1,
                    switchNode = hasExpanded ? React.createElement(Icon, { type: 'minus', size: 'xs' }) : React.createElement(Icon, { type: 'add', size: 'xs' }),
        ...
        ExpandedTable.prototype.normalizeChildren = function normalizeChildren(children) {
            ...
            toArrayChildren.unshift(React.createElement(Col, { title: '', key: 'expanded', cell: this.renderExpandedCell.bind(this), width: 50, className: prefix + 'table-expanded', __normalized: true }));
