...
var GroupListRow = (_temp = _class = function (_Row) {
    ...
    GroupListRow.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['prefix', 'className', 'onClick', 'onMouseEnter', 'onMouseLeave', 'columns', 'Cell', 'rowIndex', '__rowIndex', 'record', 'children', 'primaryKey', 'colGroup', 'cellRef', 'getCellProps', 'locale', 'wrapper', 'rtl', 'tableEl']);
        ...
        if (toRenderList) {
            return toRenderList.map(function (child, index) {
                ...
                if (_this2.context.rowSelection) {
                    cells.shift();
                    cells[0] = cells[0] && React.cloneElement(cells[0], _extends({
                        colSpan: 2
                    }, cells[0].props));
                }
                return React.createElement(
