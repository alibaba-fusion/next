...
var GroupListRow = (_temp = _class = function (_Row) {
    ...
    GroupListRow.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            rtl = _props.rtl,
            others = _objectWithoutProperties(_props, ['prefix', 'className', 'onClick', 'onMouseEnter', 'onMouseLeave', 'columns', 'Cell', 'rowIndex', 'record', 'children', 'primaryKey', 'colGroup', 'cellRef', 'getCellProps', 'locale', 'rtl']);
    ...
    GroupListRow.prototype.renderContent = function renderContent(type) {
        ...
        if (list) {
            if (React.isValidElement(list.cell)) {
                listNode = React.cloneElement(list.cell, { record: record, index: rowIndex });
