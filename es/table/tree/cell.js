    ...
    TreeCell.prototype.render = function render() {
        ...
        if (colIndex === treeArrowNodeIndex) {
            ...
            if (isTree) {
                ...
                treeArrowNode = React.createElement(Icon, { size: 'xs', rtl: rtl, className: prefix + 'table-tree-placeholder', type: 'arrow-right' });
        ...
        return React.createElement(
            CellComponent,
            _extends({}, this.props, { innerStyle: firstCellStyle, isIconLeft: !!treeArrowNode }),
            children,
            treeArrowNode
        );
    };
