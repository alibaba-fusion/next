    ...
    var SelectionTable = (_temp = _class = function (_React$Component) {
        ...
        function SelectionTable(props, context) {
            ...
            _this.renderSelectionHeader = function () {
                ...
                return mode === 'multiple' ? React.createElement(Checkbox, _extends({ indeterminate: indeterminate, 'aria-label': locale.selectAll, checked: checked, onChange: onChange }, attrs)) : null;
            };
        ...
        SelectionTable.prototype.normalizeChildren = function normalizeChildren(children) {
            ...
            if (rowSelection) {
                ...
                children.unshift(React.createElement(Col, { key: 'selection', title: this.renderSelectionHeader.bind(this),
