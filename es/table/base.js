    ...
    Table.prototype.renderTable = function renderTable(groupChildren, flatChildren) {
        if (flatChildren.length || !flatChildren.length && !this.props.lockType) {
            ...
            return React.createElement(
                ...
                hasHeader ? React.createElement(Header, { prefix: prefix,
                    pure: pure,
                    colGroup: colGroup,
                ...
                React.createElement(Body, { prefix: prefix,
                    pure: pure,
                    colGroup: colGroup,
