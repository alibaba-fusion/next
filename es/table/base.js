...
var Children = React.Children, noop = function () { };
//<Table>
//    <Table.Column/>
//    <Table.ColumnGroup>
//      <Table.Column/>
...
var Table = /** @class */ (function (_super) {
    ...
    function Table(props, context) {
        ...
        _this.findEventTarget = function (e) {
            ...
            var target = dom.getClosest(e.target, "td.".concat(prefix, "table-cell"));
    ...
    Table.prototype.renderTable = function (groupChildren, flatChildren) {
        if (flatChildren.length || (!flatChildren.length && !this.props.lockType)) {
            ...
            var _b = components.Header, Header = _b === void 0 ? HeaderComponent : _b, _c = components.Wrapper, Wrapper = _c === void 0 ? WrapperComponent : _c, _d = components.Body, Body = _d === void 0 ? BodyComponent : _d;
            var colGroup = this.renderColGroup(flatChildren);
            return [
                React.createElement("div", { key: "".concat(prefix, "table-column-resize-proxy"), ref: this.getResizeProxyDomRef, className: "".concat(prefix, "table-column-resize-proxy") }),
                React.createElement(Wrapper, { key: "".concat(prefix, "table-wrapper"), colGroup: colGroup, ref: this.getWrapperRef, prefix: prefix, tableWidth: tableWidth },
                    hasHeader ? (React.createElement(Header, { prefix: prefix, rtl: rtl, pure: pure, affixRef: this.getAffixRef, colGroup: colGroup, className: "".concat(prefix, "table-header"), filterParams: filterParams, tableEl: this.tableEl, columns: groupChildren, locale: locale, headerCellRef: this.getHeaderCellRef, components: components, onFilter: this.onFilter, sort: sort, onResizeChange: this.onResizeChange, onSort: this.onSort, sortIcons: sortIcons, tableWidth: tableWidth, resizeProxyDomRef: this.resizeProxyDomRef })) : null,
    ...
    Table.prototype.render = function () {
        ...
        var loadingcls = classnames((_b = {},
            ...
            _b));
        return (React.createElement("div", __assign({ className: cls, style: style, ref: ref || this.getTableEl }, obj.pickOthers(Object.keys(Table.propTypes), others)),
            table,
            loading ? React.createElement(LoadingComponent, { className: loadingcls }) : null));
    };
    Table.Column = Column;
    Table.ColumnGroup = ColumnGroup;
    Table.Header = HeaderComponent;
    Table.Body = BodyComponent;
    Table.Wrapper = WrapperComponent;
    Table.Row = RowComponent;
    Table.Cell = CellComponent;
    Table.Filter = FilterComponent;
    Table.Sort = SortComponent;
    Table.propTypes = __assign(__assign({}, ConfigProvider.propTypes), { 
        /**
         * 样式类名的品牌前缀
         */
        prefix: PropTypes.string, pure: PropTypes.bool, rtl: PropTypes.bool, 
        /**
         ...
         * 表格展示的数据源
         */
        dataSource: PropTypes.array, entireDataSource: PropTypes.array, 
        /**
         * 点击表格每一行触发的事件
         ...
         */
        locale: PropTypes.object, components: PropTypes.object, 
        /**
         ...
         */
        primaryKey: PropTypes.oneOfType([PropTypes.symbol, PropTypes.string]), lockType: PropTypes.oneOf(['left', 'right']), wrapperContent: PropTypes.any, refs: PropTypes.object, 
        /**
         * 额外渲染行的渲染函数
         * @param {Object} record 该行所对应的数据
         * @param {Number} index 该行所对应的序列
         ...
         */
        onRowOpen: PropTypes.func, onExpandedRowClick: PropTypes.func, 
        /**
         ...
         * 是否开启虚拟滚动
         */
        useVirtual: PropTypes.bool, rowHeight: PropTypes.oneOfType([PropTypes.number, PropTypes.func]), 
        /**
         ...
         */
        crossline: PropTypes.bool, lengths: PropTypes.object });
    Table.defaultProps = {
        dataSource: [],
        onRowClick: noop,
