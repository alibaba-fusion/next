...
var Pagination = (_temp = _class = function (_Component) {
    ...
    Pagination.prototype.renderPageEllipsis = function renderPageEllipsis(idx) {
        ...
        return React.createElement(Icon, { className: prefix + 'pagination-ellipsis', type: 'ellipsis', key: 'ellipsis-' + idx });
    };
    ...
    Pagination.prototype.render = function render() {
        ...
        var _props11 = this.props,
            ...
            others = _objectWithoutProperties(_props11, ['prefix', 'pure', 'type', 'size', 'shape', 'className', 'total', 'totalRender', 'pageSize', 'pageSizeSelector', 'pageSizeList', 'pageSizePosition', 'useFloatLayout', 'onPageSizeChange', 'hideOnlyOnePage', 'showJump', 'locale', 'current', 'defaultCurrent', 'pageShowCount', 'pageNumberRender', 'link', 'onChange']);
        /* eslint-enable */
