...
var SplitButton = (_temp = _class = function (_React$Component) {
    ...
    SplitButton.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['prefix', 'label', 'size', 'type', 'component', 'ghost', 'className', 'style', 'children', 'triggerProps', 'popupAlign', 'popupTriggerType', 'popupStyle', 'popupClassName', 'popupProps', 'selectMode', 'menuProps', 'leftButtonProps', 'disabled']);
        ...
        var trigger = React.createElement(
            Button,
            _extends({}, triggerProps, sharedBtnProps, { className: triggerClassNames }),
            React.createElement(Icon, { type: 'arrow-down' })
        );

        return React.createElement(
            Button.Group,
            _extends({}, obj.pickOthers(SplitButton.propTypes, others), { className: classNames, style: style, size: size, ref: this._wrapperRefHandler }),
            React.createElement(
                Button,
