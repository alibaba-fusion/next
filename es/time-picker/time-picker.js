...
var TimePicker = /** @class */ (function (_super) {
    ...
    TimePicker.prototype.render = function () {
        ...
        var sharedInputProps = __assign(__assign({}, inputProps), { size: size, disabled: disabled, value: inputValue, hasClear: value && hasClear, onChange: this.onInputChange, onBlur: this.onInputBlur, onPressEnter: this.onInputBlur, onKeyDown: this.onKeyown, hint: React.createElement(Icon, { type: "clock", className: "".concat(prefix, "time-picker-symbol-clock-icon") }) });
    ...
    TimePicker.propTypes = __assign(__assign({}, ConfigProvider.propTypes), { prefix: PropTypes.string, rtl: PropTypes.bool, 
        /**
         * 按钮的文案
         */
         ...
         */
        onChange: PropTypes.func, className: PropTypes.string, name: PropTypes.string, inputProps: PropTypes.object, popupComponent: PropTypes.elementType, popupContent: PropTypes.node });
