...
var getIndeterminateKeys = function (checkedKeys, checkStrictly, _k2n, _p2n) {
    ...
    var poss = filterChildKey(checkedKeys
        ...
        .filter(function (key) { return !_k2n[key].disabled && !_k2n[key].checkboxDisabled && _k2n[key].checkable !== false; }), _k2n, _p2n).map(function (key) { return _k2n[key].pos; });
...
var Tree = /** @class */ (function (_super) {
    ...
    Tree.prototype.getFirstAvaliablelChildKey = function (parentPos) {
        var _this = this;
        var pos = Object.keys(this.state._p2n).find(function (p) { return _this.isAvailablePos("".concat(parentPos, "-0"), p); });
    ...
    Tree.prototype.render = function () {
        ...
        var treeRender = function (items, ref) {
            return (React.createElement("ul", __assign({ role: "tree", ref: ref, "aria-multiselectable": multiple, onBlur: _this.handleBlur, className: newClassName, style: useVirtual ? null : style }, others), items));
        };
        var virtualTreeRender = function (dataSource) {
            return (React.createElement("div", { className: "".concat(prefix, "virtual-tree-container"), style: style },
                React.createElement(VirtualList, __assign({ itemsRenderer: function (items, ref) { return treeRender(items, ref); } }, virtualListProps), _this.renderNodeList(dataSource))));
        };
        return useVirtual
