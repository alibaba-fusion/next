...
var Tree = (_temp = _class = function (_Component) {
    ...
    Tree.prototype.handleCheck = function handleCheck(check, key, node) {
        ...
        forEachEnableNode(this.state._k2n[key], function (node) {
        ...
        switch (checkedStrategy) {
            case 'parent':
                newCheckedKeys = filterChildKey(checkedKeys, this.state._k2n, this.state._p2n);
                break;
            case 'child':
                newCheckedKeys = filterParentKey(checkedKeys, this.state._k2n, this.state._p2n);
                break;
            default:
    ...
    Tree.prototype.renderByDataSource = function renderByDataSource() {
        ...
        var loop = function loop(data) {
            ...
            return data.map(function (item, index) {
                ...
                var props = _extends({}, others, _this8.getNodeProps('' + key), {
                    _key: key
                });
                if (children && children.length) {
