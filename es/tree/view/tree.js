...
var Tree = (_temp = _class = function (_Component) {
    ...
    Tree.prototype.renderByDataSource = function renderByDataSource() {
        ...
        var loop = function loop(data) {
            ...
            return data.map(function (item, index) {
                ...
                var props = _extends({}, others, _this12.getNodeProps('' + key), {
                    _key: key
                });
                if (children && children.length) {
                    props.children = loop(children, pos);
                }
                var node = React.createElement(TreeNode, _extends({ rtl: rtl, key: key }, props));
    ...
    Tree.prototype.render = function render() {
        ...
        return React.createElement(
            'ul',
            _extends({ role: 'tree', onBlur: this.handleBlur, className: newClassName }, others),
