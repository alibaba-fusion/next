...
import { normalizeToArray, isDescendantOrSelf, isSiblingOrSelf, filterChildKey, filterParentKey, getAllCheckedKeys, forEachEnableNode, isNodeChecked, convertChildren2Data, getAllDescendantKeys } from './util';
...
var preHandleData = function preHandleData(props, dataSource) {
    var k2n = {};
    var p2n = {};
    ...
    var drill = function drill() {
        ...
        return data.map(function (item, index) {
            ...
            // - 存在children元素
            item.isLeaf = !(props.loadData && item.isLeaf !== true || children && children.length);
...
var getData = function getData(props) {
    var dataSource = props.dataSource && props.dataSource.length ? props.dataSource : convertChildren2Data(props.children || []);
...
var Tree = (_temp = _class = function (_Component) {
    ...
    function Tree(props) {
        ...
        var _getData = getData(props),
            dataSource = _getData.dataSource,
            k2n = _getData.k2n,
            p2n = _getData.p2n;
    ...
    Tree.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
        var _getData2 = getData(props),
            dataSource = _getData2.dataSource,
            k2n = _getData2.k2n,
            p2n = _getData2.p2n;
        ...
        var virtualTreeRender = function virtualTreeRender(dataSource) {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    _this11.renderNodeList(dataSource)
                )
            );
        };

        return useVirtual ? virtualTreeRender(dataSource) : renderChildNodes ? treeRender(this.renderWithCustomChildNodes(dataSource)) : treeRender(this.renderByDataSource(dataSource));
    };
