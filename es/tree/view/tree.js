...
var pickOthers = obj.pickOthers,
    pickProps = obj.pickProps,
    isPlainObject = obj.isPlainObject;


export var treeNodeProps = ['key', 'label', 'selectable', 'checkable', 'editable', 'draggable', 'disabled', 'checkboxDisabled', 'isLeaf', 'icon'];
...
var Tree = (_temp = _class = function (_Component) {
    ...
    Tree.prototype.render = function render() {
        ...
        var _props5 = this.props,
            ...
            virtualListProps = _props5.virtualListProps;
        ...
        var virtualTreeRender = function virtualTreeRender(dataSource) {
            return React.createElement(
                ...
                React.createElement(
                    VirtualList,
                    _extends({ itemsRenderer: function itemsRenderer(items, ref) {
