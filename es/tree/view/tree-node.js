...
var TreeNode = (_temp = _class = function (_Component) {
    ...
    TreeNode.prototype.renderSwitcher = function renderSwitcher(showLine) {
        ...
        var iconCls = cx((_cx2 = {}, _cx2[prefix + 'tree-switcher-icon'] = true, _cx2[prefix + 'tree-fold-icon'] = iconType === 'arrow-down', _cx2[prefix + 'tree-switcher-fold-icon'] = showLine && !expanded, _cx2[prefix + 'tree-switcher-unfold-icon'] = showLine && expanded, _cx2));
    ...
    TreeNode.prototype.renderLabel = function renderLabel() {
        ...
        return React.createElement(
            'div',
            _extends({ className: prefix + 'tree-node-label-wrapper', ref: this.saveLabelWrapperRef }, labelWrapperProps),
            React.createElement(
                'div',
                labelProps,
                iconEl,
