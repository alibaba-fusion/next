...
var Circle = (_temp = _class = function (_Component) {
    ...
    Circle.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['prefix', 'size', 'state', 'percent', 'className', 'textRender', 'progressive']);
        ...
        var pathCls = classNames((_classNames2 = {}, _classNames2[prefix + 'progress-circle-overlay'] = true, _classNames2[prefix + 'progress-circle-overlay-' + state] = !progressive && state, _classNames2[prefix + 'progress-circle-overlay-started'] = progressive && percent <= 30, _classNames2[prefix + 'progress-circle-overlay-middle'] = progressive && percent > 30 && percent < 80, _classNames2[prefix + 'progress-circle-overlay-finishing'] = progressive && percent >= 80, _classNames2));
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('path', { className: prefix + 'progress-circle-underlay', d: underlayPath, fillOpacity: '0', ref: this._underlayRefHandler }),
