...
var Item = (_temp = _class = function (_Component) {
    ...
    Item.prototype.render = function render() {
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['prefix', 'rtl', 'className', 'children', 'link', 'activated', 'separator', 'onClick']);
        ...
        return React.createElement(
            'li',
            { dir: rtl ? 'rtl' : null, className: prefix + 'breadcrumb-item', onClick: onClick },
