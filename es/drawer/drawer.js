...
var Drawer = (_temp2 = _class = function (_Component) {
    ...
    Drawer.prototype.render = function render() {
        var _props2 = this.props,
            ...
            others = _objectWithoutProperties(_props2, ['prefix', 'style', 'width', 'height', 'trigger', 'triggerType', 'animation', 'hasMask', 'visible', 'placement', 'onClose', 'onVisibleChange', 'closeable', 'closeMode', 'rtl', 'popupContainer']);
