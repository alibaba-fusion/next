...
var Inner = /** @class */ (function (_super) {
    ...
    Inner.prototype.renderHeader = function () {
        ...
        var headerCls = cx((_a = {},
            ...
            _a));
        return (React.createElement("div", { className: headerCls, style: headerStyle, role: "heading", "aria-level": "1" },
            title,
            closeLink));
    };
    ...
    Inner.prototype.renderCloseLink = function () {
        ...
        if (closeable) {
            return (React.createElement("a", { role: "button", "aria-label": locale.close, className: "".concat(prefix, "drawer-close"), onClick: onClose },
