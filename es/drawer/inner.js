...
var Inner = (_temp = _class = function (_Component) {
    ...
    Inner.prototype.renderCloseLink = function renderCloseLink() {
        ...
        if (closeable) {
            return React.createElement(
                ...
                React.createElement(Icon, { className: prefix + 'drawer-close-icon', type: 'close' })
            );
        }
    ...
    Inner.prototype.render = function render() {
        ...
        var newClassName = cx((_cx2 = {}, _cx2[prefix + 'drawer'] = true, _cx2[prefix + 'drawer-' + placement] = !v2, _cx2[prefix + 'closeable'] = closeable, _cx2[className] = !!className, _cx2));
