...
import createStyle, { getMargin, getChildMargin, getSpacingHelperMargin, filterInnerStyle, filterHelperStyle, filterOuterStyle } from
// getBoxChildProps,
    ...
    return array.map(function (child, index) {
        ...
        if (React.isValidElement(child)) {
            ...
            return React.cloneElement(child, {
                style: _extends({}, spacingMargin, childPropsMargin, child.props.style || {})
            });
        }
...
var Box = (_temp = _class = function (_Component) {
    ...
    Box.prototype.render = function render() {
        ...
        var boxs = createChildren(children, { spacing: spacing, direction: direction, wrap: wrap });
