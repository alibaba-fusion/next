    ...
    var ConfigedComponent = (_temp = _class = function (_React$Component) {
        ...
        ConfigedComponent.prototype.render = function render() {
            var _props = this.props,
                ...
                pure = _props.pure,
                others = _objectWithoutProperties(_props, ['prefix', 'locale', 'pure']);
            ...
            var contextProps = getContextProps({ prefix: prefix, locale: locale, pure: pure }, { nextPrefix: nextPrefix, nextLocale: _extends({}, currentGlobalLocale, nextLocale), nextPure: nextPure }, displayName);

            var newContextProps = ['prefix', 'locale', 'pure'].reduce(function (ret, name) {
            ...
            return React.createElement(Component, _extends({}, newOthers, newContextProps, { ref: this._getInstance }));
        };
