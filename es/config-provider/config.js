    ...
    var ConfigedComponent = (_temp = _class = function (_React$Component) {
        ...
        ConfigedComponent.prototype.render = function render() {
            var _props = this.props,
                ...
                others = _objectWithoutProperties(_props, ['prefix', 'locale', 'pure', 'rtl', 'errorBoundary']);
            ...
            var contextProps = getContextProps({ prefix: prefix, locale: locale, pure: pure, rtl: rtl, errorBoundary: errorBoundary }, {
