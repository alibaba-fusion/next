...
function isValueChanged(newValue, oldValue) {
    return Array.isArray(newValue) ? newValue.some(function (val, idx) {
        return !datejs(val).isSame(oldValue && oldValue[idx]);
...
var Picker = (_temp = _class = function (_React$Component) {
    ...
    function Picker(props) {
        ...
        var isRange = props.type === DATE_PICKER_TYPE.RANGE;
    ...
    this.onOk = function () {
        ...
        var result = func.invoke(_this4.props, 'onOk', [checkAndRectify(inputValue, isRange), inputValue]);
