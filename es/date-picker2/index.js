...
var ConfigPicker = ConfigProvider.config(Picker, { componentName: 'DatePicker', transform: transform });

var DatePicker2 = function DatePicker2(props) {
    return React.createElement(ConfigPicker, props);
};
DatePicker2.displayName = 'DatePicker2';

DatePicker2.MonthPicker = function (props) {
    return React.createElement(ConfigPicker, _extends({}, props, { mode: MONTH }));
};
DatePicker2.MonthPicker.displayName = 'MonthPicker2';

DatePicker2.YearPicker = function (props) {
    return React.createElement(ConfigPicker, _extends({}, props, { mode: YEAR }));
};
DatePicker2.YearPicker.displayName = 'YearPicker2';

DatePicker2.WeekPicker = function (props) {
    return React.createElement(ConfigPicker, _extends({}, props, { mode: WEEK }));
};
DatePicker2.WeekPicker.displayName = 'WeekPicker2';

DatePicker2.QuarterPicker = function (props) {
    return React.createElement(ConfigPicker, _extends({}, props, { mode: QUARTER }));
};
DatePicker2.QuarterPicker.displayName = 'QuarterPicker2';

DatePicker2.RangePicker = function (props) {
    return React.createElement(ConfigPicker, _extends({}, props, { type: 'range' }));
};
