...
var transform = function (props, deprecated) {
    var footerRender = props.footerRender, onVisibleMonthChange = props.onVisibleMonthChange, defaultVisibleMonth = props.defaultVisibleMonth, ranges = props.ranges, newProps = __rest(props, ["footerRender", "onVisibleMonthChange", "defaultVisibleMonth", "ranges"]);
...
var generatePicker = function (mode) { return React.forwardRef(function (props, ref) { return React.createElement(ConfigPicker, __assign({ ref: ref }, props, { mode: mode })); }); };
