...
var getPanelValue = function getPanelValue(_ref, oldPanelValue) {
    ...
    var panelValue = datejs(oldPanelValue);
...
var RangePanel = (_temp = _class = function (_React$Component) {
    ...
    this.onTimeSelect = function (v) {
        ...
        if (!curDateVal) {
            curDateVal = inputType === BEGIN && end ? end.subtract(1, 'day') : inputType === END && begin ? begin.add(1, 'day') : datejs();
        }
    ...
    this.handleSelect = function (v, fromTimeChange) {
        ...
        var timeVal = fromTimeChange || resetTime ? null : value[inputType] || value[otherType] || datejs();
        ...
        func.invoke(_this2.props, 'onSelect', [[begin, end]]);
    };
