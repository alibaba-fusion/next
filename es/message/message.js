...
var Message = (_temp2 = _class = function (_Component) {
    ...
    Message.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['prefix', 'pure', 'className', 'type', 'shape', 'size', 'title', 'children', 'defaultVisible', 'visible', 'iconType', 'closeable', 'onClose', 'afterClose', 'animation']);
        /* eslint-enable */
        ...
        var newChildren = visible ? React.createElement(
            'div',
            _extends({ role: 'alert' }, others, { className: classes }),
            ...
            React.createElement(Icon, { className: messagePrefix + '-symbol', type: iconType }),
