...
var List = (_temp2 = _class = function (_Component) {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                file.state === 'uploading' ? React.createElement(
                    ...
                    React.createElement(Progress, { size: 'medium', percent: file.percent, textRender: func.noop })
                ) : null,
                React.createElement(
                    'span',
            ...
            this.props.closable ? React.createElement(Icon, { type: 'close',
                size: 'large',
                role: 'button',
                tabIndex: '0',
                onClick: onClick,
            ...
            React.createElement(
                ...
                file.state !== 'uploading' ? React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(Icon, { type: downloadURL ? 'download' : '', className: prefixCls + '-tool-download-icon' })
                    ),
                    this.props.closable ? React.createElement(
                        'span',
                        { className: prefixCls + '-tool-close' },
                        React.createElement(Icon, { type: 'ashbin', tabIndex: '0', role: 'button', onClick: onClose, onKeyDown: onKeyDownClose })
                    ) : null
                ) : ''
            ),
            React.createElement(
    ...
    List.prototype.render = function render() {
        ...
        return React.createElement(
            'div',
            _extends({}, others, { className: listclassNames }),
            list,
            children
        );
    };
