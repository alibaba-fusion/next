...
var TransferPanel = /** @class */ (function (_super) {
    ...
    function TransferPanel(props, context) {
        ...
        _this.footerId = props.baseId ? htmlId.escapeForId("".concat(props.baseId, "-panel-footer-").concat(props.position)) : '';
        _this.headerId = props.baseId ? htmlId.escapeForId("".concat(props.baseId, "-panel-header-").concat(props.position)) : '';
        bindCtx(_this, [
            'handleCheck',
            'handleAllCheck',
            'handleSearch',
    ...
    TransferPanel.prototype.handleAllCheck = function (allChecked) {
        ...
        if (allChecked) {
            if (searchedValue) {
                newValue = this.enabledDatasource.filter(function (item) { return filter(searchedValue, item); }).map(function (item) { return item.value; });
            }
            else {
