...
var Button = (_temp2 = _class = function (_Component) {
    ...
    Button.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['prefix', 'className', 'type', 'size', 'htmlType', 'loading', 'text', 'warning', 'ghost', 'component', 'iconSize', 'children']);
        ...
        return React.createElement(
            TagName,
            _extends({}, tagAttrs, { onMouseUp: this.onMouseUp, ref: this.buttonRefHandler, role: 'button' }),
            clonedChildren
        );
    };
