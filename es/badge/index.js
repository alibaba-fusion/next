...
var Badge = (_temp = _class = function (_Component) {
    ...
    Badge.prototype.render = function render() {
        ...
        var clazz = classNames(prefix + 'badge', (_classNames = {}, _classNames[prefix + 'badge-not-a-wrapper'] = !children, _classNames), className);

        return React.createElement(
            'span',
            _extends({ className: clazz }, others),
            children,
            React.createElement(Sup, { prefix: prefix, content: content, count: count, overflowCount: overflowCount, dot: dot, style: style })
        );
    };
