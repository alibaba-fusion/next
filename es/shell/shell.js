...
export default function ShellBase(props) {
    ...
    var Shell = (_temp = _class = function (_Component) {
        ...
        this.renderShell = function (props) {
            ...
            var toolDockCls = classnames((_classnames5 = {}, _classnames5[prefix + 'aside-tooldock'] = true, _classnames5));

            var navigationCls = classnames((_classnames6 = {}, _classnames6[prefix + 'aside-navigation'] = true, _classnames6));
            ...
            if (layout.taskHeader) {
                ...
                var taskHeaderCls = classnames((_classnames7 = {}, _classnames7[prefix + 'shell-task-header'] = true, _classnames7));
            ...
            if (layout.LocalNavigation) {
                ...
                var localNavCls = classnames(asideCls, (_classnames8 = {}, _classnames8[prefix + 'aside-localnavigation'] = true, _classnames8));
            ...
            if (layout.Ancillary) {
                ...
                var ancillaryCls = classnames(asideCls, (_classnames9 = {}, _classnames9[prefix + 'aside-ancillary'] = true, _classnames9));
            ...
            var cls = classnames((_classnames10 = {}, _classnames10[prefix + 'shell'] = true, _classnames10[prefix + 'shell-' + device] = true, _classnames10[prefix + 'shell-' + type] = true, _classnames10[className] = !!className, _classnames10));
