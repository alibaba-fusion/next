...
export default function ShellBase(props) {
    ...
    var Shell = /** @class */ (function (_super) {
        ...
        function Shell(props) {
            ...
            _this.toggleAside = function (mark, props, e) {
                ...
                if (mark === 'Navigation') {
                    ...
                    com = children.filter(function (child) { return child && child.type._typeMark.replace('Shell_', '') === mark; }).pop();
                }
            ...
            _this.renderShell = function (props) {
                ...
                if (needNavigationTrigger) {
                    ...
                    var _m = layout.Navigation.props, trigger = _m.trigger, collapse = _m.collapse;
                ...
                if (needDockTrigger) {
                    ...
                    var _o = layout.ToolDock.props, trigger = _o.trigger, collapse = _o.collapse;
                ...
                if (layout.LocalNavigation) {
                    var _p = layout.LocalNavigation.props, trigger = _p.trigger, collapse = _p.collapse;
                ...
                if (layout.Ancillary) {
                    var _q = layout.Ancillary.props, trigger = _q.trigger, collapse = _q.collapse;
        ...
        Shell.propTypes = __assign(__assign({}, ConfigProvider.propTypes), { prefix: PropTypes.string, 
            /**
             * 设备类型
             * @enumdesc 手机, 平板, PC电脑
             */
