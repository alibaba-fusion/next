...
var TextArea = (_temp = _class = function (_Base) {
    ...
    TextArea.prototype.renderClear = function renderClear() {
        ...
        clearWrap = showClear ? React.createElement(
            'span',
            {
                className: cls,
    ...
    TextArea.prototype.renderControl = function renderControl() {
        ...
        return lenWrap || clearText ? React.createElement(
            'span',
            { onClick: function onClick() {
                    return _this2.focus();
                }, className: cls },
            lenWrap,
            isShowLine && React.createElement('span', { className: prefix + 'input-textarea-control-line' }),
            clearText
        ) : null;
    };
    ...
    TextArea.prototype.render = function render() {
        ...
        var cls = classNames(this.getClass(), (_classNames2 = {}, _classNames2['' + prefix + size] = size === 'large' || 'size' === 'small', _classNames2[prefix + 'input-textarea'] = true, _classNames2[prefix + 'noborder'] = !hasBorder, _classNames2[className] = !!className, _classNames2));
    ...
    return TextArea;
}(Base), _class.displayName = 'TextArea', _class.getDerivedStateFromProps = Base.getDerivedStateFromProps, _class.propTypes = _extends({}, Base.propTypes, {
    /**
     * 是否有边框
     */
