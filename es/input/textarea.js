...
var TextArea = (_temp = _class = function (_Base) {
    ...
    TextArea.prototype.render = function render() {
        ...
        return React.createElement(
            'span',
            _extends({ className: cls, style: wrapStyle }, dataProps),
            ...
            autoHeight ? React.createElement('textarea', { 'data-fake': true, ref: this.saveHelpRef.bind(this), style: _extends({}, props.style, hiddenStyle),
                rows: '1' }) : null,
            this.renderControl()
        );
    };
