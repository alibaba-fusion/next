...
var Input = (_temp = _class = function (_Base) {
    ...
    Input.prototype.renderControl = function renderControl() {
        ...
        if (hint || showClear) {
            ...
            if (hint) {
                ...
                hintIcon = React.createElement(Icon, { type: 'delete-filling', role: 'button', tabIndex: '0', className: prefix + 'input-hint', 'aria-label': locale.clear,
            ...
            clearWrap = React.createElement(
                ...
                hasClear && hint ? React.createElement(Icon, { type: 'delete-filling', role: 'button', tabIndex: '0', className: prefix + 'input-clear', 'aria-label': locale.clear,
                    onClick: this.onClear.bind(this),
                    onMouseDown: preventDefault,
    ...
    Input.prototype.render = function render() {
        ...
        var inputWrap = React.createElement(
            'span',
            _extends({}, dataProps, { className: cls, style: hasAddon ? undefined : style }),
