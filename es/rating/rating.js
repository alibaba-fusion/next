...
var Rating = /** @class */ (function (_super) {
    ...
    Rating.prototype.render = function () {
        ...
        var _loop_1 = function (i) {
            ...
            if (enableA11y) {
                overlay.push(React.createElement("input", { id: "".concat(id, "-").concat(prefix, "star").concat(i + 1), key: "input-".concat(i), className: "".concat(prefix, "sr-only"), "aria-checked": i + 1 === parseInt(hoverValue), checked: i + 1 === parseInt(hoverValue), onChange: this_1.handleChecked.bind(this_1, i + 1), type: "radio", name: "rating" }));
            }
            overlay.push(React.createElement("label", { key: "overlay-".concat(i), htmlFor: enableA11y ? "".concat(id, "-").concat(prefix, "star").concat(i + 1) : null, className: "".concat(prefix, "rating-icon") },
                iconNode,
