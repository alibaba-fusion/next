...
function LowerSlider(props) {
    ...
    if (_isMultiple(slider)) {
        return hasTip ? (React.createElement(Tooltip, { popupContainer: function (target) { return target.parentNode; }, popupProps: {
                ...
                needAdjust: false,
            }, trigger: Slider(__assign(__assign({}, props), { value: value[0] })), align: "t" }, tipRender("".concat(value[0])))) : (Slider(__assign(__assign({}, props), { value: value[0] })));
    }
    return null;
}
...
function UpperSlider(props) {
    ...
    if (_isMultiple(slider)) {
        ...
        return hasTip ? (React.createElement(Tooltip, { popupContainer: function (target) { return target.parentNode; }, popupProps: {
                ...
                animation: tooltipAnimation,
                needAdjust: false,
            }, trigger: Slider(__assign(__assign({}, newprop), { value: value[1] })), align: "t" }, tipRender(value[1]))) : (Slider(__assign(__assign({}, newprop), { value: value[1] })));
    }
    return hasTip ? (React.createElement(Tooltip, { popupContainer: function (target) { return target.parentNode; }, popupProps: {
            visible: tooltipVisible,
            onVisibleChange: onTooltipVisibleChange,
    ...
    Range.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({ ref: function (dom) {
            ...
            React.createElement("div", { className: "".concat(prefix, "range-inner") },
                ...
                this.isFixedWidth ? (React.createElement(FixedSlider, __assign({}, commonProps))) : (React.createElement("div", null,
                    React.createElement(Selected, __assign({}, commonProps)),
                    React.createElement(LowerSlider, __assign({}, commonProps, { hasMovingClass: this.state.hasMovingClass && this._moving && this._moving.dragging === 'lower', tooltipVisible: tooltipVisible || this.state.lowerTooltipVisible, onTooltipVisibleChange: this.handleLowerTooltipVisibleChange, tooltipAnimation: this.state.tooltipAnimation
                            ? {
                                in: 'expandInUp',
                                out: 'expandOutDown',
                            }
                            : false })),
                    React.createElement(UpperSlider, __assign({}, commonProps, { onKeyDown: this.onKeyDown, hasMovingClass: this.state.hasMovingClass && this._moving && this._moving.dragging === 'upper', tooltipVisible: tooltipVisible || this.state.upperTooltipVisible, onTooltipVisibleChange: this.handleUpperTooltipVisibleChange, tooltipAnimation: this.state.tooltipAnimation
                            ? {
                                in: 'expandInUp',
                                out: 'expandOutDown',
                            }
