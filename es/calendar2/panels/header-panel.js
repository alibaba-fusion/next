...
var HeaderPanel = /** @class */ (function (_super) {
    ...
    function HeaderPanel(props) {
        ...
        _this.createPanelBtns = function (_a) {
            ...
            return [
                React.createElement(Button, { text: true, className: "".concat(prefixCls, "-btn  ").concat(prefixCls, "-left-btn"), onClick: function () { return _this.handleClick(value, { num: num, unit: unit, isSuper: isSuper, isNext: false }); }, key: "prev-btn-".concat(unit) },
                    React.createElement(Icon, { type: iconTypes[0] })),
                React.createElement(Button, { text: true, className: "".concat(prefixCls, "-btn ").concat(prefixCls, "-right-btn"), onClick: function () { return _this.handleClick(value, { num: num, unit: unit, isSuper: isSuper, isNext: true }); }, key: "next-btn-".concat(unit) },
    ...
    HeaderPanel.prototype.renderInner = function () {
        ...
        if (shape === CALENDAR_SHAPE.PANEL) {
            ...
            nodes.push(React.createElement("div", { key: "actions", className: "".concat(prefixCls, "-actions") },
                ...
                this.props.renderHeaderExtra && this.props.renderHeaderExtra(__assign({}, this.props))));
        }
        return nodes;
    };
    HeaderPanel.prototype.render = function () {
        return (React.createElement("div", { className: "".concat(this.prefixCls) }, renderNode(this.props.headerRender, this.renderInner(), __spreadArray([], __read(this.props), false))));
    };
