...
var Nav = (_temp = _class = function (_Component) {
  ...
  Nav.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        others = _objectWithoutProperties(_props2, ['prefix', 'className', 'style', 'children', 'type', 'direction', 'activeDirection', 'mode', 'triggerType', 'inlineIndent', 'openMode', 'popupAlign', 'popupClassName', 'iconOnly', 'hasArrow', 'hasTooltip', 'popupProps']);
