...
var Nav = (_temp = _class = function (_Component) {
  ...
  Nav.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        rtl = _props2.rtl,
        others = _objectWithoutProperties(_props2, ['prefix', 'className', 'style', 'children', 'type', 'direction', 'activeDirection', 'mode', 'triggerType', 'inlineIndent', 'openMode', 'popupAlign', 'popupClassName', 'iconOnly', 'iconOnlyWidth', 'hasArrow', 'hasTooltip', 'embeddable', 'popupProps', 'rtl']);
