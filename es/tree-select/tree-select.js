...
var TreeSelect = (_temp = _class = function (_Component) {
    ...
    function TreeSelect(props, context) {
        ...
        bindCtx(_this, ['handleSelect', 'handleCheck', 'handleSearch', 'handleVisibleChange', 'handleChange', 'handleRemove', 'handleExpand']);
        ...
        var loop = function loop(children) {
            ...
            Children.forEach(children, function (child) {
                if (_this8.searchedKeys.indexOf(child.key) > -1) {
                    ...
                    var hideNode = cloneElement(child, { style: { display: 'none' } });
    ...
    TreeSelect.prototype.render = function render() {
        ...
        return React.createElement(Select, _extends({ prefix: prefix,
            className: className,
            size: size,
            hasBorder: hasBorder,
            hasArrow: hasArrow,
