...
var Nav = (_temp = _class = function (_React$Component) {
    ...
    function Nav(props, context) {
        ...
        _this.defaultTabTemplateRender = function (key, _ref) {
            ...
            var tail = closeable ? React.createElement(Icon, { type: 'close', onClick: function onClick(e) {
    ...
    Nav.prototype.render = function render() {
        ...
        if (extra) {
            ...
            if (tabPosition === 'top' || tabPosition === 'bottom') {
                navChildren.unshift(React.createElement(
                    'div',
                    _extends({}, extraProps, { style: floatRight }),
                    extra
                ));
            } else {
        ...
        return React.createElement(
            'div',
            { role: 'tablist', className: navbarCls, style: style, onKeyDown: onKeyDown, tabIndex: '0', ref: this.navbarRefHandler },
            navChildren
        );
    };
