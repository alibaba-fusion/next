...
var Nav = (_temp = _class = function (_React$Component) {
    ...
    Nav.prototype.renderTabList = function renderTabList(props, hideAdd) {
        ...
        if (!hideAdd && showAdd) {
            rst.push(React.createElement(
                'li',
                { role: 'button', className: prefix + 'tabs-tab ' + prefix + 'tabs-add', onClick: onAdd, key: 'add' },
                React.createElement(
                    'div',
                    { className: prefix + 'tabs-tab-inner' },
                    addIcon ? addIcon : React.createElement(Icon, { type: 'add' })
                )
            ));
        }
        return rst;
    ...
    Nav.prototype.computeExtraWidth = function computeExtraWidth() {
    ...
    Nav.prototype.render = function render() {
        ...
        var containerCls = classnames((_classnames2 = {}, _classnames2[prefix + 'tabs-nav-container'] = true, _classnames2[prefix + 'tabs-nav-container-scrolling'] = showNextPrev, _classnames2[prefix + 'tabs-show-add'] = showAdd, _classnames2));
        ...
        var wrapCls = classnames((_classnames3 = {}, _classnames3[prefix + 'tabs-nav-wrap'] = true, _classnames3[prefix + 'tabs-nav-has-add'] = showAdd, _classnames3));
        ...
        var container = React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: prefix + 'tabs-nav-scroll', ref: this.scrollerRefHandler, onScroll: this.onScroll },
            ...
            showAdd && hasExtra ? React.createElement(
                'div',
                { className: navCls + '-operations' },
                prevButton,
                nextButton,
                restButton,
                React.createElement(
                    'li',
                    { className: prefix + 'tabs-tab ' + prefix + 'tabs-add', onClick: onAdd, key: 'add' },
                    React.createElement(
                        'div',
                        { className: prefix + 'tabs-tab-inner' },
                        addIcon ? addIcon : React.createElement(Icon, { type: 'add' })
