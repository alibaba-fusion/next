...
var StepItem = /** @class */ (function (_super) {
    ...
    StepItem.prototype.adjustItemWidth = function () {
        ...
        var lastNodeWidth = labelPlacement === 'horizontal' || labelPlacement === 'hoz'
    ...
    StepItem.prototype.render = function () {
        ...
        var _b = this.props, prefix = _b.prefix, locale = _b.locale, className = _b.className, status = _b.status, title = _b.title, icon = _b.icon, index = _b.index, total = _b.total, shape = _b.shape, content = _b.content, direction = _b.direction, disabled = _b.disabled, onClick = _b.onClick, readOnly = _b.readOnly, animation = _b.animation, parentHeight = _b.parentHeight, itemRender = _b.itemRender, parentWidth = _b.parentWidth, labelPlacement = _b.labelPlacement, rtl = _b.rtl, onResize = _b.onResize;
    ...
    StepItem.propTypes = __assign(__assign({}, ConfigProvider.propTypes), { prefix: PropTypes.string, rtl: PropTypes.bool, 
        /**
         ...
         * 标题
         */
        title: PropTypes.node, direction: PropTypes.oneOf(['hoz', 'ver']), labelPlacement: PropTypes.oneOf(['hoz', 'ver']), shape: PropTypes.oneOf(['circle', 'arrow', 'dot']), 
        /**
         * 图标
         */
         ...
         * 百分比
         */
        percent: PropTypes.number, index: PropTypes.number, total: PropTypes.number, animation: PropTypes.bool, 
        /**
         * 是否禁用
         */
        disabled: PropTypes.bool, parentWidth: PropTypes.oneOfType([PropTypes.string, PropTypes.number]), parentHeight: PropTypes.oneOfType([PropTypes.string, PropTypes.number]), 
        /**
         * 点击步骤时的回调
         * @param {Number} index 节点索引
         */
         ...
         * 自定义样式
         */
        className: PropTypes.string, readOnly: PropTypes.bool, onResize: PropTypes.func, stretch: PropTypes.bool });
