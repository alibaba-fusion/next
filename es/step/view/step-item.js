...
var StepItem = (_temp = _class = function (_Component) {
    ...
    StepItem.prototype.render = function render() {
        ...
        var _props6 = this.props,
            ...
            others = _objectWithoutProperties(_props6, ['prefix', 'locale', 'className', 'status', 'title', 'icon', 'index', 'total', 'shape', 'content', 'direction', 'disabled', 'onClick', 'readOnly', 'animation', 'parentHeight', 'itemRender', 'parentWidth', 'labelPlacement']);
