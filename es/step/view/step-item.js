...
var StepItem = (_temp = _class = function (_Component) {
    ...
    StepItem.prototype.getNode = function getNode(args) {
        ...
        return React.createElement(
            'div',
            _extends({ tabIndex: '0', 'aria-current': status === 'process' ? 'step' : null }, others, { style: this.getStyle(), className: stepCls, ref: this._refHandlerCreator('step') }),
            finalNodeElement,
            React.createElement(
                'div',
    ...
    StepItem.prototype.render = function render() {
        ...
        var arrowElement = React.createElement(
            'div',
            _extends({ tabIndex: '0', 'aria-current': status === 'process' ? 'step' : null }, others, { style: this.getStyle(), className: stepCls, onClick: this.onClick }),
            React.createElement(
                'div',
                { className: prefix + 'step-item-container' },
                React.createElement(
