...
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.renderValues = function () {
        ...
        if (mode === 'single') {
            ...
            if (maxTagCount !== undefined && value.length > maxTagCount && !tagInline) {
                ...
                maxTagPlaceholderEl = (React.createElement(Tag, { key: "_count", type: "primary", size: tagSize, animation: false }, holder(value, totalValue)));
            }
            if (value.length > 0 && tagInline) {
                maxTagPlaceholderEl = (React.createElement("div", { className: "".concat(prefix, "select-tag-compact"), key: "_count" }, holder(value, totalValue)));
            }
            ...
            var selectedValueNodes = value.map(function (v) {
                ...
                return (React.createElement(Tag, { key: v.value, disabled: disabled || v.disabled, type: "primary", size: tagSize, animation: false, onClose: _this.handleTagClose.bind(_this, v), closable: tagClosable }, labelNode));
            });
    ...
    Select.prototype.renderSelect = function () {
        ...
        var triggerClazz = classNames(["".concat(prefix, "select"), "".concat(prefix, "select-trigger"), "".concat(prefix, "select-").concat(mode), "".concat(prefix).concat(size), className], (_a = {},
    ...
    Select.propTypes = __assign(__assign({}, Base.propTypes), { 
        /**
         * 选择器模式
         */
         ...
         * 弹层内容为空的文案
         */
        notFoundContent: PropTypes.node, style: PropTypes.object, 
        /**
         * 受控搜索值，一般不需要设置
         * @type {[type]}
         */
         ...
         * 失去焦点事件
         */
        onBlur: PropTypes.func, onMouseEnter: PropTypes.func, onMouseLeave: PropTypes.func, onKeyDown: PropTypes.func, locale: PropTypes.object, 
        /**
         * 展开下拉菜单时是否自动焦点到弹层
         */
