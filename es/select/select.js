...
var Select = (_temp = _class = function (_Base) {
    ...
    Select.prototype.renderValues = function renderValues() {
        ...
        var _props6 = this.props,
            ...
            maxTagTextLength = _props6.maxTagTextLength,
        ...
        if (mode === 'single') {
            ...
            if (maxTagCount !== undefined && value.length > maxTagCount) {
                var totalLen = this.dataStore.getFlattenDS().length;
    ...
    onSearch: noop,
    onSearchClear: noop,
    maxTagPlaceholder: function maxTagPlaceholder(selected, total) {
