...
var Select = (_temp = _class = function (_Base) {
    ...
    Select.prototype.renderMenuHeader = function renderMenuHeader() {
        ...
        var cls = classNames((_classNames3 = {}, _classNames3[prefix + 'select-all'] = true, _classNames3[prefix + 'menu-item'] = true, _classNames3[prefix + 'selected'] = selectAllYet, _classNames3));
