...
var Base = (_temp = _class = function (_React$Component) {
    ...
    function Base(props) {
        ...
        _this.state = {
            ...
            width: 100,
            highlightKey: 'highlightKey' in props ? props.highlightKey : props.value || props.defaultHighlightKey || props.defaultValue,
            srReader: ''
        };
    ...
    Base.prototype.syncWidth = function syncWidth() {
        ...
        if (width && this.width !== width) {
            ...
            if (this.popupRef && this.shouldAutoWidth()) {
                ...
                setTimeout(function () {
                    if (_this3.popupRef) {
                        dom.setStyle(_this3.popupRef, 'width', _this3.width);
                        return;
                    }
                }, 0);
            }
    ...
    Base.prototype.render = function render(props) {
        ...
        return React.createElement(
            Tag,
            _extends({}, _props, { trigger: this.renderSelect() }),
