...
var AutoComplete = /** @class */ (function (_super) {
    ...
    AutoComplete.prototype.renderSelect = function (props) {
        ...
        // });
        // trigger className
        var triggerClazz = classNames(["".concat(prefix, "select"), "".concat(prefix, "select-auto-complete"), "".concat(prefix, "size-").concat(size), className], (_a = {},
        ...
        return (React.createElement("span", __assign({}, othersData, { className: triggerClazz, style: style, dir: rtl ? 'rtl' : undefined, ref: this.saveSelectRef, onClick: this.focusInput }),
            React.createElement(Input, __assign({ role: "combobox", "aria-autocomplete": "list", "aria-disabled": disabled, "aria-expanded": this.state.visible }, _inputProps)),
    ...
    AutoComplete.propTypes = __assign(__assign({}, Base.propTypes), { 
        /**
         * 当前值，用于受控模式
         */
        ...
        highlightHolder: PropTypes.bool, style: PropTypes.object });
