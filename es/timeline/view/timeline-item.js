...
var TimelineItem = /** @class */ (function (_super) {
    ...
    TimelineItem.propTypes = __assign(__assign({}, ConfigProvider.propTypes), { prefix: PropTypes.string, index: PropTypes.number, total: PropTypes.number, folderIndex: PropTypes.number, foldShow: PropTypes.bool, 
        /**
         * 节点状态
         */
         ...
         * 右侧内容
         */
        content: PropTypes.node, toggleFold: PropTypes.func, className: PropTypes.string, locale: PropTypes.object, 
        /**
         * 动画
         */
