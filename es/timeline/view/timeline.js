...
var Timeline = /** @class */ (function (_super) {
    ...
    Timeline.propTypes = __assign(__assign({}, ConfigProvider.propTypes), { 
        /**
         * 样式的品牌前缀
         */
         ...
         * 自定义类名
         */
        className: PropTypes.string, children: PropTypes.any, locale: PropTypes.object, animation: PropTypes.bool, 
        /**
         * 展示的模式
         * @enumdesc 左, 交错显示
         * @version 1.23.18
