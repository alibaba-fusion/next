...
var RangePicker = (_temp = _class = function (_Component) {
    ...
    function RangePicker(props, context) {
        ...
        _this.onDateInputKeyDown = function (e) {
            ...
            var dateStr = onDateKeydown(e, { format: format, value: _this.state[activeDateInput], dateInputStr: dateInputStr }, 'day');
            if (!dateStr) return;
        ...
        _this.getDisabledTime = function (_ref2) {
            var startValue = _ref2.startValue,
                endValue = _ref2.endValue;

            var _ref3 = _this.props.showTime || {},
    ...
    RangePicker.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['prefix', 'rtl', 'defaultVisibleMonth', 'onVisibleMonthChange', 'showTime', 'disabledDate', 'footerRender', 'label', 'state', 'size', 'disabled', 'hasClear', 'popupTriggerType', 'popupAlign', 'popupContainer', 'popupStyle', 'popupClassName', 'popupProps', 'className', 'locale', 'inputProps', 'dateCellRender', 'startDateInputAriaLabel', 'startTimeInputAriaLabel', 'endDateInputAriaLabel', 'endTimeInputAriaLabel']);
