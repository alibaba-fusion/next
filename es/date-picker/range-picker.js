                    ...
                    if (showTime) {
                        if (!prevStartValue) {
                            ...
                            if (showTime.defaultValue) {
                                var defaultTimeValue = formatDateValue(showTime.defaultValue, _this3.timeFormat);
            ...
            case 'endValue':
                ...
                if (showTime) {
                    if (!prevEndValue) {
                        // 第一次选择，如果设置了时间默认值，则使用该默认时间
                        if (showTime.defaultValue) {
                            var _defaultTimeValue = formatDateValue(showTime.defaultValue, _this3.timeFormat);
