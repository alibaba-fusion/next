...
var CascaderMenuItem = (_temp = _class = function (_Component) {
    ...
    CascaderMenuItem.prototype.render = function render() {
        ...
        return React.createElement(
            ...
            itemProps,
            children,
            canExpand ? loading ? React.createElement(Icon, { className: prefix + 'cascader-menu-icon-right ' + prefix + 'cascader-menu-icon-loading', type: 'loading' }) : React.createElement(Icon, { className: prefix + 'cascader-menu-icon-right ' + prefix + 'cascader-menu-icon-expand', type: 'arrow-right' }) : null
        );
    };
