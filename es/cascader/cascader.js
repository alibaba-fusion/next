...
var pickOthers = obj.pickOthers, pickProps = obj.pickProps;
...
var getFormatMenuProps = function (others) {
    var targetProps = pickProps(ViewMenu.propTypes, others);
    var targetMenuProps = pickOthers(__assign({ value: false, onChange: false, defaultValue: false, focusedKey: false, onItemFocus: false, focusable: false, onBlur: false }, ConfigProvider.propTypes), targetProps);
    return __assign(__assign({}, targetMenuProps), { isSelectIconRight: false });
};
/**
 * Cascader
 */
var Cascader = /** @class */ (function (_super) {
    ...
    function Cascader(props) {
        ...
        _this.lastExpandedValue = __spreadArray([], __read(st.expandedValue), false);
        _this.state = __assign(__assign({}, st), { _v2n: v2n, _p2n: p2n });
        bindCtx(_this, [
            'handleMouseLeave',
            'handleFocus',
            'handleFold',
    ...
    Cascader.getDerivedStateFromProps = function (props, state) {
        ...
        return __assign(__assign({}, states), { _v2n: v2n, _p2n: p2n });
    };
    ...
    Cascader.prototype.handleSelect = function (v, canExpand) {
        ...
        if (canExpand) {
            ...
            this.lastExpandedValue = __spreadArray([], __read(this.state.expandedValue), false);
        }
    };
    Cascader.prototype.handleCheck = function (v, checked) {
        ...
        var value = __spreadArray([], __read(this.state.value), false);
    ...
    Cascader.prototype.handleMouseLeave = function () {
        this.setExpandValue(__spreadArray([], __read(this.lastExpandedValue), false), true);
    };
    ...
    Cascader.prototype.getIndeterminate = function (value) {
        ...
        var poss = filterChildValue(value
    ...
    Cascader.prototype.renderMenu = function (data, level) {
        var _this = this;
        var _a = this.props, prefix = _a.prefix, multiple = _a.multiple, useVirtual = _a.useVirtual, checkStrictly = _a.checkStrictly, expandTriggerType = _a.expandTriggerType, loadData = _a.loadData, canOnlyCheckLeaf = _a.canOnlyCheckLeaf, listClassName = _a.listClassName, listStyle = _a.listStyle, itemRender = _a.itemRender, others = __rest(_a, ["prefix", "multiple", "useVirtual", "checkStrictly", "expandTriggerType", "loadData", "canOnlyCheckLeaf", "listClassName", "listStyle", "itemRender"]);
        var _b = this.state, value = _b.value, expandedValue = _b.expandedValue, focusedValue = _b.focusedValue;
        return (React.createElement(CascaderMenu, __assign({}, getFormatMenuProps(others), { key: level, prefix: prefix, useVirtual: useVirtual, className: listClassName, style: listStyle, focusedKey: focusedValue, onItemFocus: this.handleFocus, onBlur: this.onBlur }), data
            .map(function (item) {
            ...
            return (React.createElement(CascaderMenuItem, __assign({ key: item.value }, props), itemContent));
        })
    ...
    Cascader.prototype.renderFilteredItem = function (path) {
        ...
        if (multiple) {
            ...
            props = __assign(__assign({}, props), { checked: value.indexOf(lastItem.value) > -1, indeterminate: !checkStrictly &&
                    !canOnlyCheckLeaf &&
            ...
            Item = Menu.Item;
            props = __assign(__assign({}, props), { selected: value[0] === lastItem.value, onSelect: this.handleSelect.bind(this, lastItem.value, false) });
        }
        return React.createElement(Item, __assign({ key: lastItem.value }, props));
    };
    Cascader.prototype.renderFilteredList = function () {
        var _this = this;
        var _a = this.props, prefix = _a.prefix, filteredListStyle = _a.filteredListStyle, filteredPaths = _a.filteredPaths, _b = _a.focusable, focusable = _b === void 0 ? false : _b, others = __rest(_a, ["prefix", "filteredListStyle", "filteredPaths", "focusable"]);
        var focusedValue = this.state.focusedValue;
        return (React.createElement(Menu, __assign({}, getFormatMenuProps(others), { 
    ...
    Cascader.prototype.render = function () {
        ...
        var others = pickOthers(__assign(__assign({}, Cascader.propTypes), ViewMenu.propTypes), this.props);
        var value = this.state.value;
        if (rtl) {
            others.dir = 'rtl';
        }
        var props = __assign({ className: cx((_a = {},
        ...
        return (React.createElement("div", __assign({}, props, { ref: this.getCascaderNode }), !searchValue ? (React.createElement("div", { className: "".concat(prefix, "cascader-inner"), ref: this.getCascaderInnerNode }, dataSource && dataSource.length ? this.renderMenus() : null)) : (this.renderFilteredList())));
    };
    Cascader.propTypes = {
