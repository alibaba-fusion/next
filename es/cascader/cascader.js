...
var Cascader = /** @class */ (function (_super) {
    ...
    Cascader.prototype.renderMenu = function (data, level) {
        ...
        return (React.createElement(CascaderMenu, { key: level, prefix: prefix, useVirtual: useVirtual, className: listClassName, style: listStyle, ref: this.saveMenuRef, focusedKey: focusedValue, onItemFocus: this.handleFocus, onBlur: this.onBlur }, data
            .map(function (item) {
            ...
            if (multiple) {
                ...
                props.indeterminate =
                    (checkStrictly || canOnlyCheckLeaf
                        ? false
                        : _this.indeterminate.indexOf(item.value) > -1) || !!item.indeterminate;
