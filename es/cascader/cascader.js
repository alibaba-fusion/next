...
var Cascader = (_temp = _class = function (_Component) {
    ...
    Cascader.prototype.setCache = function setCache(data) {
        ...
        data.forEach(function (item, index) {
            ...
            _this3._v2n[value] = _this3._p2n[pos] = _extends({}, item, { pos: pos, _source: item });
    ...
    Cascader.prototype.renderMenu = function renderMenu(data, level) {
        ...
        return React.createElement(
            CascaderMenu,
            { key: level, prefix: prefix, useVirtual: useVirtual, className: listClassName, style: listStyle, focusedKey: focusedValue, onItemFocus: this.handleFocus },
