...
var EventHandlers = {
    ...
    swipeMove: function (e) {
        ...
        var curLeft = getTrackLeft(__assign(__assign({ slideIndex: this.state.currentSlide, trackRef: this.refs.track }, this.props), this.state));
        ...
        this.setState({
            ...
            swipeLeft: swipeLeft,
            trackStyle: getTrackCSS(__assign(__assign({ left: swipeLeft }, this.props), this.state)),
        });
        ...
        if (this.props.swipeToSlide) {
            ...
            Array.from(slides).every(function (slide) {
                if (!_this.props.vertical) {
                    if (slide.offsetLeft - centerOffset + (_this.getWidth(slide) || 0) / 2 >
                        _this.state.swipeLeft * -1) {
                        swipedSlide_1 = slide;
                        return false;
                    }
                }
                else if (slide.offsetTop + (_this.getHeight(slide) || 0) / 2 >
                    _this.state.swipeLeft * -1) {
                    swipedSlide_1 = slide;
                    return false;
                }
            ...
            Math.abs(swipedSlide_1.dataset.index - this.state.currentSlide) || 1;
    ...
    swipeEnd: function (e) {
        ...
        if (touchObject.swipeLength > minSwipe) {
            ...
            var currentLeft = getTrackLeft(__assign(__assign({ slideIndex: this.state.currentSlide, trackRef: this.track }, this.props), this.state));
            this.setState({
                trackStyle: getTrackAnimateCSS(__assign(__assign({ left: currentLeft }, this.props), this.state)),
            });
        }
    },
