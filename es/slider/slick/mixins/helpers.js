...
var helpers = {
    initialize: function (props) {
        ...
        var trackWidth = this.getWidth(ReactDOM.findDOMNode(this.track)) || 0;
        var slideWidth;
        if (!props.vertical) {
        ...
        try {
            for (var newSlickList_1 = __values(newSlickList), newSlickList_1_1 = newSlickList_1.next(); !newSlickList_1_1.done; newSlickList_1_1 = newSlickList_1.next()) {
        ...
        this.setState({
            ...
            var targetLeft = getTrackLeft(__assign(__assign({ slideIndex: _this.state.currentSlide, trackRef: _this.track }, props), _this.state));
            // getCSS function needs previously set state
            var trackStyle = getTrackCSS(__assign(__assign({ left: targetLeft }, props), _this.state));
    ...
    slideHandler: function (index) {
        ...
        var targetLeft = getTrackLeft(__assign(__assign({ slideIndex: targetSlide, trackRef: this.track }, this.props), this.state));
        var currentLeft = getTrackLeft(__assign(__assign({ slideIndex: currentSlide, trackRef: this.track }, this.props), this.state));
        if (this.props.infinite === false) {
        ...
        if (this.props.useCSS === false) {
            this.setState({
                currentSlide: currentSlide,
                trackStyle: getTrackCSS(__assign(__assign({ left: currentLeft }, this.props), this.state)),
            }, function () {
            ...
            this.setState({
                animating: true,
                currentSlide: currentSlide,
                trackStyle: getTrackAnimateCSS(__assign(__assign({ left: targetLeft }, this.props), this.state)),
            }, function () {
                this.animationEndCallback = setTimeout(callback, this.props.speed + 20);
            });
        }
    ...
    arrowHoverHandler: function (msg) {
        ...
        var targetLeft = getTrackLeft(__assign(__assign({ slideIndex: this.state.currentSlide, trackRef: this.track }, this.props), this.state));
        var left;
        ...
        this.setState({
            trackStyle: getTrackAnimateCSS(__assign(__assign({ left: left }, this.props), this.state)),
        });
    },
    ...
    play: function () {
        ...
        else if (this.canGoNext(__assign(__assign({}, this.props), this.state))) {
            nextIndex = this.state.currentSlide + this.props.slidesToScroll;
        }
        else {
            return false;
