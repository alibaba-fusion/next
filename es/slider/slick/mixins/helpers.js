...
var helpers = {
    initialize: function initialize(props) {
        ...
        this.setState({
            ...
            var trackStyle = getTrackCSS(_extends({ left: targetLeft }, props, _this.state));
    ...
    slideHandler: function slideHandler(index) {
        ...
        if (this.props.useCSS === false) {
            this.setState({
                currentSlide: currentSlide,
                trackStyle: getTrackCSS(_extends({ left: currentLeft }, this.props, this.state))
            }, function () {
            ...
            this.setState({
                animating: true,
                currentSlide: currentSlide,
                trackStyle: getTrackAnimateCSS(_extends({ left: targetLeft }, this.props, this.state))
            }, function () {
                this.animationEndCallback = setTimeout(callback, this.props.speed + 20);
            });
        }
