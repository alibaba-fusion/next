...
var Slider = /** @class */ (function (_super) {
    ...
    Slider.prototype.render = function () {
        ...
        var clazz = classNames(["".concat(prefix, "slick"), "".concat(prefix, "slick-").concat(arrowPosition), "".concat(prefix, "slick-").concat(slideDirection)], className);
        ...
        return (React.createElement(ConfigProvider, __assign({}, globalProps, { rtl: false }),
            React.createElement("div", __assign({ dir: "ltr", className: clazz, style: style }, obj.pickOthers(__assign(__assign({}, Slider.propTypes), InnerSlider.propTypes), sliderProps)),
                React.createElement(InnerSlider, __assign({ ref: function (InnerSlider) { return (_this.innerSlider = InnerSlider); } }, sliderProps)))));
    };
    Slider.propTypes = {
