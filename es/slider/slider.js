...
var Slider = (_temp2 = _class = function (_Component) {
  ...
  Slider.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        _extends({ role: 'toolbar', dir: 'ltr', className: clazz, style: style }, obj.pickOthers(_extends({}, Slider.propTypes, InnerSlider.propTypes), sliderProps)),
        React.createElement(InnerSlider, _extends({ ref: function ref(InnerSlider) {
