...
var Group = /** @class */ (function (_super) {
    ...
    Group.prototype.render = function () {
        var _a;
        var _b = this.props, root = _b.root, className = _b.className, label = _b.label, children = _b.children, parentMode = _b.parentMode, others = __rest(_b, ["root", "className", "label", "children", "parentMode"]);
