...
var Menu = (_temp = _class = function (_Component) {
    ...
    Menu.prototype.componentDidUpdate = function componentDidUpdate(prevProps, prevState) {
        if (prevState.lastVisibleIndex !== this.state.lastVisibleIndex || React.Children.toArray(this.props.children).length !== React.Children.toArray(prevProps.children).length) {
            this.adjustChildrenWidth();
        }
    };
    ...
    Menu.prototype.render = function render() {
        ...
        var footerElement = footer ? React.createElement(
            'li',
            {
                className: cx((_cx3 = {}, _cx3[prefix + 'menu-footer'] = true, _cx3[footerWrapperClassName] = !!footerWrapperClassName, _cx3)),
