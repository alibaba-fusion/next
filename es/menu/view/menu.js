...
var Menu = (_temp = _class = function (_Component) {
    ...
    Menu.prototype.getIndicatorsItem = function getIndicatorsItem(items, isPlaceholder) {
        ...
        var moreCls = cx((_cx2 = {}, _cx2[prefix + 'menu-more'] = true, _cx2));
    ...
    Menu.prototype.render = function render() {
        ...
        var newClassName = cx((_cx3 = {}, _cx3[prefix + 'menu'] = true, _cx3[prefix + 'ver'] = direction === 'ver', _cx3[prefix + 'hoz'] = direction === 'hoz', _cx3[prefix + 'menu-embeddable'] = embeddable, _cx3[prefix + 'menu-nowrap'] = hozInLine, _cx3[className] = !!className, _cx3));
