...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.render = function () {
        ...
        var footerElement = footer ? (React.createElement("li", { className: cx((_b = {},
        ...
        return (React.createElement("ul", __assign({ role: role, onBlur: this.onBlur, className: newClassName, onKeyDown: this.handleEnter, "aria-multiselectable": ariaMultiselectable }, others),
            headerElement,
    ...
    Menu.propTypes = __assign(__assign({}, ConfigProvider.propTypes), { prefix: PropTypes.string, pure: PropTypes.bool, rtl: PropTypes.bool, className: PropTypes.string, 
        /**
         * 菜单项和子菜单
         */
         ...
         * 内连子菜单缩进距离
         */
        inlineIndent: PropTypes.number, inlineArrowDirection: PropTypes.oneOf(['down', 'right']), 
        /**
         ...
         */
        hasSelectedIcon: PropTypes.bool, labelToggleChecked: PropTypes.bool, 
        /**
         ...
         */
        hozInLine: PropTypes.bool, renderMore: PropTypes.func, 
        /**
         * 自定义菜单头部
         */
         ...
         */
        focusedKey: PropTypes.oneOfType([PropTypes.string, PropTypes.number, PropTypes.object]), focusable: PropTypes.bool, onItemFocus: PropTypes.func, onBlur: PropTypes.func, 
        /**
         * 是否开启嵌入式模式，一般用于Layout的布局中，开启后没有默认背景、外层border、box-shadow，可以配合`<Menu style={{lineHeight: '100px'}}>` 自定义高度
         * @version 1.18
         */
        embeddable: PropTypes.bool, onItemKeyDown: PropTypes.func, expandAnimation: PropTypes.bool, itemClassName: PropTypes.string, 
        /**
