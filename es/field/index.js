...
import { getValueFromEvent, getErrorStrs, getParams, setIn, getIn, deleteIn, mapValidateRules } from './utils';
...
var Field = function () {
    ...
    Field.prototype.getValues = function getValues(names) {
        ...
        if (names && names.length) {
            ...
            _extends(allValues, this.values);
        }
    ...
    Field.prototype.setValues = function setValues() {
        ...
        if (!this.options.parseName) {
            ...
            this.values = _extends({}, this.values, fieldsValue);
            var fields = this.getNames();
            fields.forEach(function (name) {
                var value = getIn(_this5.values, name);
                if (value !== undefined) {
                    ...
                    _this5.values = setIn(_this5.values, name, _this5.fieldsMeta[name].value);
                }
            });
        }
        reRender && this._reRender();
    ...
    Field.prototype.validate = function validate(ns, cb) {
        ...
        validate.validate(values, function (errors) {
            ...
            if (formattedGetErrors) {
                errorsGroup = _extends({}, formattedGetErrors, errorsGroup);
            }
        ...
        names.forEach(function (name) {
            ...
            if (field) {
                ...
                if (_this9.options.parseName) {
                    _this9.values = setIn(_this9.values, name, field.value);
                } else {
    ...
    Field.prototype.remove = function remove(ns) {
        ...
        names.forEach(function (name) {
            ...
            if (_this10.options.parseName) {
                _this10.values = deleteIn(_this10.values, name);
            } else {
