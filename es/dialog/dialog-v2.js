...
var Dialog = function Dialog(props) {
    ...
    var _props$prefix = props.prefix,
        ...
        useCapture = _props$useCapture === undefined ? false : _props$useCapture,
        others = _objectWithoutProperties(props, ['prefix', 'afterClose', 'hasMask', 'autoFocus', 'className', 'title', 'children', 'footer', 'footerAlign', 'footerActions', 'onOk', 'onCancel', 'okProps', 'cancelProps', 'locale', 'rtl', 'visible', 'closeMode', 'closeIcon', 'animation', 'cache', 'wrapperStyle', 'popupContainer', 'dialogRender', 'centered', 'top', 'bottom', 'width', 'height', 'isFullScreen', 'overflowScroll', 'minMargin', 'onClose', 'style', 'wrapperClassName', 'useCapture']);
    ...
    var wrapperCls = classNames((_classNames = {}, _classNames[prefix + 'overlay-wrapper'] = true, _classNames[wrapperClassName] = !!wrapperClassName, _classNames.opened = visible, _classNames));
    ...
    var inner = React.createElement(
        ...
        React.createElement(
            Inner,
            _extends({}, others, {
                style: centered ? _extends({}, topStyle, innerStyle) : innerStyle,
                v2: true,
                ref: dialogRef,
                prefix: prefix,
                className: dialogCls,
