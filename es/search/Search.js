...
var Search = (_temp = _class = function (_React$Component) {
    ...
    Search.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            rtl = _props.rtl,
            others = _objectWithoutProperties(_props, ['shape', 'filter', 'hasIcon', 'disabled', 'placeholder', 'type', 'className', 'style', 'size', 'prefix', 'searchText', 'dataSource', 'filterProps', 'buttonProps', 'popupContent', 'hasClear', 'visible', 'rtl']);
        ...
        if (shape === 'simple') {
            ...
            searchIcon = React.createElement(Icon, _extends({}, buttonProps, { type: 'search', tabIndex: '0', role: 'button', 'aria-disabled': disabled, className: _cls, onClick: this.onSearch, onKeyDown: this.onKeyDown }));
        } else {
            var _classNames3;
            ...
            searchBtn = React.createElement(
                Button,
                _extends({}, buttonProps, { tabIndex: '0', className: _cls2, onClick: this.onSearch, onKeyDown: this.onKeyDown, disabled: disabled }),
