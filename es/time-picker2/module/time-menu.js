...
var TimeMenu = (_temp2 = _class = function (_React$Component) {
    ...
    function TimeMenu() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.prefixCls = _this.props.prefix + 'time-picker2', _this._menuRefHandler = function (ref) {
            _this.menu = ref;
            ...
            return list.map(function (_ref) {
                ...
                var itemCls = classnames((_classnames = {}, _classnames[_this.prefixCls + '-menu-item'] = true, _classnames[prefix + 'disabled'] = isDisabled, _classnames[prefix + 'selected'] = value === activeIndex, _classnames));
