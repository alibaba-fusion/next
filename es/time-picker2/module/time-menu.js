...
var TimeMenu = /** @class */ (function (_super) {
        ...
        _this.createMenuItems = function (list) {
            ...
            return list.map(function (_a) {
                ...
                var itemCls = classnames((_b = {},
                    _b["".concat(_this.prefixCls, "-menu-item")] = true,
                ...
                return (React.createElement("li", { role: "option", "aria-selected": String(value === activeIndex), key: value, title: value, className: itemCls, onClick: onClick }, label));
            });
        };
        return _this;
    }
    ...
    TimeMenu.prototype.render = function () {
        var _a = this.props, mode = _a.mode, step = _a.step;
        ...
        return (React.createElement("div", { className: "".concat(this.prefixCls, "-menu"), ref: this._menuWrapperRefHandler },
            React.createElement("ul", { role: "listbox", className: "".concat(this.prefixCls, "-menu-").concat(mode), ref: this._menuRefHandler }, this.createMenuItems(list))));
    };
    TimeMenu.propTypes = {
