...
function getRule(ruleName, props) {
    var _a;
    return _a = {},
        _a[ruleName] = props[ruleName],
        _a.message = getCfgFromProps(props, "".concat(ruleName, "Message")),
        _a.trigger = getCfgFromProps(props, "".concat(ruleName, "Trigger")),
        _a;
}
...
export function getRules(props, labelForErrorMessage) {
    ...
    if (minLength || maxLength) {
        result.push({
            ...
            message: getCfgFromProps(props, 'minmaxLengthMessage') ||
                getCfgFromProps(props, 'minLengthMessage') ||
                getCfgFromProps(props, 'maxLengthMessage'),
            trigger: getCfgFromProps(props, 'minmaxLengthTrigger') ||
    ...
    if (max || min) {
        result.push({
            ...
            message: getCfgFromProps(props, 'minmaxMessage') ||
                getCfgFromProps(props, 'minMessage') ||
                getCfgFromProps(props, 'maxMessage'),
            trigger: getCfgFromProps(props, 'minmaxTrigger') ||
