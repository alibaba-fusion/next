...
var Error = (_temp2 = _class = function (_React$Component) {
    ...
    Error.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['children', 'name', 'prefix', 'style', 'className', 'field', 'preferMarginToDisplayHelp']);
        ...
        if (children && typeof children !== 'function') {
            return React.createElement(
                ...
                children,
                !!preferMarginToDisplayHelp && React.createElement('div', { className: prefix + 'form-item-help-margin-offset' })
            );
        }
