...
var Form = /** @class */ (function (_super) {
    ...
    Form.prototype.render = function () {
        ...
        return (React.createElement(Tag, __assign({ role: "grid" }, obj.pickOthers(Form.propTypes, this.props), { className: formClassName, style: style, dir: rtl ? 'rtl' : undefined, onSubmit: onSubmit }), responsive ? React.createElement(RGrid, { gap: gap }, newChildren) : newChildren));
    };
    Form.propTypes = {
        /**
         * 样式前缀
