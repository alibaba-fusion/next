...
var YearPanelHeader = /** @class */ (function (_super) {
    ...
    YearPanelHeader.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "".concat(prefix, "calendar-panel-header") },
            React.createElement("button", { role: "button", type: "button", title: locale.prevDecade, className: "".concat(btnCls, " ").concat(btnCls, "-prev-decade"), onClick: goPrevDecade },
            ...
            React.createElement("div", { className: "".concat(prefix, "calendar-panel-header-full") },
                React.createElement("button", { role: "button", type: "button", title: decadeLable, className: btnCls }, decadeLable)),
            React.createElement("button", { role: "button", type: "button", title: locale.nextDecade, className: "".concat(btnCls, " ").concat(btnCls, "-next-decade"), onClick: goNextDecade },
