...
var DatePanelHeader = /** @class */ (function (_super) {
    ...
    DatePanelHeader.prototype.render = function () {
        ...
        var monthButton = (React.createElement("button", { role: "button", type: "button", className: btnCls, title: monthLabel, onClick: function () { return changeMode('month', 'start'); } }, monthLabel));
        var yearButton = (React.createElement("button", { role: "button", type: "button", className: btnCls, title: yearLabel, onClick: function () { return changeMode('year', 'start'); } }, yearLabel));
        if (disableChangeMode) {
            var months = getMonths(momentLocale);
            var years = getYears(yearRange, yearRangeOffset, visibleMonth.year());
            monthButton = (React.createElement(Dropdown, { align: "tc bc", container: this.selectContainerHandler, trigger: React.createElement("button", { role: "button", type: "button", className: btnCls, title: monthLabel },
                    monthLabel,
            ...
            yearButton = (React.createElement(Dropdown, { align: "tc bc", container: this.selectContainerHandler, trigger: React.createElement("button", { role: "button", type: "button", className: btnCls, title: yearLabel },
                    yearLabel,
                    React.createElement(Icon, { type: "arrow-down" })), triggerType: "click" },
