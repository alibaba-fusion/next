...
var Calendar = (_temp = _class = function (_Component) {
    ...
    Calendar.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['prefix', 'rtl', 'className', 'shape', 'showOtherMonth', 'format', 'locale', 'dateCellRender', 'monthCellRender', 'yearCellRender', 'disabledDate', 'yearRange']);
        ...
        return React.createElement(
            ...
            shape === 'panel' ? panelHeaders[state.mode] : React.createElement(CardHeader, _extends({}, headerProps, { yearRange: yearRange })),
            tables[state.mode]
        );
    };
