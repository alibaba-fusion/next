...
var Calendar = (_temp = _class = function (_Component) {
    ...
    Calendar.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['prefix', 'className', 'shape', 'showOtherMonth', 'locale', 'dateCellRender', 'monthCellRender', 'disabledDate']);
        ...
        var tables = (_tables = {}, _tables[CALENDAR_MODE_DATE] = React.createElement(DateTable, _extends({}, tableProps, { onSelectDate: this.onSelectCell })), _tables[CALENDAR_MODE_MONTH] = React.createElement(MonthTable, _extends({}, tableProps, { onSelectMonth: this.onSelectCell })), _tables[CALENDAR_MODE_YEAR] = React.createElement(YearTable, _extends({}, tableProps, { onSelectYear: this.onSelectCell })), _tables);
