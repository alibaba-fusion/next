        ...
        for (var i = 0; i < YEAR_TABLE_ROW_COUNT; i++) {
            ...
            for (var j = 0; j < YEAR_TABLE_COL_COUNT; j++) {
                ...
                rowElements.push(React.createElement("td", { key: "".concat(i, "-").concat(j), className: classNames, role: "cell" },
                    React.createElement("div", { className: "".concat(prefix, "calendar-year"), onClick: onClick, title: title, "aria-disabled": isDisabled ? 'true' : 'false', "aria-selected": isSelected ? 'true' : 'false' }, content)));
            }
