    ...
    MonthTable.prototype.render = function () {
        ...
        for (var i = 0; i < MONTH_TABLE_ROW_COUNT; i++) {
            ...
            for (var j = 0; j < MONTH_TABLE_COL_COUNT; j++) {
                ...
                rowList.push(React.createElement("td", { key: counter, title: localedMonth, onClick: isDisabled ? undefined : this.onMonthCellClick.bind(this, monthDate), className: elementCls, role: "cell", "aria-disabled": isDisabled ? 'true' : 'false', "aria-selected": isSelected ? 'true' : 'false' },
