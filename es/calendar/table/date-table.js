...
var DateTable = /** @class */ (function (_super) {
    ...
    DateTable.prototype.render = function () {
        ...
        for (var i = 0; i < CALENDAR_TABLE_ROW_COUNT; i++) {
            ...
            for (var j = 0; j < CALENDAR_TABLE_COL_COUNT; j++) {
                ...
                var elementCls = classNames((_a = {},
                    ...
                    _a));
                weekElements.push(React.createElement("td", { key: counter, title: currentDate.format(format), onClick: isDisabled ? undefined : onSelectDate.bind(null, currentDate), className: elementCls, role: "cell", "aria-disabled": isDisabled ? 'true' : 'false', "aria-selected": isSelected ? 'true' : 'false' },
        ...
        return (React.createElement("table", { className: "".concat(prefix, "calendar-table"), role: "grid" },
            ...
            React.createElement("tbody", { className: "".concat(prefix, "calendar-tbody"), role: "rowgroup" }, monthElements)));
    };
    return DateTable;
}(PureComponent));
