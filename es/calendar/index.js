...
var transform = function (props, deprecated) {
    var type = props.type, onChange = props.onChange, base = props.base, disabledMonth = props.disabledMonth, disabledYear = props.disabledYear, others = __rest(props, ["type", "onChange", "base", "disabledMonth", "disabledYear"]);
    var newProps = others;
    if ('type' in props) {
