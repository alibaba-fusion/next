...
var RangeCalendar = /** @class */ (function (_super) {
    ...
    RangeCalendar.propTypes = __assign(__assign({}, ConfigProvider.propTypes), { 
        /**
         * 样式前缀
         */
        prefix: PropTypes.string, rtl: PropTypes.bool, 
        /**
         * 默认的开始日期
         */
        ...
        format: PropTypes.string, yearRange: PropTypes.arrayOf(PropTypes.number), 
        /**
         * 是否显示非本月的日期
         */
         ...
         * @returns {ReactNode}
         */
        monthCellRender: PropTypes.func, yearCellRender: PropTypes.func, locale: PropTypes.object, className: PropTypes.string });
