...
var RangeCalendar = (_temp = _class = function (_React$Component) {
    ...
    RangeCalendar.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = _objectWithoutProperties(_props, ['prefix', 'dateCellRender', 'className', 'format', 'locale', 'showOtherMonth', 'disabledDate']);
            ...
            case CALENDAR_MODE_DATE:
                {
                    table = [React.createElement(
                        ...
                        React.createElement(DateTable, _extends({ format: format }, tableProps, { visibleMonth: startVisibleMonth, onSelectDate: this.onSelectCell }))
                    ), React.createElement(
                        'div',
                        { className: prefix + 'calendar-body-right', key: 'right-panel' },
                        React.createElement(DateTable, _extends({ format: format }, tableProps, { visibleMonth: endVisibleMonth, onSelectDate: this.onSelectCell }))
                    )];
