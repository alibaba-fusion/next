    ...
    NumberPicker.prototype.render = function render() {
        ...
        if (type === 'normal') {
            innerAfter = [React.createElement(
                Button,
                _extends({}, upBtnProps, { onMouseDown: this.handleMouseDown, disabled: disabled || upDisabled, onClick: this.up.bind(this), key: '0' }),
                React.createElement(Icon, { size: 'xxs', type: 'arrow-up' })
            ), React.createElement(
                Button,
                _extends({}, downBtnProps, { onMouseDown: this.handleMouseDown, disabled: disabled || downDisabled, onClick: this.down.bind(this), key: '1' }),
            ...
            addonBefore = React.createElement(
                Button,
                _extends({}, downBtnProps, { size: size, disabled: disabled || downDisabled, onClick: this.down.bind(this) }),
                React.createElement(Icon, { type: 'minus', size: 'xs' })
            );
            addonAfter = React.createElement(
                Button,
                _extends({}, upBtnProps, { size: size, disabled: disabled || upDisabled, onClick: this.up.bind(this) }),
