...
var NumberPicker = /** @class */ (function (_super) {
    ...
    function NumberPicker(props) {
        ...
        _this.onBlur = function (e) {
            ...
            if (editable === true &&
                ...
                valueCorrected = stringMode
                    ? Big(valueCorrected).toFixed(_this.getPrecision())
                    : valueCorrected;
        ...
        _this.onKeyDown = function (e) {
            ...
            onKeyDown && onKeyDown.apply(void 0, __spreadArray([e], __read(args), false));
        };
    ...
    NumberPicker.prototype.render = function () {
        ...
        if (type === 'normal') {
            extra = (React.createElement("span", { className: "".concat(prefixCls, "-handler") },
                React.createElement(Button, __assign({}, upBtnProps, { onMouseDown: this.handleMouseDown, disabled: disabled, className: "".concat(upBtnProps.className || '', " ").concat(upDisabled ? 'disabled' : ''), onClick: this.up.bind(this, upDisabled), tabIndex: -1, "aria-label": "icon-up" }),
                    React.createElement(Icon, { type: "arrow-up", className: "".concat(prefixCls, "-up-icon") })),
                React.createElement(Button, __assign({}, downBtnProps, { onMouseDown: this.handleMouseDown, disabled: disabled, className: "".concat(downBtnProps.className || '', " ").concat(downDisabled ? 'disabled' : ''), onClick: this.down.bind(this, downDisabled), tabIndex: -1, "aria-label": "icon-down" }),
                    React.createElement(Icon, { type: "arrow-down", className: "".concat(prefixCls, "-down-icon") }))));
        }
        else {
            addonBefore = (React.createElement(Button, __assign({}, downBtnProps, { size: size, disabled: disabled, className: "".concat(downBtnProps.className || '', " ").concat(downDisabled ? 'disabled' : ''), onClick: this.down.bind(this, downDisabled), tabIndex: -1, "aria-label": "icon-minus" }),
                React.createElement(Icon, { type: "minus", className: "".concat(prefixCls, "-minus-icon") })));
            addonAfter = (React.createElement(Button, __assign({}, upBtnProps, { size: size, disabled: disabled, className: "".concat(upBtnProps.className || '', " ").concat(upDisabled ? 'disabled' : ''), onClick: this.up.bind(this, upDisabled), tabIndex: -1, "aria-label": "icon-add" }),
