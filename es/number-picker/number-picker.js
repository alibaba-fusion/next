...
var NumberPicker = (_temp = _class = function (_React$Component) {
    ...
    NumberPicker.prototype.onChange = function onChange(value, e) {
        if (this.props.editable === true) {
            ...
            if (value) {
                ...
                if (dotIndex > -1) {
                    if (precisionSet === 0) value = value.substr(0, dotIndex);else if (precisionCurrent > precisionSet) value = value.substr(0, dotIndex + 1 + precisionSet);
                }
    ...
    NumberPicker.prototype.renderValue = function renderValue() {
        ...
        return typeof format === 'function' && !hasFocused ? format(value) : typeof value === 'number' && 1 / value === -Infinity ? '-0' : value;
    };
