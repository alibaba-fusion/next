...
var create = function (props) {
    ...
    var mask, myRef, destroyed = false;
...
var withContext = function (WrappedComponent) {
    var HOC = function (props) {
        return (react_1.default.createElement(config_provider_1.default.Consumer, null, function (contextConfig) { return (react_1.default.createElement(WrappedComponent, tslib_1.__assign({}, props, { contextMessage: {
