...
var Message = (_temp2 = _class = function (_Component) {
    ...
    Message.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'pure', 'className', 'type', 'shape', 'size', 'title', 'children', 'defaultVisible', 'visible', 'iconType', 'closeable', 'onClose', 'afterClose', 'animation', 'rtl', 'locale']);
        /* eslint-enable */
        ...
        var newChildren = visible ? _react2.default.createElement(
            'div',
            (0, _extends3.default)({ role: 'alert' }, others, { className: classes, dir: rtl ? 'rtl' : undefined }),
            closeable ? _react2.default.createElement(
                'a',
                { role: 'button', 'aria-label': locale.closeAriaLabel, href: 'javascript:;', className: messagePrefix + '-close', onClick: this.onClose },
