...
var Rating = (_temp = _class = function (_Component) {
    ...
    Rating.prototype.render = function render() {
        ...
        var _loop = function _loop(i) {
            ...
            var iconCls = (0, _classnames2.default)((_classNames4 = {
                hover: hoverValue > 0 && isCurrent,
                clicked: clicked && isCurrent
            }, _classNames4[prefix + 'rating-symbol-icon'] = !iconType, _classNames4));
            var iconNode = iconType ? _react2.default.createElement(_icon2.default, { type: iconType, size: sizeMap, className: iconCls }) : _react2.default.createElement(_icon2.default, { type: 'favorites-filling', size: sizeMap, className: iconCls });
        ...
        if (isPreview && 'renderPreview' in this.props) {
            return _react2.default.createElement(
                'div',
                (0, _extends3.default)({ id: id }, others, { className: previewCls }),
...
exports.default = (0, _reactLifecyclesCompat.polyfill)(Rating);
