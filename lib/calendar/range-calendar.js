...
var RangeCalendar = (_temp = _class = function (_React$Component) {
    ...
    RangeCalendar.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'dateCellRender', 'className', 'locale', 'showOtherMonth', 'disabledDate']);
            ...
            case _utils.CALENDAR_MODE_DATE:
                {
                    table = [_react2.default.createElement(
                        ...
                        _react2.default.createElement(_dateTable2.default, (0, _extends3.default)({}, tableProps, { visibleMonth: startVisibleMonth, onSelectDate: this.onSelectCell }))
                    ), _react2.default.createElement(
                        'div',
                        { className: prefix + 'calendar-body-right', key: 'right-panel' },
                        _react2.default.createElement(_dateTable2.default, (0, _extends3.default)({}, tableProps, { visibleMonth: endVisibleMonth, onSelectDate: this.onSelectCell }))
                    )];
