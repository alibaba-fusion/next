...
var DatePanelHeader = /** @class */ (function (_super) {
    ...
    DatePanelHeader.prototype.render = function () {
        ...
        var monthButton = (react_1.default.createElement("button", { role: "button", type: "button", className: btnCls, title: monthLabel, onClick: function () { return changeMode('month', 'start'); } }, monthLabel));
        var yearButton = (react_1.default.createElement("button", { role: "button", type: "button", className: btnCls, title: yearLabel, onClick: function () { return changeMode('year', 'start'); } }, yearLabel));
        if (disableChangeMode) {
            ...
            monthButton = (react_1.default.createElement(dropdown_1.default, { align: "tc bc", container: this.selectContainerHandler, trigger: react_1.default.createElement("button", { role: "button", type: "button", className: btnCls, title: monthLabel },
                    monthLabel,
            ...
            yearButton = (react_1.default.createElement(dropdown_1.default, { align: "tc bc", container: this.selectContainerHandler, trigger: react_1.default.createElement("button", { role: "button", type: "button", className: btnCls, title: yearLabel },
                    yearLabel,
                    react_1.default.createElement(icon_1.default, { type: "arrow-down" })), triggerType: "click" },
