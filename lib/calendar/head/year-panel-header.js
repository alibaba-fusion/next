...
var YearPanelHeader = /** @class */ (function (_super) {
    ...
    YearPanelHeader.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: "".concat(prefix, "calendar-panel-header") },
            react_1.default.createElement("button", { role: "button", type: "button", title: locale.prevDecade, className: "".concat(btnCls, " ").concat(btnCls, "-prev-decade"), onClick: goPrevDecade },
            ...
            react_1.default.createElement("div", { className: "".concat(prefix, "calendar-panel-header-full") },
                react_1.default.createElement("button", { role: "button", type: "button", title: decadeLable, className: btnCls }, decadeLable)),
            react_1.default.createElement("button", { role: "button", type: "button", title: locale.nextDecade, className: "".concat(btnCls, " ").concat(btnCls, "-next-decade"), onClick: goNextDecade },
