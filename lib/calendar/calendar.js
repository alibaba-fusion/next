...
var Calendar = (_temp = _class = function (_Component) {
    ...
    Calendar.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'className', 'shape', 'showOtherMonth', 'locale', 'dateCellRender', 'monthCellRender', 'disabledDate']);
        ...
        var tables = (_tables = {}, _tables[_utils.CALENDAR_MODE_DATE] = _react2.default.createElement(_dateTable2.default, (0, _extends3.default)({}, tableProps, { onSelectDate: this.onSelectCell })), _tables[_utils.CALENDAR_MODE_MONTH] = _react2.default.createElement(_monthTable2.default, (0, _extends3.default)({}, tableProps, { onSelectMonth: this.onSelectCell })), _tables[_utils.CALENDAR_MODE_YEAR] = _react2.default.createElement(_yearTable2.default, (0, _extends3.default)({}, tableProps, { onSelectYear: this.onSelectCell })), _tables);
