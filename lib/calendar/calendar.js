...
var Calendar = (_temp = _class = function (_Component) {
    ...
    Calendar.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'rtl', 'className', 'shape', 'showOtherMonth', 'format', 'locale', 'dateCellRender', 'monthCellRender', 'yearCellRender', 'disabledDate', 'yearRange']);
        ...
        return _react2.default.createElement(
            ...
            shape === 'panel' ? panelHeaders[state.mode] : _react2.default.createElement(_cardHeader2.default, (0, _extends3.default)({}, headerProps, { yearRange: yearRange })),
            tables[state.mode]
        );
    };
