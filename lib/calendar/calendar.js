...
var card_header_1 = require("./head/card-header");
var date_panel_header_1 = require("./head/date-panel-header");
...
var Calendar = /** @class */ (function (_super) {
    ...
    Calendar.prototype.render = function () {
        ...
        var tables = (_b = {},
            ...
            _b);
        var panelHeaders = (_c = {},
            _c[utils_1.CALENDAR_MODE_DATE] = react_1.default.createElement(date_panel_header_1.default, tslib_1.__assign({}, headerProps)),
        ...
        return (react_1.default.createElement("div", tslib_1.__assign({}, util_1.obj.pickOthers(Calendar.propTypes, others), { className: classNames }),
            shape === 'panel' ? panelHeaders[state.mode] : react_1.default.createElement(card_header_1.default, tslib_1.__assign({}, headerProps)),
            tables[state.mode]));
    };
