...
var date_table_head_1 = require("./date-table-head");
...
var DateTable = /** @class */ (function (_super) {
    ...
    DateTable.prototype.render = function () {
        ...
        for (var i = 0; i < utils_1.CALENDAR_TABLE_ROW_COUNT; i++) {
            ...
            for (var j = 0; j < utils_1.CALENDAR_TABLE_COL_COUNT; j++) {
                ...
                var elementCls = (0, classnames_1.default)((_a = {},
                    ...
                    _a));
                weekElements.push(react_1.default.createElement("td", { key: counter, title: currentDate.format(format), onClick: isDisabled ? undefined : onSelectDate.bind(null, currentDate), className: elementCls, role: "cell", "aria-disabled": isDisabled ? 'true' : 'false', "aria-selected": isSelected ? 'true' : 'false' },
        ...
        return (react_1.default.createElement("table", { className: "".concat(prefix, "calendar-table"), role: "grid" },
            ...
            react_1.default.createElement("tbody", { className: "".concat(prefix, "calendar-tbody"), role: "rowgroup" }, monthElements)));
    };
    return DateTable;
