...
declare const getMargin: (size: Spacing, { isNegative, half }?: {
    isNegative: boolean;
    half: boolean;
}) => {
...
declare const getGridChildProps: (props: ResponsiveGridProps, device: ResponsiveGridProps['device'], gap?: ResponsiveGridProps['gap']) => ObjectType;
declare const _default: ({ device, display, gap, direction, dense, rowSpan, colSpan, row, col, rows, columns, justify, align, alignSelf, wrap, flex, padding, margin, }: ResponsiveGridProps) => ObjectType;
