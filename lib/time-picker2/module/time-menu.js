...
var TimeMenu = /** @class */ (function (_super) {
    ...
    TimeMenu.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: "".concat(this.prefixCls, "-menu"), ref: this._menuWrapperRefHandler },
            react_1.default.createElement("ul", { role: "listbox", className: "".concat(this.prefixCls, "-menu-").concat(mode), ref: this._menuRefHandler }, this.createMenuItems(list))));
    };
    TimeMenu.propTypes = {
