...
var TimePickerPanel = (_temp2 = _class = function (_Component) {
    ...
    function TimePickerPanel() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.prefixCls = _this.props.prefix + 'time-picker2', _this.onSelectMenuItem = function (index, type) {
            var value = _this.props.value;

            var clonedValue = value ? value.clone() : (0, _util.datejs)('00:00:00', 'HH:mm:ss', true);
            var newValue = void 0;
            switch (type) {
                case 'hour':
    ...
    TimePickerPanel.prototype.render = function render() {
        ...
        var classNames = (0, _classnames2.default)(this.prefixCls + '-panel', this.prefixCls + '-panel-col-' + colLen, className);
        ...
        if (value && _util.datejs.isSelf(value)) {
