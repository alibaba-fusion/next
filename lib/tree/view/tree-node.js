...
var TreeNode = (_temp = _class = function (_Component) {
    ...
    TreeNode.prototype.componentDidMount = function componentDidMount() {
        this.itemLabelWrapperNode = (0, _reactDom.findDOMNode)(this.labelWrapperEl);
        this.setFocus();
    };
    ...
    TreeNode.prototype.renderLabel = function renderLabel() {
        ...
        return _react2.default.createElement(
            'div',
            (0, _extends3.default)({ className: prefix + 'tree-node-label-wrapper', ref: this.saveLabelWrapperRef }, labelWrapperProps),
            _react2.default.createElement(
                'div',
                labelProps,
                iconEl,
