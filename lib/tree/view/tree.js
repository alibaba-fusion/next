...
var Tree = (_temp = _class = function (_Component) {
    ...
    function Tree(props) {
        ...
        var _flatDataSource = flatDataSource(props),
            k2n = _flatDataSource.k2n,
            p2n = _flatDataSource.p2n;
    ...
    Tree.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
        var _flatDataSource2 = flatDataSource(props),
            k2n = _flatDataSource2.k2n,
            p2n = _flatDataSource2.p2n;
    ...
    Tree.prototype.handleCheck = function handleCheck(check, key, node) {
        ...
        if (checkStrictly) {
            ...
            onCheck(_newCheckedKeys, {
                ...
                checkedNodesPositions: checkedKeys.map(function (key) {
                    if (!_this5.state._k2n[key]) return null;
                    var _state$_k2n$key = _this5.state._k2n[key],
                        node = _state$_k2n$key.node,
                        pos = _state$_k2n$key.pos;
        ...
        (0, _util2.forEachEnableNode)(this.state._k2n[key], function (node) {
        ...
        for (var i = nums.length; i > 2; i--) {
            ...
            var parentKey = this.state._p2n[parentPos].key;
        ...
        var indeterminateKeys = getIndeterminateKeys(checkedKeys, checkStrictly, this.state._k2n, this.state._p2n);
        ...
        switch (checkedStrategy) {
            case 'parent':
                newCheckedKeys = (0, _util2.filterChildKey)(checkedKeys, this.state._k2n, this.state._p2n);
                break;
            case 'child':
                newCheckedKeys = (0, _util2.filterParentKey)(checkedKeys, this.state._k2n, this.state._p2n);
                break;
            default:
        ...
        onCheck(newCheckedKeys, {
            ...
            checkedNodesPositions: newCheckedKeys.map(function (key) {
                if (!_this5.state._k2n[key]) return null;
                var _state$_k2n$key2 = _this5.state._k2n[key],
                    node = _state$_k2n$key2.node,
                    pos = _state$_k2n$key2.pos;
    ...
    Tree.prototype.renderByDataSource = function renderByDataSource() {
        ...
        var loop = function loop(data) {
            ...
            return data.map(function (item, index) {
                ...
                var props = (0, _extends3.default)({}, others, _this8.getNodeProps('' + key), {
                    _key: key
                });
                if (children && children.length) {
                ...
                _this8.state._k2n[key].node = node;
                return node;
            });
        };
    ...
    Tree.prototype.renderByChildren = function renderByChildren() {
        ...
        var loop = function loop(children) {
            ...
            return _react.Children.map(children, function (child, index) {
                ...
                var props = _this9.getNodeProps('' + key);
                ...
                // eslint-disable-next-line
                _this9.state._k2n[key].node = node;
                return node;
            });
        };
