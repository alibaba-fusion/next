...
var getData = function getData(props) {
    var dataSource = props.dataSource && props.dataSource.length ? props.dataSource : (0, _util2.convertChildren2Data)(props.children || []);
...
var Tree = (_temp = _class = function (_Component) {
    ...
    Tree.prototype.shouldNodeShow = function shouldNodeShow(nodeData) {
        ...
        return (0, _util2.getAllDescendantKeys)(nodeData, _p2n).every(function (k) {
