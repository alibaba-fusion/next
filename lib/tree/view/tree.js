...
var Tree = (_temp = _class = function (_Component) {
    ...
    Tree.prototype.handleDrop = function handleDrop(e, node) {
        if ((0, _util2.isDescendantOrSelf)(this._k2n[this.dragNode.props.eventKey].pos, this._k2n[node.props.eventKey].pos)) {
            return;
        }
    ...
    Tree.prototype.renderByDataSource = function renderByDataSource() {
        ...
        var loop = function loop(data) {
            ...
            return data.map(function (item, index) {
                ...
                var node = _react2.default.createElement(_treeNode2.default, (0, _extends3.default)({ rtl: rtl, key: key }, props));
    ...
    Tree.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            'ul',
            (0, _extends3.default)({ role: 'tree', onBlur: this.handleBlur, className: newClassName }, others),
