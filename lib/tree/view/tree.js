    ...
    Tree.prototype.render = function () {
        ...
        var virtualTreeRender = function (dataSource) {
            return (react_1.default.createElement("div", { className: "".concat(prefix, "virtual-tree-container"), style: style },
                react_1.default.createElement(virtual_list_1.default, tslib_1.__assign({ itemsRenderer: function (items, ref) { return treeRender(items, ref); } }, virtualListProps), _this.renderNodeList(dataSource))));
        };
        return useVirtual
