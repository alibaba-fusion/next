...
function isNodeChecked(node, checkedKeys) {
    ...
    if (node.checkable === false) {
        return !node.children || node.children.length === 0 || node.children.every(function (c) { return isNodeChecked(c, checkedKeys); });
    }
...
function convertChildren2Data(children) {
    function convert(treeNodes) {
        ...
        return treeNodes
            ...
            var key = node.key, _a = node.props, children = _a.children, rest = tslib_1.__rest(_a, ["children"]);
