...
var Range = (_temp = _class = function (_React$Component) {
    ...
    Range.prototype._onContextMenu = function _onContextMenu(e) {
        pauseEvent(e);
    };
    ...
    Range.prototype._addDocumentMouseEvents = function _addDocumentMouseEvents() {
        ...
        this._onContextMenuListener = _util.events.on(document, 'contextmenu', this._onContextMenu.bind(this));
    };
        ...
        if (isPreview) {
            ...
            if ('renderPreview' in this.props) {
                return _react2.default.createElement(
                    'div',
                    (0, _extends3.default)({ id: id, dir: rtl ? 'rtl' : 'ltr' }, others, { className: previewCls }),
