...
var Select = (_temp = _class = function (_Base) {
    ...
    Select.prototype.renderMenuHeader = function renderMenuHeader() {
        ...
        var cls = (0, _classnames2.default)((_classNames3 = {}, _classNames3[prefix + 'select-all'] = true, _classNames3[prefix + 'menu-item'] = true, _classNames3[prefix + 'selected'] = selectAllYet, _classNames3));

        return _react2.default.createElement(
            'div',
            { key: 'all', onClick: this.handleSelectAll, className: cls },
