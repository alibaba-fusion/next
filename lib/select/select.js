...
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.handleSelectAll = function (e) {
        ...
        if (this.selectAllYet) {
            ...
            nextValues = tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read((this.state.value || []).map(function (item) {
                if (typeof item === 'object' && item !== null) {
                    return item.value;
                }
                return item;
            })), false), tslib_1.__read(this.dataStore.getEnableDS().map(function (item) { return item.value; })), false);
        }
        // 去重
    ...
    Select.prototype.renderValues = function () {
        ...
        if (mode === 'single') {
            ...
            if (maxTagCount !== undefined && detailedValueArr.length > maxTagCount && !tagInline) {
                ...
                maxTagPlaceholderEl = (react_1.default.createElement(tag_1.default, { key: "_count", type: "primary", size: tagSize, animation: false }, holder(detailedValueArr, totalValue)));
            }
            if (detailedValueArr.length > 0 && tagInline) {
                maxTagPlaceholderEl = (react_1.default.createElement("div", { className: "".concat(prefix, "select-tag-compact"), key: "_count" }, holder(detailedValueArr, totalValue)));
            }
            ...
            var selectedValueNodes = detailedValueArr.map(function (v) {
                ...
                return (react_1.default.createElement(tag_1.default, { key: v.value, disabled: disabled || v.disabled, type: "primary", size: tagSize, animation: false, onClose: _this.handleTagClose.bind(_this, v), closable: tagClosable, color: v.color }, labelNode));
            });
    ...
    Select.prototype.renderExtraNode = function () {
        ...
        var ret = [];
        if (hasArrow) {
            ret.push(react_1.default.createElement("span", { key: "arrow", "aria-hidden": true, onClick: this.handleArrowClick, className: "".concat(prefix, "select-arrow") },
                react_1.default.createElement(icon_1.default, { type: "arrow-down", className: "".concat(prefix, "select-symbol-fold") })));
        }
        // do not use this.hasClear() here, to make sure clear btn always exists, can not influenced by apis like `disabled` `readOnly`
        if (hasClear) {
            ret.push(react_1.default.createElement("span", { key: "clear", "aria-hidden": true, onClick: this.handleClear, className: "".concat(prefix, "select-clear") },
                react_1.default.createElement(icon_1.default, { type: "delete-filling" })));
        }
        return ret;
    };
    /**
    ...
    Select.prototype.renderSelect = function () {
        ...
        var triggerClazz = (0, classnames_1.default)([
            ...
            _a));
        return (react_1.default.createElement("span", tslib_1.__assign({}, othersData, { className: triggerClazz, style: style, dir: rtl ? 'rtl' : undefined, ref: this.saveSelectRef, onClick: this.handleWrapClick, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, onMouseDown: this.handleWrapClick }),
            react_1.default.createElement(input_1.default, tslib_1.__assign({ "aria-label": "select" }, util_1.obj.pickOthers(othersData, others), { role: "combobox", tabIndex: 0, "aria-expanded": this.state.visible ? 'true' : 'false', "aria-disabled": disabled, state: state, label: label, extra: extra, value: this.state.searchValue, size: size, readOnly: !this.hasSearch() || readOnly, disabled: disabled, placeholder: _placeholder, hasBorder: hasBorder, hasClear: false, htmlSize: "1", inputRender: function (inputEl) {
    ...
    Select.prototype.renderSearchInput = function (valueNodes, placeholder, inputEl) {
        ...
        var searchInput = [
            isSingle && valueNodes ? (react_1.default.createElement("em", { title: title, key: "select-value" }, valueNodes)) : (valueNodes),
        ];
        var triggerSearch = (react_1.default.createElement("span", { key: "trigger-search", className: "".concat(prefix, "select-trigger-search") },
            inputEl,
            react_1.default.createElement("span", { "aria-hidden": true },
                react_1.default.createElement("span", null, mirrorText || placeholder),
                react_1.default.createElement("span", { style: { display: 'inline-block', width: 1 } }, "\u00A0"))));
    ...
    Select.prototype.renderMenuHeader = function () {
        ...
        return (react_1.default.createElement("div", { key: "all", onClick: this.handleSelectAll, className: cls, style: { lineHeight: 'unset' } },
            selectAllYet ? (react_1.default.createElement(icon_1.default, { className: "".concat(prefix, "menu-icon-selected"), style: { display: 'none' }, type: "select" })) : null,
    ...
    Select.propTypes = tslib_1.__assign(tslib_1.__assign({}, base_1.default.propTypes), { mode: prop_types_1.default.oneOf(['single', 'multiple', 'tag']), value: prop_types_1.default.any, defaultValue: prop_types_1.default.any, onChange: prop_types_1.default.func, dataSource: prop_types_1.default.arrayOf(prop_types_1.default.oneOfType([
