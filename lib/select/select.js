...
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.handleSelectAll = function (e) {
        ...
        if (this.selectAllYet) {
            ...
            nextValues = this.dataStore.getEnableDS().map(function (item) { return item.value; });
        }
    ...
    Select.prototype.renderValues = function () {
        ...
        if (mode === 'single') {
            ...
            var retvalue = fillProps && typeof value === 'object' && fillProps in value ? value[fillProps] : valueRender(value);
            // 0 => '0'
    ...
    Select.prototype.renderSelect = function () {
        ...
        var triggerClazz = (0, classnames_1.default)(["".concat(prefix, "select"), "".concat(prefix, "select-trigger"), "".concat(prefix, "select-").concat(mode), "".concat(prefix).concat(size), className], (_a = {},
    ...
    Select.propTypes = tslib_1.__assign(tslib_1.__assign({}, base_1.default.propTypes), { 
         ...
         */
        dataSource: prop_types_1.default.arrayOf(prop_types_1.default.oneOfType([
