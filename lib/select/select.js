...
var Select = (_temp = _class = function (_Base) {
    ...
    Select.prototype.handleMultipleSelect = function handleMultipleSelect(keys, triggerType, key) {
        var _this2 = this;
    ...
    Select.prototype.hasClear = function hasClear() {
        ...
        return typeof value !== 'undefined' && value !== null && hasClear && !readOnly && !disabled && mode === 'single' && !(showSearch && visible);
    };
