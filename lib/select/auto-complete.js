...
var AutoComplete = /** @class */ (function (_super) {
    ...
    AutoComplete.prototype.renderSelect = function (props) {
        ...
        // });
        // trigger className
        var triggerClazz = (0, classnames_1.default)(["".concat(prefix, "select"), "".concat(prefix, "select-auto-complete"), "".concat(prefix, "size-").concat(size), className], (_a = {},
        ...
        return (react_1.default.createElement("span", tslib_1.__assign({}, othersData, { className: triggerClazz, style: style, dir: rtl ? 'rtl' : undefined, ref: this.saveSelectRef, onClick: this.focusInput }),
            react_1.default.createElement(input_1.default, tslib_1.__assign({ role: "combobox", "aria-autocomplete": "list", "aria-disabled": disabled, "aria-expanded": this.state.visible }, _inputProps)),
