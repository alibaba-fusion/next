...
exports.generateGroupKey = exports.valueToSelectKey = exports.getValueDataSource = exports.filterDataSource = exports.flattingDataSource = exports.normalizeDataSource = exports.isObjectDataSourceItem = exports.parseDataSourceFromChildren = exports.loopMap = exports.filter = exports.escapeForReg = exports.isNull = exports.isSingle = void 0;
 ...
 * @returns group key
 */
function generateGroupKey(index, itemValueSet) {
    var targetKey = "select-group-".concat(index);
    if (!itemValueSet.has(targetKey)) {
        return targetKey;
    }
    var suffix = 0;
    var key = "".concat(targetKey, "-repeat-").concat(suffix);
    while (itemValueSet.has(key)) {
        suffix++;
        key = "".concat(targetKey, "-repeat-").concat(suffix);
    }
    return key;
}
