...
var Pagination = (_temp = _class = function (_Component) {
    ...
    Pagination.prototype.renderPageItem = function renderPageItem(index) {
        ...
        return _react2.default.createElement(
            _button2.default,
            (0, _extends3.default)({
                'aria-label': _util.str.template(locale.total, { current: index, total: totalPage })
            }, props, {
                key: index }),
    ...
    Pagination.prototype.renderPageFirst = function renderPageFirst(current) {
        ...
        return _react2.default.createElement(
            _button2.default,
            (0, _extends3.default)({}, props, { 'aria-label': _util.str.template(locale.labelPrev, { current: current }) }),
            icon,
    ...
    Pagination.prototype.renderPageLast = function renderPageLast(current, totalPage) {
        ...
        return _react2.default.createElement(
            _button2.default,
            (0, _extends3.default)({}, props, { 'aria-label': _util.str.template(locale.labelNext, { current: current }) }),
    ...
    */
    ...
    selectPopupContiner: _propTypes2.default.func
}, _class.defaultProps = {
    prefix: 'next-',
    pure: false,
    rtl: false,
