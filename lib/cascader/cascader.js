...
var Cascader = (_temp = _class = function (_Component) {
    ...
    Cascader.prototype.setCache = function setCache(data) {
        ...
        data.forEach(function (item, index) {
            ...
            item.value = newValue;
            _this3._v2n[newValue] = _this3._p2n[pos] = (0, _extends3.default)({}, item, {
                pos: pos,
                _source: item
            });
    ...
    Cascader.prototype.completeValue = function completeValue(dataSource, value) {
        return (0, _utils.getAllCheckedValues)(value, this._v2n, this._p2n);
    };
    /*eslint-enable*/


    Cascader.prototype.flatValue = function flatValue(value) {
        return (0, _utils.filterChildValue)(value, this._v2n, this._p2n);
    };
    ...
    Cascader.prototype.handleCheck = function handleCheck(v, checked) {
        ...
        if (checkStrictly || canOnlyCheckLeaf) {
            ...
            (0, _utils.forEachEnableNode)(this._v2n[v], function (node) {
        ...
        return _react2.default.createElement(
            ...
            data.map(function (item) {
                ...
                if (multiple) {
                    ...
                    props.indeterminate = checkStrictly || canOnlyCheckLeaf ? false : _this10.indeterminate.indexOf(item.value) > -1;
