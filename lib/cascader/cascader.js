...
var Cascader = /** @class */ (function (_super) {
    ...
    Cascader.prototype.renderMenu = function (data, level) {
        ...
        return (react_1.default.createElement(menu_2.default, { key: level, prefix: prefix, useVirtual: useVirtual, className: listClassName, style: listStyle, ref: this.saveMenuRef, focusedKey: focusedValue, onItemFocus: this.handleFocus, onBlur: this.onBlur }, data
            .map(function (item) {
