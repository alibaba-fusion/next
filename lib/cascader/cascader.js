...
var menu_3 = require("../menu/view/menu");
var config_provider_1 = tslib_1.__importDefault(require("../config-provider"));
var bindCtx = util_1.func.bindCtx;
var pickOthers = util_1.obj.pickOthers, pickProps = util_1.obj.pickProps;
...
var getFormatMenuProps = function (others) {
    var targetProps = pickProps(menu_3.Menu.propTypes, others);
    var targetMenuProps = pickOthers(tslib_1.__assign({ value: false, onChange: false, defaultValue: false, focusedKey: false, onItemFocus: false, focusable: false, onBlur: false }, config_provider_1.default.propTypes), targetProps);
    return tslib_1.__assign(tslib_1.__assign({}, targetMenuProps), { isSelectIconRight: false });
};
/**
 * Cascader
 */
var Cascader = /** @class */ (function (_super) {
    ...
    Cascader.prototype.renderFilteredList = function () {
        var _this = this;
        var _a = this.props, prefix = _a.prefix, filteredListStyle = _a.filteredListStyle, filteredPaths = _a.filteredPaths, _b = _a.focusable, focusable = _b === void 0 ? false : _b, others = tslib_1.__rest(_a, ["prefix", "filteredListStyle", "filteredPaths", "focusable"]);
        var focusedValue = this.state.focusedValue;
        return (react_1.default.createElement(menu_1.default, tslib_1.__assign({}, getFormatMenuProps(others), { 
    ...
    Cascader.prototype.render = function () {
        ...
        var others = pickOthers(tslib_1.__assign(tslib_1.__assign({}, Cascader.propTypes), menu_3.Menu.propTypes), this.props);
        var value = this.state.value;
        if (rtl) {
            others.dir = 'rtl';
        }
