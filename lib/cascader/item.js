...
var CascaderMenuItem = (_temp = _class = function (_Component) {
    ...
    CascaderMenuItem.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            ...
            itemProps,
            children,
            canExpand ? loading ? _react2.default.createElement(_icon2.default, { className: prefix + 'cascader-menu-icon-right ' + prefix + 'cascader-menu-icon-loading', type: 'loading' }) : _react2.default.createElement(_icon2.default, { className: prefix + 'cascader-menu-icon-right ' + prefix + 'cascader-menu-icon-expand', type: 'arrow-right' }) : null
        );
    };
