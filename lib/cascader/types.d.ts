...
export interface ItemProps extends Omit<HTMLAttributesWeak, 'onSelect'>, CommonProps, Omit<CheckboxItemProps, 'onSelect' | 'onChange'>, MenuItemProps {
 ...
 * @api Cascader
 */
export interface CascaderProps extends Omit<HTMLAttributesWeak, 'onChange' | 'onSelect' | 'defaultValue'>, CommonProps {
    /**
     * 数据源
     * @en data source
     * @defaultValue []
