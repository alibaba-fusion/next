...
var Password = (_temp2 = _class = function (_Input) {
    ...
    return Password;
}(_input2.default), _class.getDerivedStateFromProps = _input2.default.getDerivedStateFromProps, _class.propTypes = (0, _extends3.default)({}, _input2.default.propTypes, {
    /**
     * 是否展示切换按钮
     */
