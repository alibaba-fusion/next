...
var TextArea = (_temp = _class = function (_Base) {
    ...
    TextArea.prototype.renderClear = function renderClear() {
        ...
        clearWrap = showClear ? _react2.default.createElement(
            'span',
            {
                className: cls,
    ...
    TextArea.prototype.renderControl = function renderControl() {
        ...
        return lenWrap || clearText ? _react2.default.createElement(
            'span',
            { onClick: function onClick() {
                    return _this2.focus();
                }, className: cls },
            lenWrap,
            isShowLine && _react2.default.createElement('span', { className: prefix + 'input-textarea-control-line' }),
            clearText
        ) : null;
    };
    ...
    TextArea.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            'span',
            (0, _extends3.default)({ className: cls, style: wrapStyle, dir: rtl ? 'rtl' : undefined }, dataProps),
            _react2.default.createElement('textarea', (0, _extends3.default)({}, others, props, compositionProps, {
                'data-real': true,
                rows: rows,
                style: textareStyle,
