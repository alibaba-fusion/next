...
var TextArea = /** @class */ (function (_super) {
    ...
    TextArea.prototype.renderClear = function () {
        ...
        var cls = (0, classnames_1.default)((_a = {},
            ...
            _a));
        clearWrap = showClear ? (react_1.default.createElement("span", { className: cls, onClick: this.onClear.bind(this), onKeyDown: this.handleKeyDownFromClear },
            ' ',
            locale.clear)) : null;
        if (state === 'loading') {
            clearWrap = null;
    ...
    TextArea.prototype.renderControl = function () {
        ...
        var cls = (0, classnames_1.default)("".concat(prefix, "input-control"), "".concat(prefix, "input-textarea-control"));
        return lenWrap || clearText ? (react_1.default.createElement("span", { onClick: function () { return _this.focus(); }, className: cls },
            lenWrap,
            isShowLine && react_1.default.createElement("span", { className: "".concat(prefix, "input-textarea-control-line") }),
            clearText)) : null;
    };
    TextArea.prototype.render = function () {
        ...
        var wrapStyle = autoHeight
            ? tslib_1.__assign(tslib_1.__assign({}, style), { position: 'relative' }) : style;
        if (isPreview) {
    ...
    TextArea.propTypes = tslib_1.__assign(tslib_1.__assign({}, base_1.default.propTypes), { hasBorder: prop_types_1.default.bool, state: prop_types_1.default.oneOf(['error', 'warning']), autoHeight: prop_types_1.default.oneOfType([prop_types_1.default.bool, prop_types_1.default.object]), rows: prop_types_1.default.number, isPreview: prop_types_1.default.bool, renderPreview: prop_types_1.default.func, locale: prop_types_1.default.object });
    TextArea.defaultProps = tslib_1.__assign(tslib_1.__assign({}, base_1.default.defaultProps), { hasBorder: true, isPreview: false, rows: 4, autoHeight: false, locale: zh_cn_1.default.TextArea });
    return TextArea;
}(base_1.default));
