...
var Item = (_temp = _class = function (_React$Component) {
    ...
    Item.prototype.getLabelForErrorMessage = function getLabelForErrorMessage() {
        var _props = this.props,
            errorMessageName = _props.errorMessageName,
            label = _props.label,
            useLabelForErrorMessage = _props.useLabelForErrorMessage;
        ...
        var labelForErrorMessage = useLabelForErrorMessage || this.context._formLabelForErrorMessage;
    ...
    Item.prototype.getItemLabel = function getItemLabel(children) {
        ...
        var _props2 = this.props,
            ...
            _props2$asterisk = _props2.asterisk,
            asterisk = _props2$asterisk === undefined ? required : _props2$asterisk,
            label = _props2.label,
            ...
            labelTextAlign = _props2.labelTextAlign,
            colon = _props2.colon;
    ...
    Item.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            Tag,
            (0, _extends3.default)({}, _util.obj.pickOthers(Item.propTypes, this.props), { className: itemClassName, style: style }),
            label,
