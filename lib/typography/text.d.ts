...
declare const _default: {
    new (props: TextProps & import("../config-provider/types").ComponentCommonProps, context?: unknown): import("../config-provider/types").ConfiguredComponent<TextProps & import("../config-provider/types").ComponentCommonProps, Text>;
