    ...
    transform: /* istanbul ignore next */function transform(props, deprecated) {
        ...
        if ('triggerType' in props) {
            ...
            if (triggerType.indexOf('focus') > -1) {
                _util.log.warning('triggerType[focus] is deprecated at [Balloon], use triggerType[hover, click] instead of it. If focus is desired maybe you should use [Balloon.Tooltip]');
            }
        }
