...
var Checkbox = (_temp = _class = function (_UIState) {
    ...
    Checkbox.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            value = _props.value,
            name = _props.name,
            otherProps = (0, _objectWithoutProperties3.default)(_props, ['id', 'className', 'children', 'style', 'label', 'onMouseEnter', 'onMouseLeave', 'rtl', 'isPreview', 'renderPreview', 'value', 'name']);
