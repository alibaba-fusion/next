...
declare const _default: {
    new (props: AffixProps & import("../config-provider/types").ComponentCommonProps, context?: unknown): import("../config-provider/types").ConfiguredComponent<AffixProps & import("../config-provider/types").ComponentCommonProps, Affix>;
