...
var Selectable = (_temp = _class = function (_Component) {
    ...
    Selectable.prototype.render = function render() {
        ...
        return _react2.default.createElement(_tag2.default, (0, _extends3.default)({}, others, { role: 'checkbox', _shape: 'checkable', 'aria-checked': isChecked, className: clazz, onClick: this.handleClick }));
    };
