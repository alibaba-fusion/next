...
var RangeCalendar = (_temp = _class = function (_React$Component) {
    ...
    RangeCalendar.prototype.render = function render() {
            ...
            case _utils.CALENDAR_MODE_DATE:
                {
                    table = [_react2.default.createElement(
                        'div',
                        { className: prefix + 'calendar2-body-left', key: 'left-panel' },
                        ...
                        'div',
                        { className: prefix + 'calendar2-body-right', key: 'right-panel' },
                        _react2.default.createElement(_dateTable2.default, (0, _extends3.default)({
                            format: format
                        }, tableProps, {
        ...
        var classNames = (0, _classnames3.default)((_classnames = {}, _classnames[prefix + 'calendar2'] = true, _classnames[prefix + 'calendar2-range'] = true, _classnames), className);
