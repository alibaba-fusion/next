...
var HeaderPanel = /** @class */ (function (_super) {
    ...
    function HeaderPanel(props) {
        ...
        _this.createPanelBtns = function (_a) {
            ...
            return [
                react_1.default.createElement(button_1.default, { text: true, className: "".concat(prefixCls, "-btn  ").concat(prefixCls, "-left-btn"), onClick: function () { return _this.handleClick(value, { num: num, unit: unit, isSuper: isSuper, isNext: false }); }, key: "prev-btn-".concat(unit) },
                    react_1.default.createElement(icon_1.default, { type: iconTypes[0] })),
                react_1.default.createElement(button_1.default, { text: true, className: "".concat(prefixCls, "-btn ").concat(prefixCls, "-right-btn"), onClick: function () { return _this.handleClick(value, { num: num, unit: unit, isSuper: isSuper, isNext: true }); }, key: "next-btn-".concat(unit) },
    ...
    HeaderPanel.prototype.renderInner = function () {
        ...
        if (shape === constant_1.CALENDAR_SHAPE.PANEL) {
            ...
            nodes.push(react_1.default.createElement("div", { key: "actions", className: "".concat(prefixCls, "-actions") },
                ...
                this.props.renderHeaderExtra && this.props.renderHeaderExtra(tslib_1.__assign({}, this.props))));
        }
        return nodes;
    };
