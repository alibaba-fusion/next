...
var RangePicker = (_temp = _class = function (_Component) {
    ...
    function RangePicker(props, context) {
        ...
        var dateTimeFormat = (0, _util2.getDateTimeFormat)(props.format, props.showTime, props.type);
    ...
    RangePicker.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
        if ('showTime' in nextProps) {
            var dateTimeFormat = (0, _util2.getDateTimeFormat)(nextProps.format || this.props.format, nextProps.showTime, nextProps.type);
                    ...
                    if (showTime) {
                        if (!prevStartValue) {
                            ...
                            if (showTime.defaultValue) {
                                var defaultTimeValue = (0, _util2.formatDateValue)(Array.isArray(showTime.defaultValue) ? showTime.defaultValue[0] : showTime.defaultValue, _this3.timeFormat);
            ...
            case 'endValue':
                ...
                if (showTime) {
                    if (!prevEndValue) {
                        // 第一次选择，如果设置了时间默认值，则使用该默认时间
                        if (showTime.defaultValue) {
                            var _defaultTimeValue = (0, _util2.formatDateValue)(Array.isArray(showTime.defaultValue) ? showTime.defaultValue[1] || showTime.defaultValue[0] : showTime.defaultValue, _this3.timeFormat);
    ...
    this.onTimeInputKeyDown = function (e) {
        ...
        var _ref2 = (typeof showTime === 'undefined' ? 'undefined' : (0, _typeof3.default)(showTime)) === 'object' ? showTime : {},
            disabledMinutes = _ref2.disabledMinutes,
            disabledSeconds = _ref2.disabledSeconds,
            _ref2$hourStep = _ref2.hourStep,
            hourStep = _ref2$hourStep === undefined ? 1 : _ref2$hourStep,
            _ref2$minuteStep = _ref2.minuteStep,
            minuteStep = _ref2$minuteStep === undefined ? 1 : _ref2$minuteStep,
            _ref2$secondStep = _ref2.secondStep,
            secondStep = _ref2$secondStep === undefined ? 1 : _ref2$secondStep;
    ...
    this.getDisabledTime = function (_ref3) {
        var startValue = _ref3.startValue,
            endValue = _ref3.endValue;

        var _ref4 = _this3.props.showTime || {},
            disabledHours = _ref4.disabledHours,
            disabledMinutes = _ref4.disabledMinutes,
            disabledSeconds = _ref4.disabledSeconds;
