...
var RangePicker = (_temp = _class = function (_Component) {
    ...
    RangePicker.getDerivedStateFromProps = function getDerivedStateFromProps(props) {
        ...
        if ('value' in props) {
            ...
            if (props.value && (typeof props.value[0] === 'string' || typeof props.value[1] === 'string')) {
                states.inputAsString = true;
            }
            if (props.value && (_moment2.default.isMoment(props.value[0]) || _moment2.default.isMoment(props.value[1]))) {
