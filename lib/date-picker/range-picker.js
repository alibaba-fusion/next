...
var RangePicker = (_temp = _class = function (_Component) {
    ...
    function RangePicker(props, context) {
        ...
        _this.onDateInputKeyDown = function (e) {
            ...
            var dateStr = (0, _util2.onDateKeydown)(e, { format: format, value: _this.state[activeDateInput], dateInputStr: dateInputStr }, 'day');
            if (!dateStr) return;
