...
var event_handlers_1 = require("./mixins/event-handlers");
var helpers_1 = require("./mixins/helpers");
...
var InnerSlider = /** @class */ (function (_super) {
    ...
    InnerSlider.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        if (prevProps.activeIndex !== this.props.activeIndex) {
            ...
            if (diffKeys_1.every(function (key) { return key === 'children' || typeof _this.props[key] === 'function'; })) {
                // do nothing;
            }
            else {
