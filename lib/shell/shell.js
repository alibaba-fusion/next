...
var _classnames9 = require('classnames');

var _classnames10 = _interopRequireDefault(_classnames9);
...
function ShellBase(props) {
    ...
    var Shell = (_temp = _class = function (_Component) {
        ...
        function Shell(props) {
            ...
            var deviceMap = (0, _util.getCollapseMap)(props.device);
            _this.layout = {};
        ...
        Shell.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
            ...
            if (nextProps.device !== device) {
                var deviceMap = (0, _util.getCollapseMap)(nextProps.device);
        ...
        return Shell;
    }(_react.Component), _class.displayName = componentName, _class._typeMark = componentName, _class.propTypes = {
        ...
        shellPrefix: _propTypes2.default.string
        ...
        this.setChildCollapse = function (child, mark) {
            ...
            var deviceMap = (0, _util.getCollapseMap)(device);
            var props = {};

            // 非受控模式
            if ((0, _util.isBoolean)(collapse) === false) {
        ...
        this.toggleNavigation = function (e) {
            ...
            if ('keyCode' in e && e.keyCode !== _util2.KEYCODE.ENTER) {
                return;
            }
        ...
        this.renderShell = function (props) {
            ...
            var prefix = props.prefix,
                ...
                type = props.type,
                others = (0, _objectWithoutProperties3.default)(props, ['prefix', 'children', 'className', 'type']);
            ...
            var headerCls = (0, _classnames10.default)((_classnames = {}, _classnames[prefix + 'shell-header'] = true, _classnames));

            var mainCls = (0, _classnames10.default)((_classnames2 = {}, _classnames2[prefix + 'shell-main'] = true, _classnames2));

            var submainCls = (0, _classnames10.default)((_classnames3 = {}, _classnames3[prefix + 'shell-sub-main'] = true, _classnames3));

            var asideCls = (0, _classnames10.default)((_classnames4 = {}, _classnames4[prefix + 'shell-aside'] = true, _classnames4));
            ...
            if (needDockTrigger) {
                var action = layout.header && layout.header.Action;
            ...
            if (layout.taskHeader) {
                ...
                var taskHeaderCls = (0, _classnames10.default)((_classnames5 = {}, _classnames5[prefix + 'shell-task-header'] = true, _classnames5));
            ...
            if (layout.LocalNavigation) {
                ...
                var localNavCls = (0, _classnames10.default)(asideCls, (_classnames6 = {}, _classnames6[prefix + 'aside-localnavigation'] = true, _classnames6));
            ...
            if (layout.Ancillary) {
                ...
                var ancillaryCls = (0, _classnames10.default)(asideCls, (_classnames7 = {}, _classnames7[prefix + 'aside-ancillary'] = true, _classnames7));
            ...
            layout.Navigation && contentArr.push(_react2.default.cloneElement(layout.Navigation, {
                className: (0, _classnames10.default)(asideCls, layout.Navigation.props.className),
                key: 'navigation'
            }));
            ...
            layout.ToolDock && contentArr.push(_react2.default.cloneElement(layout.ToolDock, {
                className: (0, _classnames10.default)(asideCls, layout.ToolDock.props.className),
                key: 'tooldock'
            }));

            var cls = (0, _classnames10.default)((_classnames8 = {}, _classnames8[prefix + 'shell'] = true, _classnames8[prefix + 'shell-' + device] = true, _classnames8[prefix + 'shell-' + type] = true, _classnames8[className] = !!className, _classnames8));
