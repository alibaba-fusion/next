...
function Base(props) {
    ...
    var Shell = (_temp = _class = function (_Component) {
        ...
        Shell.prototype.render = function render() {
            ...
            var cls = (0, _classnames3.default)((_classnames = {}, _classnames[prefix + 'shell-' + componentName.toLowerCase()] = true, _classnames[prefix + 'shell-collapse'] = !!collapse, _classnames[prefix + 'shell-mini'] = miniable, _classnames[className] = !!className, _classnames));
