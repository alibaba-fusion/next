    ...
    var Shell = (_temp = _class = function (_Component) {
        ...
        Shell.prototype.render = function render() {
            ...
            var _props = this.props,
                ...
                others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'className', 'miniable', 'device', 'direction', 'children', 'collapse', 'triggerProps', 'onCollapseChange', 'component']);
            ...
            var cls = (0, _classnames3.default)((_classnames = {}, _classnames[basePrefix + 'shell-' + componentName.toLowerCase()] = true, _classnames[basePrefix + 'shell-collapse'] = !!collapse, _classnames[basePrefix + 'shell-mini'] = miniable, _classnames[className] = !!className, _classnames));
        ...
        return Shell;
    }(_react.Component), _class.displayName = componentName, _class._typeMark = 'Shell_' + componentName, _class.propTypes = {
