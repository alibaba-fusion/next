...
declare const _default: {
    new (props: import("./types").SearchProps & import("../config-provider/types").ComponentCommonProps, context?: unknown): import("../config-provider/types").ConfiguredComponent<import("./types").SearchProps & import("../config-provider/types").ComponentCommonProps, {
