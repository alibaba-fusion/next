...
var Search = (_temp = _class = function (_React$Component) {
    ...
    Search.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            rtl = _props.rtl,
            others = (0, _objectWithoutProperties3.default)(_props, ['shape', 'filter', 'hasIcon', 'disabled', 'placeholder', 'type', 'className', 'style', 'size', 'prefix', 'searchText', 'dataSource', 'filterProps', 'buttonProps', 'popupContent', 'hasClear', 'visible', 'locale', 'rtl']);
        ...
        if (shape === 'simple') {
            ...
            searchIcon = _react2.default.createElement(_icon2.default, (0, _extends3.default)({
                type: 'search',
                tabIndex: '0',
                role: 'button',
