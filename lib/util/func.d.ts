...
export declare function renderNode<Result = unknown>(render: AnyFunction<Result> | undefined, defaultRender: AnyFunction<Result> | undefined, renderProps?: unknown[]): Result | undefined;
/**
 * 日期检验：无效值返回 null
 */
 ...
 */
export declare function checkRangeDate(value: ConfigType, inputType: number, disabled?: boolean, strictly?: boolean, format?: OptionType): [Dayjs | null, Dayjs | null];
