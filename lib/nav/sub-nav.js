...
var SubNav = (_temp = _class = function (_Component) {
    ...
    SubNav.prototype.render = function render() {
        ...
        var cls = (0, _classnames2.default)((_classNames = {}, _classNames[prefix + 'nav-sub-nav-item'] = true, _classNames[prefix + 'nav-popup'] = mode === 'popup', _classNames[className] = !!className, _classNames));
        ...
        var newLabel = [iconEl ? (0, _react.cloneElement)(iconEl, { key: 'icon' }) : null];

        var showLabel = !iconOnly || iconOnly && !iconOnlyWidth;

        if (showLabel) {
            newLabel.push(_react2.default.createElement(
                'span',
                { key: 'label' },
                label
            ));
        ...
        return _react2.default.createElement(
            ...
            (0, _extends3.default)({ className: cls, label: newLabel, level: level, title: title, noIcon: noIcon }, others),
            children
        );
    };
