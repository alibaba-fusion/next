...
var Nav = (_temp = _class = function (_Component) {
  ...
  Nav.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        rtl = _props2.rtl,
        others = (0, _objectWithoutProperties3.default)(_props2, ['prefix', 'className', 'style', 'children', 'type', 'direction', 'activeDirection', 'mode', 'triggerType', 'inlineIndent', 'openMode', 'popupAlign', 'popupClassName', 'iconOnly', 'hasArrow', 'hasTooltip', 'popupProps', 'rtl']);
    ...
    var props = {
      ...
      popupClassName: (0, _classnames2.default)((_classNames2 = {}, _classNames2[cls.replace(prefix + 'icon-only', '')] = mode === 'popup', _classNames2[prefix + 'icon-only'] = iconOnly && mode === 'inline', _classNames2[popupClassName] = !!popupClassName, _classNames2)),
    ...
    return _react2.default.createElement(
      _menu2.default,
      (0, _extends3.default)({ className: cls, style: newStyle }, props, others, { ref: this.getMenuRef }),
      children
    );
  };
