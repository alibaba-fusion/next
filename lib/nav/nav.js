...
var Nav = (_temp = _class = function (_Component) {
    ...
    Nav.prototype.render = function render() {
        ...
        var props = {
            ...
            popupClassName: (0, _classnames2.default)((_classNames2 = {}, _classNames2[cls.replace(prefix + 'icon-only', '').replace(prefix + 'nav-embeddable', '')] = mode === 'popup', _classNames2[prefix + 'icon-only'] = iconOnly && mode === 'inline', _classNames2[popupClassName] = !!popupClassName, _classNames2)),
