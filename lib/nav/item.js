...
var Item = (_temp = _class = function (_Component) {
    ...
    Item.prototype.render = function render() {
        ...
        var iconEl = typeof icon === 'string' ? _react2.default.createElement(_icon2.default, { className: prefix + 'nav-icon', type: icon }) : icon && _react2.default.cloneElement(icon, {
            className: (0, _classnames2.default)(prefix + 'nav-icon', icon && icon.props && icon.props.className)
        });
        ...
        var item = _react2.default.createElement(
            _menu2.default.Item,
            (0, _extends3.default)({ title: title }, others),
            iconEl,
