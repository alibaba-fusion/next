...
var item_1 = require("../menu/view/item");
...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.getTextList = function (file) {
        ...
        var onClick = function () { return (file.state === 'uploading' ? _this.handleCancel(file) : _this.handleClose(file)); };
    ...
    List.prototype.getImageList = function (file) {
        var _this = this;
        var _a = this.props, extraRender = _a.extraRender, actionRender = _a.actionRender, progressProps = _a.progressProps, rtl = _a.rtl, fileNameRender = _a.fileNameRender, previewOnFileName = _a.previewOnFileName;
    ...
    List.prototype.render = function () {
        ...
        if (isPreview) {
            ...
            list = this.props.value.map(function (file) {
                ...
                if (listType === 'text') {
                    return (react_1.default.createElement("div", { className: previewCls_1 },
