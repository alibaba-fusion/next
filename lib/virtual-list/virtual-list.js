...
var VirtualList = /** @class */ (function (_super) {
    ...
    VirtualList.prototype.cacheSizes = function () {
        ...
        var _a = this.items, children = _a.children, _b = _a.props, props = _b === void 0 ? {} : _b;
    ...
    VirtualList.prototype.render = function () {
        ...
        var cls = (0, classnames_1.default)((_a = {},
            ...
            _a));
        return (react_1.default.createElement("div", { className: cls, style: style, ref: function (c) {
                _this.el = c;
                return _this.el;
            } },
    ...
    VirtualList.defaultProps = {
        prefix: 'next-',
        itemsRenderer: function (items, ref) { return react_1.default.createElement("ul", { ref: ref }, items); },
        minSize: 1,
        pageSize: 10,
        jumpIndex: 0,
        threshold: 100,
