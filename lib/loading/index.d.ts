...
declare const _default: {
    new (props: LoadingProps & import("../config-provider/types").ComponentCommonProps, context?: unknown): import("../config-provider/types").ConfiguredComponent<LoadingProps & import("../config-provider/types").ComponentCommonProps, Loading>;
