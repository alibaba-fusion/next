...
var Field = function () {
    function Field(com) {
        ...
        ['init', 'getValue', 'getValues', 'setValue', 'setValues', 'getError', 'setError', 'setErrors', 'validate', 'getState', 'reset', 'resetToDefault', 'remove', 'spliceArray'].forEach(function (m) {
    ...
    Field.prototype.getValues = function getValues(names) {
        ...
        fields.forEach(function (f) {
            ...
            if (!_this4.options.parseName) {
                ...
                allValues = (0, _utils.setIn)(allValues, f, _this4.getValue(f));
            }
        });
        return allValues;
    };
    ...
    Field.prototype.validate = function validate(ns, cb) {
        ...
        var validate = new _validate3.default(descriptor, { first: this.options.first });
