...
var transfer_panel_1 = require("../view/transfer-panel");
...
var Transfer = /** @class */ (function (_super) {
    ...
    Transfer.prototype.render = function () {
        var _a = this.props, prefix = _a.prefix, mode = _a.mode, disabled = _a.disabled, className = _a.className, dataSource = _a.dataSource, locale = _a.locale, _b = _a.showSearch, showSearch = _b === void 0 ? false : _b, _c = _a.searchProps, searchProps = _c === void 0 ? {} : _c, filter = _a.filter, onSearch = _a.onSearch, leftDisabled = _a.leftDisabled, rightDisabled = _a.rightDisabled, searchPlaceholder = _a.searchPlaceholder, notFoundContent = _a.notFoundContent, titles = _a.titles, listClassName = _a.listClassName, listStyle = _a.listStyle, itemRender = _a.itemRender, sortable = _a.sortable, useVirtual = _a.useVirtual, rtl = _a.rtl, id = _a.id, children = _a.children, showCheckAll = _a.showCheckAll;
        var _d = this.state, value = _d.value, leftValue = _d.leftValue, leftCheckedValue = _d.leftCheckedValue, rightCheckedValue = _d.rightCheckedValue;
        var itemValues = dataSource.map(function (item) { return item.value; });
