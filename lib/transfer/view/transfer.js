...
var Transfer = (_temp = _class = function (_Component) {
     ...
     * 左右面板是否显示搜索框
     */
    showSearch: _propTypes2.default.bool | _propTypes2.default.arrayOf(_propTypes2.default.bool),
    /**
     * 左右面板搜索框配置项，同 Search 组件 props
     */
    searchProps: _propTypes2.default.object | _propTypes2.default.arrayOf(_propTypes2.default.object),
    /**
     * 自定义搜索函数
     ...
     * 列表为空显示内容
     */
    notFoundContent: _propTypes2.default.node | _propTypes2.default.arrayOf(_propTypes2.default.node),
    /**
     * 左右面板标题
     */
