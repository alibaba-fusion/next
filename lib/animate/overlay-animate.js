...
var OverlayAnimate = _react2.default.forwardRef(function (props, ref) {
    ...
    var childRef = (0, _react.useCallback)(_util.func.makeChain(_util.dom.saveRef(ref), _util.dom.saveRef(children.ref)), []);
