...
var Badge = /** @class */ (function (_super) {
    ...
    Badge.prototype.render = function () {
        ...
        var classes = classNames("".concat(prefix, "badge"), (_a = {},
            ...
            _a), className);
        return (React.createElement("span", tslib_1.__assign({ dir: rtl ? 'rtl' : undefined, className: classes }, others),
            children,
            React.createElement(sup_1.default, { prefix: prefix, content: content, count: count, showZero: showZero, overflowCount: overflowCount, dot: dot, style: style })));
    };
    Badge.propTypes = {
        // 样式类名的品牌前缀
