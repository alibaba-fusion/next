...
declare const _default: {
    new (props: BadgeProps & import("../config-provider/types").ComponentCommonProps, context?: unknown): import("../config-provider/types").ConfiguredComponent<BadgeProps & import("../config-provider/types").ComponentCommonProps, Badge>;
