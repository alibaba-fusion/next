...
var SplitButton = (_temp = _class = function (_React$Component) {
    ...
    SplitButton.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'label', 'size', 'type', 'component', 'ghost', 'className', 'style', 'children', 'triggerProps', 'popupAlign', 'popupTriggerType', 'popupStyle', 'popupClassName', 'popupProps', 'selectMode', 'menuProps', 'leftButtonProps', 'disabled']);


        var state = this.state;

        var classNames = (0, _classnames4.default)((_classnames = {}, _classnames[prefix + 'split-btn'] = true, _classnames), className);
        ...
        var triggerClassNames = (0, _classnames4.default)((_classnames2 = {}, _classnames2[prefix + 'split-btn-trigger'] = true, _classnames2[prefix + 'expand'] = state.visible, _classnames2.opened = state.visible, _classnames2));

        var trigger = _react2.default.createElement(
            _button2.default,
            (0, _extends3.default)({}, triggerProps, sharedBtnProps, { className: triggerClassNames }),
            _react2.default.createElement(_icon2.default, { type: 'arrow-down' })
        );

        return _react2.default.createElement(
            _button2.default.Group,
            (0, _extends3.default)({}, _util.obj.pickOthers(SplitButton.propTypes, others), { className: classNames, style: style, size: size, ref: this._wrapperRefHandler }),
...
exports.default = _configProvider2.default.config(SplitButton);
