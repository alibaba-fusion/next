...
var Table = (_temp = _class = function (_React$Component) {
    ...
    function Table(props, context) {
        ...
        _this.handleHoverClass = function (rowIndex, colIndex, isAdd) {
            var crossline = _this.props.crossline;

            var funcName = isAdd ? 'addClass' : 'removeClass';
            crossline && _this.props.entireDataSource.forEach(function (val, index) {
                try {
            ...
            try {
                ...
                // need to clear refs of this.tableInc when dataSource Changed
                // in virtual table
                var currentRow = (0, _reactDom.findDOMNode)(_this.getRowRef(rowIndex));
                currentRow && _util.dom[funcName](currentRow, 'hovered');
            } catch (error) {
                return null;
            }
        };
        ...
        _this.findEventTarget = function (e) {
            ...
            var colIndex = e.target.getAttribute('data-next-table-col'),
                rowIndex = e.target.getAttribute('data-next-table-row');
            crossline && !colIndex && !rowIndex && _this.props.entireDataSource.forEach(function (val, row) {
                _this.flatChildren.forEach(function (child, col) {
                    try {
                        // in case of finding an unmounted component due to cached data
                        // need to clear refs of this.tableInc when dataSource Changed
                        // in virtual table
                        var currentCol = (0, _reactDom.findDOMNode)(_this.getCellRef(row, col));
        ...
        _this.onBodyMouseOver = function (e) {
            ...
            if (_this.colIndex === colIndex && _this.rowIndex === rowIndex) {
                return;
            }
            _this.handleHoverClass(rowIndex, colIndex, true);
        ...
        _this.onBodyMouseOut = function (e) {
            _this.handleHoverClass(_this.rowIndex, _this.colIndex, false);
            ...
            _this.handleHoverClass(rowIndex, colIndex, false);
