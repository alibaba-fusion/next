    ...
    var SelectionTable = (_temp = _class = function (_React$Component) {
        ...
        function SelectionTable(props, context) {
            ...
            _this.renderSelectionHeader = function () {
                ...
                return mode === 'multiple' ? _react2.default.createElement(_checkbox2.default, (0, _extends3.default)({ 'aria-label': locale.selectAll, checked: checked, onChange: onChange }, attrs)) : null;
            };
