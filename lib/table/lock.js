            ...
            if (this.isLock()) {
                this.tableInc.groupChildren.forEach(function (child, index) {
                    ...
                    if (headerRightRow) {
                        ...
                        headerRightLockRow && _util.dom.setStyle(headerRightLockRow, 'height', maxRightRowHeight);
                    }

                    if (headerLeftRow) {
                        var maxLeftRowHeight = Math.max(headerLeftLockRowHeight, headerLeftRow.offsetHeight);
                        headerLeftLockRow && _util.dom.setStyle(headerLeftLockRow, 'height', maxLeftRowHeight);
                    }
                });
            }
        };
