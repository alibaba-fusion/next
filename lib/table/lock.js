...
function lock(BaseComponent) {
    ...
    var LockTable = (_temp = _class = function (_React$Component) {
        ...
        function LockTable(props, context) {
            ...
            _this.onLockBodyLRScroll = function (event, lockType) {
                if (_this.isLock()) {
            ...
            _this.onLockBodyScroll = function (event) {
                if (_this.isLock()) {
                    ...
                    var arr = [lockLeftBody, lockRightBody],
        ...
        LockTable.prototype.adjustCellSize = function adjustCellSize() {
            ...
            if (this.isLock()) {
                this.tableInc.props.dataSource.forEach(function (item, index) {
                    ...
                    // 同步最左侧的锁列
                    _this4.lockLeftChildren.forEach(function (child, i) {
                        _this4.setCellSize(rowIndex, i, 'left');
                    });
                    // 同步最右侧的锁列
                    _this4.lockRightChildren.forEach(function (child, i) {
                        _this4.setCellSize(rowIndex, i, 'right');
                    });
                });
            }
        };
        ...
        onLockBodyLRScroll: _propTypes2.default.func,
