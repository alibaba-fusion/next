...
var body_1 = require("./lock/body");
var header_1 = require("./lock/header");
...
function lock(BaseComponent) {
    ...
    var LockTable = /** @class */ (function (_super) {
        ...
        LockTable.prototype.adjustBodySize = function () {
            ...
            if (this.isLock()) {
                ...
                lockRightBodyWrapper &&
                    +scrollBarSize &&
                    util_1.dom.setStyle(lockRightBodyWrapper, rtl ? 'left' : 'right', "".concat(width, "px"));
            }
            else {
                style.marginBottom = -scrollBarSize;
                style.paddingBottom = scrollBarSize;
        ...
        LockTable.prototype.render = function () {
            ...
            var _b = this.props, children = _b.children, columns = _b.columns, prefix = _b.prefix, components = _b.components, className = _b.className, dataSource = _b.dataSource, tableWidth = _b.tableWidth, others = tslib_1.__rest(_b, ["children", "columns", "prefix", "components", "className", "dataSource", "tableWidth"]);
            ...
            if (this.isOriginLock()) {
                ...
                className = (0, classnames_1.default)((_a = {},
                    ...
                    _a));
                var content = [
                    react_1.default.createElement(BaseComponent, tslib_1.__assign({}, others, { dataSource: dataSource, key: "lock-left", columns: lockLeftChildren, className: "".concat(prefix, "table-lock-left"), lengths: lengths, prefix: prefix, lockType: "left", components: components, ref: this.saveLockLeftRef, loading: false, "aria-hidden": true })),
                    react_1.default.createElement(BaseComponent, tslib_1.__assign({}, others, { dataSource: dataSource, key: "lock-right", columns: lockRightChildren, className: "".concat(prefix, "table-lock-right"), lengths: lengths, prefix: prefix, lockType: "right", components: components, ref: this.saveLockRightRef, loading: false, "aria-hidden": true })),
                ];
