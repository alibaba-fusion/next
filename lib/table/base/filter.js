...
var Filter = (_temp = _class = function (_React$Component) {
    ...
    Filter.prototype.render = function render() {
        ...
        var cls = (0, _classnames4.default)((_classnames = {}, _classnames[prefix + 'table-filter'] = true, _classnames[className] = className, _classnames));

        var filterIconCls = (0, _classnames4.default)((_classnames2 = {}, _classnames2[prefix + 'table-filter-active'] = selectedKeys && selectedKeys.length > 0, _classnames2));
