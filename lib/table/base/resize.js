...
var Resize = (_temp2 = _class = function (_React$Component) {
    ...
    Resize.prototype.unSelect = function unSelect() {
        var height = _util.dom.getStyle(this.props.tableEl, 'height');
        _util.dom.setStyle(document.body, {
            userSelect: 'none',
            cursor: 'ew-resize'
        });
        _util.dom.setStyle(this.resizeRef, { height: height });
        document.body.setAttribute('unselectable', 'on');
        _util.dom.addClass(this.resizeRef, 'resizing');
    };
    ...
    Resize.prototype.select = function select() {
        ...
        _util.dom.setStyle(this.resizeRef, { height: '100%' });
        document.body.removeAttribute('unselectable');
        _util.dom.removeClass(this.resizeRef, 'resizing');
    };
