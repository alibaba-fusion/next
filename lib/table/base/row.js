...
var Row = (_temp2 = _class = function (_React$Component) {
    ...
    Row.prototype.render = function render() {
        ...
        var _props3 = this.props,
            ...
            tableOuterWidth = _props3.tableOuterWidth,
            rtl = _props3.rtl,
            wrapper = _props3.wrapper,
            others = (0, _objectWithoutProperties3.default)(_props3, ['prefix', 'className', 'onClick', 'onMouseEnter', 'onMouseLeave', 'columns', 'Cell', 'getCellProps', 'rowIndex', 'record', '__rowIndex', 'children', 'primaryKey', 'cellRef', 'colGroup', 'pure', 'locale', 'expandedIndexSimulate', 'tableOuterWidth', 'rtl', 'wrapper']);
