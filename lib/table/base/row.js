...
var Row = (_temp2 = _class = function (_React$Component) {
    ...
    Row.prototype.renderCells = function renderCells(record, rowIndex) {
        ...
        return columns.map(function (child, colIndex) {
            ...
            var dataIndex = child.dataIndex,
                ...
                style = child.style,
                others = (0, _objectWithoutProperties3.default)(child, ['dataIndex', 'align', 'alignHeader', 'width', 'colSpan', 'style']);
    ...
    Row.prototype.render = function render() {
        ...
        var _props2 = this.props,
            ...
            colGroup = _props2.colGroup,
            pure = _props2.pure,
            locale = _props2.locale,
            expandedIndexSimulate = _props2.expandedIndexSimulate,
            rtl = _props2.rtl,
            wrapper = _props2.wrapper,
            others = (0, _objectWithoutProperties3.default)(_props2, ['prefix', 'className', 'onClick', 'onMouseEnter', 'onMouseLeave', 'columns', 'Cell', 'getCellProps', 'rowIndex', 'record', 'children', 'primaryKey', 'cellRef', 'colGroup', 'pure', 'locale', 'expandedIndexSimulate', 'rtl', 'wrapper']);
