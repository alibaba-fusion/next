...
function stickyLock(BaseComponent) {
    ...
    /** Table */
    var LockTable = (_temp2 = _class = function (_React$Component) {
        ...
        function LockTable() {
            ...
            return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {}, _this.updateOffsetArr = function () {
                ...
                var _this2 = _this,
                    pingRight = _this2.pingRight,
                    pingLeft = _this2.pingLeft;
        ...
        LockTable.prototype.render = function render() {
            ...
            var _props2 = this.props,
                ...
                others = (0, _objectWithoutProperties3.default)(_props2, ['children', 'columns', 'prefix', 'components', 'className', 'dataSource']);
