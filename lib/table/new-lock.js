...
function stickyLock(BaseComponent) {
    ...
    var LockTable = /** @class */ (function (_super) {
        ...
        LockTable.prototype.render = function () {
            ...
            var _b = this.props, children = _b.children, columns = _b.columns, prefix = _b.prefix, components = _b.components, scrollToRow = _b.scrollToRow, className = _b.className, dataSource = _b.dataSource, others = tslib_1.__rest(_b, ["children", "columns", "prefix", "components", "scrollToRow", "className", "dataSource"]);
