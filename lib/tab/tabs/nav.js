...
var Nav = /** @class */ (function (_super) {
    ...
    function Nav(props, context) {
        ...
        _this.defaultTabTemplateRender = function (key, _a) {
            ...
            var tail = closeable ? (react_1.default.createElement(icon_1.default, { "aria-label": locale.closeAriaLabel, type: "close", tabIndex: "0", onKeyDown: function (e) { return _this.onCloseKeyDown(key, e); }, onClick: function (e) { return _this.removeTab(key, e); }, className: "".concat(prefix, "tabs-tab-close") })) : null;
            return (react_1.default.createElement("div", { className: "".concat(prefix, "tabs-tab-inner") },
                title,
                tail));
        };
    ...
    Nav.prototype.renderTabList = function (props, hideAdd) {
        ...
        if (!hideAdd && showAdd) {
            rst.push(react_1.default.createElement("li", { role: "button", className: "".concat(prefix, "tabs-tab ").concat(prefix, "tabs-add"), onClick: onAdd, key: "add" },
                react_1.default.createElement("div", { className: "".concat(prefix, "tabs-tab-inner") }, addIcon ? addIcon : react_1.default.createElement(icon_1.default, { type: "add" }))));
        }
        return rst;
    };
    ...
    Nav.prototype.renderDropdownTabs = function (tabs) {
        ...
        return (react_1.default.createElement(Popup, tslib_1.__assign({ key: "down", rtl: rtl, triggerType: triggerType, trigger: trigger, container: function (target) { return target.parentNode; }, className: "".concat(prefix, "tabs-bar-popup") }, popupProps),
            react_1.default.createElement(menu_1.default, { rtl: rtl, selectedKeys: [activeKey], onSelect: this.onSelectMenuItem, selectMode: "single" }, tabs.map(function (tab) {
    ...
    Nav.prototype.render = function () {
        var _a, _b;
        var _c = this.props, prefix = _c.prefix, tabPosition = _c.tabPosition, excessMode = _c.excessMode, extra = _c.extra, onKeyDown = _c.onKeyDown, animation = _c.animation, style = _c.style, className = _c.className, showAdd = _c.showAdd, onAdd = _c.onAdd, addIcon = _c.addIcon, rtl = _c.rtl;
        ...
        var containerCls = (0, classnames_1.default)((_a = {},
        ...
        var wrapCls = (0, classnames_1.default)((_b = {},
            _b["".concat(prefix, "tabs-nav-wrap")] = true,
            _b["".concat(prefix, "tabs-nav-has-add")] = showAdd,
            _b));
        var container = (react_1.default.createElement("div", { className: containerCls, onKeyDown: onKeyDown, key: "nav-container" },
            react_1.default.createElement("div", { className: "".concat(prefix, "tabs-nav-wrap"), ref: this.wrapperRefHandler },
                react_1.default.createElement("div", { className: "".concat(prefix, "tabs-nav-scroll"), ref: this.scrollerRefHandler, onScroll: this.onScroll }, animation ? (react_1.default.createElement(animate_1.default, { role: "tablist", "aria-multiselectable": false, component: "ul", className: navCls, animation: navCls, singleMode: false, ref: this.navRefHandler, afterAppear: this.initialSettings.bind(this) }, tabList)) : (react_1.default.createElement("ul", { role: "tablist", className: "".concat(navCls, " ").concat(prefix, "disable-animation"), ref: this.navRefHandler }, tabList)))),
            showAdd && hasExtra ? (react_1.default.createElement("div", { className: "".concat(navCls, "-operations") },
                prevButton,
                nextButton,
                restButton,
                react_1.default.createElement("li", { className: "".concat(prefix, "tabs-tab ").concat(prefix, "tabs-add"), onClick: onAdd, key: "add" },
                    react_1.default.createElement("div", { className: "".concat(prefix, "tabs-tab-inner") }, addIcon ? addIcon : react_1.default.createElement(icon_1.default, { type: "add" }))))) : ([prevButton, nextButton, restButton])));
