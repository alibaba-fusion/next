...
var Nav = /** @class */ (function (_super) {
    ...
    function Nav(props) {
        ...
        _this.navRefHandler = function (ref) {
            var domNode = (0, react_dom_1.findDOMNode)(ref);
    ...
    Nav.prototype.getIcon = function (type) {
        ...
        if (icons && icons[type]) {
            ...
            if (typeof customIcon === 'string') {
                icon = react_1.default.createElement(icon_1.default, { rtl: rtl, type: customIcon });
            }
            else if (react_1.default.isValidElement(customIcon)) {
                icon = customIcon;
            }
        }
        return icon;
