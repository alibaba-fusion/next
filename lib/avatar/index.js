...
var Avatar = /** @class */ (function (_super) {
    ...
    Avatar.prototype.render = function () {
        var _a;
        var _b = this.props, prefix = _b.prefix, className = _b.className, style = _b.style, size = _b.size, icon = _b.icon, alt = _b.alt, srcSet = _b.srcSet, shape = _b.shape, src = _b.src;
        ...
        if (src) {
            if (isImgExist) {
                children = (react_1.default.createElement("img", { src: src, srcSet: srcSet, onError: this.handleImgLoadError, alt: alt }));
            }
            else {
        ...
        return (react_1.default.createElement("span", tslib_1.__assign({ className: cls, style: tslib_1.__assign(tslib_1.__assign({}, sizeStyle), style) }, others), children));
    };
    Avatar.propTypes = {
