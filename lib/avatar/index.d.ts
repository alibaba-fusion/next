...
declare const _default: {
    new (props: AvatarProps & import("../config-provider/types").ComponentCommonProps, context?: unknown): import("../config-provider/types").ConfiguredComponent<AvatarProps & import("../config-provider/types").ComponentCommonProps, Avatar>;
