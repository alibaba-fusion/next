...
declare const Card: (import("../../config-provider/types").ConfiguredComponentClass<import("../types").CardProps & import("../../config-provider/types").ComponentCommonProps, import("../card").default, {}> & {
