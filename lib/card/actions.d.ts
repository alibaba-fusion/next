...
declare const _default: import("../config-provider/types").ConfiguredComponentClass<CardActionsProps & import("../config-provider/types").ComponentCommonProps, CardActions, {}>;
