...
declare const _default: import("../config-provider/types").ConfiguredComponentClass<CardBulletHeaderProps & import("../config-provider/types").ComponentCommonProps, CardBulletHeader, {}>;
