...
declare const _default: import("../config-provider/types").ConfiguredComponentClass<CardDividerProps & import("../config-provider/types").ComponentCommonProps, CardDivider, {}>;
