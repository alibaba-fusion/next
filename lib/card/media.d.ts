...
declare const _default: import("../config-provider/types").ConfiguredComponentClass<CardMediaProps & import("../config-provider/types").ComponentCommonProps, CardMedia, {}>;
