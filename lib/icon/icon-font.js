...
function createFromIconfontCN(options) {
    ...
    var Iconfont = function (props) {
        ...
        react_1.default.createElement(ConfigIcon, { size: size },
            react_1.default.createElement("svg", tslib_1.__assign({ className: classes, focusable: false }, others, extraCommonProps), content)));
    };
