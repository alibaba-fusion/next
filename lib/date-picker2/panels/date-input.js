...
var DateInput = (_temp = _class = function (_React$Component) {
    ...
    DateInput.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            state = _props.state,
            restProps = (0, _objectWithoutProperties3.default)(_props, ['autoFocus', 'readOnly', 'isRange', 'value', 'prefix', 'hasClear', 'inputType', 'size', 'focus', 'hasBorder', 'separator', 'disabled', 'inputProps', 'dateInputAriaLabel', 'state']);


        var placeholder = this.getPlaceholder();
        var htmlSize = String(Math.max(this.formatter((0, _util.datejs)('2020-12-12 24:00:00')).length, hasBorder ? 12 : 8));
    ...
    rtl: PT.bool,
    locale: PT.object,
    value: _propTypes3.default.inputValue,
    ...
    readOnly: false,
    hasClear: true,
    separator: _react2.default.createElement(_icon2.default, { size: 'xxs', type: 'minus' }),
    hasBorder: true,
    size: 'medium'
}, _temp);
