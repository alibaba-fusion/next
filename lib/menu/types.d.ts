...
export type ChildItemPropsInMenu<Props extends object> = Props & ChildPropsFromMenu & Partial<ChildPropsFromSubMenu & ChildPropsFromGroup>;
export type ItemPropsFromParent = Partial<ChildPropsFromMenu & ChildPropsFromSubMenu & ChildPropsFromGroup>;
/**
 * Menu.Item
 * @order 0
 */
export interface ItemProps extends Omit<React.HTMLAttributes<Element>, 'onClick' | 'onChange' | 'onSelect' | 'type'>, ItemPropsFromParent {
    /**
     * 是否禁用
     ...
     */
    onSelect?: (selected: boolean, menuItem: SelectableItem, event: React.MouseEvent | React.KeyboardEvent) => void;
    /**
     * 指定所属 menu 菜单实例
     * @skip
     */
...
export interface CheckboxItemProps extends ItemProps {
     ...
     * @param event - 事件对象 - Event object
     */
    onChange?: (checked: boolean, event: React.MouseEvent | React.KeyboardEvent | React.ChangeEvent) => void;
    /**
     * 帮助文本
     * @en help text
     */
 ...
 * @api
 */
export interface MenuProps extends Omit<React.HTMLAttributes<HTMLElement>, 'onSelect'>, CommonProps {
    /**
     * 菜单项和子菜单
     ...
     */
    onItemFocus?: (key: string, item: MenuItem, event: React.MouseEvent | React.KeyboardEvent) => void;
    /**
     * 点击菜单项触发的回调函数
     ...
     * @param event - 事件对象 - Event object
     */
    onItemClick?: (key: string, item: MenuItem, event: React.MouseEvent | React.KeyboardEvent) => void;
    /**
     * 菜单项触发键盘按下的回调函数
     ...
     * @param event - 事件对象 - Event object
     */
    onItemKeyDown?: (key: string | null | undefined, item: MenuItem, event: React.KeyboardEvent) => void;
    /**
     ...
     */
    renderMore?: (items?: React.ReactElement[]) => React.ReactElement<{
        className?: string;
...
export interface CreateMenuProps extends Pick<OverlayProps, 'target' | 'align' | 'offset' | 'afterClose'>, MenuProps {
