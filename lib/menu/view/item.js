...
var Item = (_temp = _class = function (_Component) {
    ...
    Item.prototype.render = function render() {
        ...
        if (parentMode === 'inline' && level > 1 && inlineIndent > 0 && needIndent) {
            ...
            others.style = (0, _extends4.default)({}, others.style || {}, (_extends2 = {}, _extends2[rtl ? 'paddingRight' : 'paddingLeft'] = level * inlineIndent - (groupIndent || 0) * 0.4 * inlineIndent + 'px', _extends2));
        }
        var TagName = component;

        return _react2.default.createElement(
            TagName,
            (0, _extends4.default)({ role: 'menuitem',
