...
var Menu = (_temp = _class = function (_Component) {
    ...
    function Menu(props) {
        ...
        bindCtx(_this, ['handleOpen', 'handleSelect', 'handleItemClick', 'handleItemKeyDown']);
    ...
    Menu.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            'ul',
            (0, _extends3.default)({ role: role, className: newClassName, onKeyDown: this.handleEnter, 'aria-multiselectable': selectMode === 'multiple' }, others),
            headerElement,
