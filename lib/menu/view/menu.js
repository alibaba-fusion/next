...
var Menu = (_temp = _class = function (_Component) {
    ...
    Menu.prototype.render = function render() {
        ...
        var newClassName = (0, _classnames2.default)((_cx = {}, _cx[prefix + 'menu'] = true, _cx[prefix + 'ver'] = direction === 'ver', _cx[prefix + 'hoz'] = direction === 'hoz', _cx[prefix + 'menu-embeddable'] = embeddable, _cx[className] = !!className, _cx));
