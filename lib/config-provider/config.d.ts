import { ComponentClass, FunctionComponent, ForwardRefExoticComponent, ComponentProps, ComponentRef, StaticLifecycle } from 'react';
...
declare function config<C extends ComponentClass | ForwardRefExoticComponent<unknown> | FunctionComponent, R = C extends ComponentClass ? InstanceType<C> : C extends ForwardRefExoticComponent<unknown> ? ComponentRef<C> : unknown>(Component: C, options?: ConfigOptions<ComponentProps<C>>): typeof ConfiguredComponent<ComponentProps<C> & ComponentCommonProps, R> & {
