    ...
    var ConfigedComponent = (_temp = _class = function (_React$Component) {
        ...
        ConfigedComponent.prototype.render = function render() {
            var _props = this.props,
                ...
                others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'locale', 'pure', 'rtl', 'device', 'errorBoundary']);
            ...
            var contextProps = (0, _getContextProps2.default)({ prefix: prefix, locale: locale, pure: pure, device: device, rtl: rtl, errorBoundary: errorBoundary }, {
            ...
            var newContextProps = ['prefix', 'locale', 'pure', 'rtl', 'device'].reduce(function (ret, name) {
