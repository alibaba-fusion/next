...
function config(Component) {
    ...
    if (typeOf(Component) === 'Function' && Component.prototype.isReactComponent !== undefined && Component.prototype.shouldComponentUpdate === undefined) {
