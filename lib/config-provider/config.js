    ...
    var ConfigedComponent = (_temp = _class = function (_React$Component) {
        ...
        ConfigedComponent.prototype.render = function render() {
            var _props = this.props,
                ...
                others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'locale', 'pure', 'rtl', 'errorBoundary']);
            var _context = this.context,
                ...
                _context$nextErrorBou = _context.nextErrorBoundary,
                nextErrorBoundary = _context$nextErrorBou === undefined ? {} : _context$nextErrorBou;


            var displayName = options.componentName || getDisplayName(Component);
            var contextProps = (0, _getContextProps2.default)({ prefix: prefix, locale: locale, pure: pure, rtl: rtl, errorBoundary: errorBoundary }, {
