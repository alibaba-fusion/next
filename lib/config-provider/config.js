    ...
    var ConfigedComponent = (_temp = _class = function (_React$Component) {
        ...
        ConfigedComponent.prototype.render = function render() {
            var _props = this.props,
                ...
                others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'locale', 'defaultPropsConfig', 'pure', 'rtl', 'device', 'popupContainer', 'popupClassName', 'errorBoundary']);
            var _context = this.context,
                ...
                nextPopupClassName = _context.nextPopupClassName,
            ...
            var contextProps = (0, _getContextProps2.default)({
                ...
                nextPopupClassName: nextPopupClassName,
            ...
            var newContextProps = ['prefix', 'locale', 'pure', 'rtl', 'device', 'popupContainer', 'popupClassName'].reduce(function (ret, name) {
        ...
        nextPopupClassName: _propTypes2.default.string,
