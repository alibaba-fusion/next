...
declare class ConfigProvider extends Component<ConfigProviderProps, Pick<ConfigProviderProps, 'locale'>> {
    static propTypes: {
        /**
         * 样式类名的品牌前缀
         */
    ...
    static getContext: () => {
        ...
        locale: import("..").Locale | undefined;
    ...
    render(): boolean | {} | import("react").ReactChild | import("react").ReactPortal | null | undefined;
}
