...
function getContextProps(props, context, displayName) {
    ...
    var newErrorBoundary = (0, _extends3.default)({}, typeof nextErrorBoundary === 'boolean' ? { open: nextErrorBoundary } : nextErrorBoundary, typeof errorBoundary === 'boolean' ? { open: errorBoundary } : errorBoundary);
