...
var Panel = /** @class */ (function (_super) {
    ...
    Panel.prototype.render = function () {
        var _a, _b;
        var _c = this.props, title = _c.title, children = _c.children, isExpanded = _c.isExpanded, disabled = _c.disabled, style = _c.style, prefix = _c.prefix, onClick = _c.onClick, id = _c.id, others = tslib_1.__rest(_c, ["title", "children", "isExpanded", "disabled", "style", "prefix", "onClick", "id"]);
