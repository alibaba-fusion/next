    ...
    NumberPicker.prototype.render = function render() {
        ...
        if (type === 'normal') {
            innerAfter = [_react2.default.createElement(
                _button2.default,
                (0, _extends3.default)({}, upBtnProps, { onMouseDown: this.handleMouseDown, disabled: disabled || upDisabled, onClick: this.up.bind(this), key: '0' }),
                _react2.default.createElement(_icon2.default, { size: 'xxs', type: 'arrow-up' })
            ), _react2.default.createElement(
                _button2.default,
                (0, _extends3.default)({}, downBtnProps, { onMouseDown: this.handleMouseDown, disabled: disabled || downDisabled, onClick: this.down.bind(this), key: '1' }),
            ...
            addonBefore = _react2.default.createElement(
                _button2.default,
                (0, _extends3.default)({}, downBtnProps, { size: size, disabled: disabled || downDisabled, onClick: this.down.bind(this) }),
                _react2.default.createElement(_icon2.default, { type: 'minus', size: 'xs' })
            );
            addonAfter = _react2.default.createElement(
                _button2.default,
                (0, _extends3.default)({}, upBtnProps, { size: size, disabled: disabled || upDisabled, onClick: this.up.bind(this) }),
