...
var Modal = (_temp2 = _class = function (_Component) {
    ...
    Modal.prototype.render = function render() {
        var _props = this.props,
            ...
            rtl = _props.rtl,
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'type', 'title', 'content', 'messageProps', 'footerActions', 'onOk', 'onCancel', 'onClose', 'okProps', 'needWrapper', 'rtl']);
...
var show = exports.show = function show() {
    ...
    _reactDom2.default.render(_react2.default.createElement(
        ...
        newContext,
        _react2.default.createElement(ConfigModal, (0, _extends3.default)({}, config, { afterClose: unmount, ref: function ref(_ref) {
                myRef = _ref;
            } }))
    ), container, function () {
        instance = myRef;
