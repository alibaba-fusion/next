...
var Overlay = (_temp = _class = function (_Component) {
    ...
    Overlay.prototype.addDocumentEvents = function addDocumentEvents() {
        ...
        if (this.props.canCloseByEsc) {
            this._keydownEvents = _util.events.on(document, 'keydown', this.handleDocumentKeyDown, true);
        }

        if (this.props.canCloseByOutSideClick) {
            this._clickEvents = _util.events.on(document, 'click', this.handleDocumentClick, true);
            this._touchEvents = _util.events.on(document, 'touchend', this.handleDocumentClick, true);
        }
    };
