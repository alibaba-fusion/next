...
var Overlay = (_temp = _class = function (_Component) {
    ...
    Overlay.prototype.addDocumentEvents = function addDocumentEvents() {
        var _props = this.props,
            ...
            delegateDom = _props.delegateDom;

        var dom = (typeof delegateDom === 'string' ? document.getElementById(delegateDom) : delegateDom) || document;
        ...
        if (this.props.canCloseByEsc) {
            this._keydownEvents = _util.events.on(dom, 'keydown', this.handleDocumentKeyDown, useCapture);
        }
    ...
    Overlay.prototype.render = function render() {
        var _props2 = this.props,
            ...
            needAdjust = _props2.needAdjust,
            autoFit = _props2.autoFit,
            beforePosition = _props2.beforePosition,
            onPosition = _props2.onPosition,
            wrapperStyle = _props2.wrapperStyle,
            rtl = _props2.rtl,
            propShouldUpdatePosition = _props2.shouldUpdatePosition,
            cache = _props2.cache,
            wrapperClassName = _props2.wrapperClassName,
            onMaskMouseEnter = _props2.onMaskMouseEnter,
            onMaskMouseLeave = _props2.onMaskMouseLeave,
            maskClass = _props2.maskClass,
            isChildrenInMask = _props2.isChildrenInMask,
            pinFollowBaseElementWhenFixed = _props2.pinFollowBaseElementWhenFixed;
     ...
     */
    delegateDom: _propTypes2.default.any,
    /**
     * esc 触发关闭后是否阻止事件冒泡
     */
    ifStopBubbling: _propTypes2.default.bool
}, _class.defaultProps = {
    prefix: 'next-',
    pure: false,
    visible: false,
