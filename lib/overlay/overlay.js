        ...
        if (this.props.disableScroll) {
            if (modals.length === 0) {
                ...
                if (hasScroll(this.containerNode)) {
                    ...
                    style.paddingRight = _util.dom.getStyle(this.containerNode, 'paddingRight') + _util.dom.scrollbar().width + 'px';
                }

                _util.dom.setStyle(this.containerNode, style);
            }
            modals.push(this);
        }
    };
        ...
        if (this.props.disableScroll) {
            ...
            if (index > -1) {
                if (modals.length === 1) {
                    ...
                    this.containerNode && _util.dom.setStyle(this.containerNode, style);
