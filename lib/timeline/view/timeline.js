...
var Timeline = (_temp = _class = function (_Component) {
    ...
    Timeline.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            mode = _props.mode,
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'rtl', 'className', 'children', 'locale', 'animation', 'mode']);
        ...
        var timelineCls = (0, _classnames2.default)((_classNames = {}, _classNames[prefix + 'timeline'] = true, _classNames[prefix + 'alternate'] = isAlternateMode, _classNames), className);
        ...
        return _react2.default.createElement(
            'ul',
            (0, _extends3.default)({}, _util.obj.pickOthers(Timeline.propTypes, others), { className: timelineCls }),
            cloneChildren
        );
    };
     ...
     * @enumdesc 左, 交错显示
    */
    mode: _propTypes2.default.oneOf(['left', 'alternate'])
}), _class.defaultProps = {
    prefix: 'next-',
    rtl: false,
    fold: [],
