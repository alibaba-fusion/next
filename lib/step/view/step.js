...
var Step = (_temp = _class = function (_Component) {
    ...
    function Step(props, context) {
        ...
        _this.handleKeyDown = function (e) {
            ...
            currentfocus = currentfocus >= max ? 0 : currentfocus < 0 ? max - 1 : currentfocus;
            _this.setState({ currentfocus: currentfocus }, function () {
                var child = _this.step.children[currentfocus];
                if (!child) return;
                var focusItem = shape === 'arrow' ? child : child.querySelector('.next-step-item-body');
    ...
    Step.prototype.render = function render() {
        ...
        var cloneChildren = _react.Children.map(children, function (child, index) {
            ...
            return _react2.default.cloneElement(child, {
                ...
                readOnly: readOnly,
                animation: animation,
                tabIndex: _this2.state.currentfocus === index ? '0' : '-1',
