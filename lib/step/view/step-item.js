...
var StepItem = (_temp = _class = function (_Component) {
    ...
    StepItem.prototype.resize = function resize() {
        ...
        if (direction === 'vertical' || direction === 'ver') {
            ...
            var stepHozWhitespace = _util.dom.getNodeHozWhitespace(this.step.parentNode);
            var stepBodyHozWhitespace = _util.dom.getNodeHozWhitespace(this.body);
            var rtl = this.props.rtl;

            rtl ? this.body.style.right = stepWidth + 'px' : this.body.style.left = stepWidth + 'px';
            _util.dom.setStyle(this.body, {
                width: _util.dom.getStyle(this.step.parentNode.parentNode, 'width') - stepWidth - stepHozWhitespace - stepBodyHozWhitespace
            });
