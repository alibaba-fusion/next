...
var StepItem = (_temp = _class = function (_Component) {
    ...
    StepItem.prototype.getNode = function getNode(args) {
        ...
        return _react2.default.createElement(
            'div',
            (0, _extends3.default)({ tabIndex: '0', 'aria-current': status === 'process' ? 'step' : null }, others, { style: this.getStyle(), className: stepCls, ref: this._refHandlerCreator('step') }),
            finalNodeElement,
            _react2.default.createElement(
                'div',
    ...
    StepItem.prototype.render = function render() {
        ...
        var arrowElement = _react2.default.createElement(
            'div',
            (0, _extends3.default)({ tabIndex: '0', 'aria-current': status === 'process' ? 'step' : null }, others, { style: this.getStyle(), className: stepCls, onClick: this.onClick }),
            _react2.default.createElement(
                'div',
                { className: prefix + 'step-item-container' },
                _react2.default.createElement(
