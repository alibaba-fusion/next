...
var Inner = /** @class */ (function (_super) {
    ...
    Inner.prototype.renderHeader = function () {
        ...
        var headerCls = (0, classnames_1.default)((_a = {},
            ...
            _a));
        return (react_1.default.createElement("div", { className: headerCls, style: headerStyle, role: "heading", "aria-level": "1" },
            title,
            closeLink));
    };
    ...
    Inner.prototype.renderCloseLink = function () {
        ...
        if (closeable) {
            return (react_1.default.createElement("a", { role: "button", "aria-label": locale.close, className: "".concat(prefix, "drawer-close"), onClick: onClose },
