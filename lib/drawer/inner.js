...
var Inner = (_temp = _class = function (_Component) {
    ...
    Inner.prototype.renderHeader = function renderHeader() {
        ...
        return _react2.default.createElement(
            'div',
            { className: headerCls, style: headerStyle, role: 'heading', 'aria-level': '1' },
            title,
            closeLink
        );
    };
    ...
    Inner.prototype.renderCloseLink = function renderCloseLink() {
        ...
        if (closeable) {
            return _react2.default.createElement(
                'a',
                { role: 'button', 'aria-label': locale.close, className: prefix + 'drawer-close', onClick: onClose },
                _react2.default.createElement(_icon2.default, { className: prefix + 'drawer-close-icon', type: 'close' })
            );
        }
    ...
    Inner.prototype.render = function render() {
        ...
        var newClassName = (0, _classnames2.default)((_cx2 = {}, _cx2[prefix + 'drawer'] = true, _cx2[prefix + 'drawer-' + placement] = !v2, _cx2[prefix + 'closeable'] = closeable, _cx2[className] = !!className, _cx2));
        ...
        return _react2.default.createElement(
            ...
            v2 ? _react2.default.createElement(
                'div',
                { className: prefix + 'drawer-content' },
                header,
                body
