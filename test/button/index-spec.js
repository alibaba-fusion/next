...
describe('Button', () => {
    describe('render', () => {
        ...
        it('should render custom loading button', () => {
            const wrapper = mount(<Button ghost id="custom-loading-btn" loading icons={{ loading: <Icon type="loading" /> }}>确定</Button>);

            assert(wrapper.find('#custom-loading-btn .next-btn-custom-loading-icon').length === 1);
