...
import TimePicker2 from '../../src/time-picker-2/index';
...
describe('TimePicker2', () => {
    describe('render', () => {
        ...
        it('should render with format', () => {
            wrapper = mount(
                <TimePicker2 defaultValue="10:1:1" format="H:m:s" />
            );
            assert(
                wrapper.find('.next-time-picker2-input input').instance()
                    .value === '10:1:1'
        ...
        it('should render with defaultVisible', () => {
            wrapper = mount(
                <TimePicker2 defaultValue={defaultValue} defaultVisible />
            );
            assert(
                wrapper
                    .find(
        ...
        it('should render with step', () => {
            ...
            assert(
                wrapper.find(
                    '.next-time-picker2-menu-second .next-time-picker2-menu-item'
                ).length === 12
            );
        });
    ...
    describe('action', () => {
        ...
        it('should select time-picker-2 panel', () => {
            ...
            wrapper
                .find(
                    '.next-time-picker2-menu-minute .next-time-picker2-menu-item'
                )
                .at(2)
                .simulate('click');
            assert(ret === '02:02:00');
