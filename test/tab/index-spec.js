...
describe('Tab', () => {
    ...
    describe('with props', () => {
        ...
        it('should render with tabPosition (wrapped)', () => {
            wrapper = mount(<Tab tabPosition="left" shape="wrapped">{panes}</Tab>);
        ...
        it('should render with extra', () => {
            wrapper = mount(<Tab extra={<div className="test-extra"></div>}>{panes}</Tab>);
        ...
        it('should render with navStyle & navClassName', () => {
            ...
            wrapper = mount(<Tab navClassName="custom-nav" navStyle={navStyle}>{panes}</Tab>);
    ...
    describe('with action', () => {
        ...
        it('should click to change', () => {
            let clickCounter = 0;
            let changeCounter = 0;
            wrapper = mount(<Tab onClick={() => ++clickCounter} onChange={() => ++changeCounter}>{panes}</Tab>);
        ...
        it('should change tabs with triggerType', () => {
            let changeCounter = 0;
            wrapper = mount(<Tab triggerType="hover" onChange={() => ++changeCounter}>{panes}</Tab>);
    ...
    describe('slide mode', () => {
        ...
        it('should render excess tabs with slides', () => {
            wrapper = mount(<div style={boxStyle}><Tab>{panes}</Tab></div>, { attachTo: target });
        ...
        it('should click prev/next to slide', () => {
            wrapper = mount(<div style={boxStyle}><Tab animation={false}>{panes}</Tab></div>, { attachTo: target });
            assert(wrapper.find('.next-tabs-btn-prev').hasClass('disabled'));
        ...
        it('should render excess tabs with dropdown', () => {
            wrapper = mount(<div style={boxStyle}><Tab excessMode="dropdown" shape="wrapped">{panes}</Tab></div>, { attachTo: target });
