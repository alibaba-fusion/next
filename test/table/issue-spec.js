...
describe('Issue', () => {
    ...
    it('should support locking columns when the data source is empty and in the same grouping, close #4282', () => {
        ...
        ReactDOM.render(<Table.StickyLock dataSource={[]} fixedHeader maxBodyHeight={400}>
        ...
        const title2CellLeft = container.querySelector('th.next-table-fix-left-last[rowspan="1"]').getBoundingClientRect().left;
