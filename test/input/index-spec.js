...
describe('input', () => {
    describe('render', () => {
        ...
        it('should accept addonBefore & addonAfter', () => {
            let wrapper = mount(<Input addonBefore="test" addonAfter="test2"/>);
    ...
    describe('behavior', () => {
        ...
        it('should support maxLength & hasLimitHint', (done) => {
            let wrapper = mount(<Input defaultValue={"abcd"} maxLength={10} hasLimitHint/>);
        ...
        it('should support onPressEnter & onFocus & onBlur', (done) => {
            ...
            let wrapper2 = mount(<Input defaultValue={'123'} onFocus={(e) => {
                assert(e.target.value === '123');
            }}/>);
            wrapper2.find('input').simulate('focus');

            let wrapper3 = mount(<Input defaultValue={'123'} onBlur={(e) => {
                assert(e.target.value === '123');
            }}/>);
        ...
        it('should support hasClear', (done) => {
            ...
            assert(wrapper.find('.next-icon').hasClass('next-icon-delete-filling'));
            wrapper.find('.next-icon').simulate('click');
            assert(wrapper.find('input').prop('value') === '');

            // hasClear with disabled
            let wrapper2 = mount(<Input defaultValue="abcdef" hasClear disabled/>);
        ...
        it('should support getValueLength', (done) => {
            ...
            let getValueLength2 = (value) => {
                return 1;
            }, wrapper = mount(<Input defaultValue="abcdef" maxLength={10} hasLimitHint
