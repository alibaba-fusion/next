    ...
    const expectStyle = (number, removeTransition, position) => {
        ...
        if (support.animation) {
            const expectTransition = transition => {
                ...
                return transition === 'transform 0.3s cubic-bezier(0.645, 0.045, 0.355, 1), -webkit-transform 0.3s cubic-bezier(0.645, 0.045, 0.355, 1)' || 'transform 0.3s cubic-bezier(0.645, 0.045, 0.355, 1) 0s, -webkit-transform 0.3s cubic-bezier(0.645, 0.045, 0.355, 1) 0s';
            };
            return expectTransition(style.transition) &&
