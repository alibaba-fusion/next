...
describe('DatePicker', () => {
    ...
    describe('action', () => {
        ...
        it('should input value in picker', () => {
            ...
            wrapper.find('.next-date-picker-panel-input input').at(0).simulate('change', { target: { value: '2017-11-11' } });
            wrapper.find('.next-date-picker-panel-input input').at(0).simulate('blur');
            wrapper.find('.next-date-picker-panel-input input').at(1).simulate('change', { target: { value: '11:11:11' } });
            wrapper.find('.next-date-picker-panel-input input').at(1).simulate('blur');
        ...
        it('should focus input to change panel', () => {
            ...
            wrapper.find('.next-date-picker-panel-input input').at(1).simulate('focus');
            assert(wrapper.find('.next-time-picker-panel').length === 1);
            wrapper.find('.next-date-picker-panel-input input').at(0).simulate('focus');
            wrapper.find('.next-date-picker-panel-input input').at(0).simulate('blur');
        ...
        it('should select time panel', () => {
            let ret;
            wrapper = mount(<DatePicker showTime defaultVisible defaultValue={startValue} onChange={val => ret = val} />);
            wrapper.find('.next-date-picker-panel-input input').at(1).simulate('focus');
            wrapper.find('.next-time-picker-menu-hour .next-time-picker-menu-item').at(3).simulate('click');
        ...
        it('should select time panel by time-btn', () => {
            let ret;
            wrapper = mount(<DatePicker showTime defaultVisible defaultValue={startValue} />);
            wrapper.find('.next-date-picker-panel-footer .next-btn').at(0).simulate('click');
            assert(wrapper.find('div.next-date-picker-panel-time').length === 1);
        });

        it('should click onOk', () => {
            let ret;
            wrapper = mount(<DatePicker showTime defaultVisible defaultVisibleMonth={() => startValue} onOk={val => ret = val} />);
            wrapper.find('td[title="2017-11-09"] .next-calendar-date').simulate('click');
            wrapper.find('.next-date-picker-panel-footer .next-btn').at(1).simulate('click');
            assert(ret.format('YYYY-MM-DD HH:mm:ss') === '2017-11-09 00:00:00');
        });

        it('should set defaultValue for TimePicker', () => {
            let ret;
            wrapper = mount(<DatePicker showTime={{ defaultValue: defaultTimeValue }} defaultVisible defaultVisibleMonth={() => startValue} onChange={val => ret = val} />);
            wrapper.find('td[title="2017-11-09"] .next-calendar-date').simulate('click');
    ...
    describe('with date string', () => {
        ...
        it('should set defaultValue as string for TimePicker', () => {
            let ret;
            wrapper = mount(<DatePicker showTime={{ defaultValue: "09:00:00" }} defaultVisible defaultVisibleMonth={() => startValue} onChange={val => ret = val} />);
            wrapper.find('td[title="2017-11-09"] .next-calendar-date').simulate('click');
            assert(ret.format('YYYY-MM-DD HH:mm:ss') === '2017-11-09 09:00:00');
            wrapper.find('td[title="2017-11-11"] .next-calendar-date').simulate('click');
            assert(ret.format('YYYY-MM-DD HH:mm:ss') === '2017-11-11 09:00:00');
...
describe('YearPicker', () => {
    ...
    describe('action', () => {
        it('should select', () => {
            ...
            wrapper.find('div.next-calendar-year').at(5).simulate('click');
...
describe('RangePicker', () => {
    ...
    describe('render with props', () => {
        ...
        it('should render with defaultValue', () => {
            ...
            assert(wrapper.find('.next-range-picker-trigger-input input').at(0).instance().value === '2017-11-20');
            assert(wrapper.find('.next-range-picker-trigger-input input').at(1).instance().value === '2017-12-15');
        });
        ...
        it('should render controlled value of RangePicker', () => {
            ...
            wrapper.setProps({ value: [startValue.clone().add(1, 'days'), endValue.clone().add(1, 'days')] });
            assert(wrapper.find('.next-range-picker-trigger-input input').at(0).instance().value === '2017-11-21');
            assert(wrapper.find('.next-range-picker-trigger-input input').at(1).instance().value === '2017-12-16');
        });
    ...
    describe('action', () => {
        it('should foucs the input of start date', () => {
            wrapper = mount(<RangePicker />);
            wrapper.find('.next-range-picker-trigger-input input').at(0).simulate('focus');
            wrapper.find('.next-range-picker-trigger-input input').at(0).simulate('click');
            wrapper.find('span.next-range-picker-panel-input-start-date').hasClass('next-focus');
        });

        it('should foucs the input of end date', () => {
            wrapper = mount(<RangePicker />);
            wrapper.find('.next-range-picker-trigger-input input').at(1).simulate('focus');
            wrapper.find('.next-range-picker-trigger-input input').at(1).simulate('click');
        ...
        it('should slect range with same day', () => {
            let ret;
            wrapper = mount(<RangePicker defaultValue={[startValue, endValue]} onChange={val => ret = val} visible />);
            wrapper.find('.next-range-picker-panel-input-start-date input').simulate('focus');
            wrapper.find('td[title="2017-11-09"] .next-calendar-date').simulate('click');
        ...
        it('should input range value', function() {
            this.timeout(3000);
            let ret;
            wrapper = mount(<RangePicker defaultVisibleMonth={() => startValue} showTime visible onChange={val => ret = val} />);
            wrapper.find('.next-range-picker-panel-input-start-date input').simulate('focus');
            wrapper.find('.next-range-picker-panel-input-start-date input').simulate('change', { target: { value: '2017-11-05' } });
            wrapper.find('.next-range-picker-panel-input-start-date input').simulate('blur');
            assert(ret[0].format('YYYY-MM-DD') === '2017-11-05');
            assert(!ret[1]);
            wrapper.find('.next-range-picker-panel-input-end-date input').simulate('focus');
            wrapper.find('.next-range-picker-panel-input-end-date input').simulate('change', { target: { value: '2017-12-05' } });
            wrapper.find('.next-range-picker-panel-input-end-date input').simulate('blur');
            assert(ret[0].format('YYYY-MM-DD') === '2017-11-05');
            assert(ret[1].format('YYYY-MM-DD') === '2017-12-05');
            wrapper.find('.next-range-picker-panel-input-start-time input').simulate('focus');
            wrapper.find('.next-range-picker-panel-input-start-time input').simulate('change', { target: { value: '09:00:00' } });
            wrapper.find('.next-range-picker-panel-input-start-time input').simulate('blur');
            ...
            wrapper.find('.next-range-picker-panel-input-end-time input').simulate('change', { target: { value: '20:00:00' } });
        ...
        it('should select time panel', () => {
            let ret;
            wrapper = mount(<RangePicker showTime defaultVisible defaultValue={[startValue, endValue]} onChange={val => ret = val} />);
            wrapper.find('.next-range-picker-panel-input-start-time input').simulate('focus');
            wrapper.find('.next-range-picker-panel-time-start .next-time-picker-menu-hour .next-time-picker-menu-item').at(3).simulate('click');
            assert(ret[0].format('YYYY-MM-DD HH:mm:ss') === '2017-11-20 03:00:00');
            wrapper.find('.next-range-picker-panel-time-end .next-time-picker-menu-hour .next-time-picker-menu-item').at(3).simulate('click');
            assert(ret[1].format('YYYY-MM-DD HH:mm:ss') === '2017-12-15 03:00:00');
        });

        it('should set defaultValue for TimePicker', () => {
            let ret;
            wrapper = mount(<RangePicker showTime={{ defaultValue: defaultTimeValue }} defaultVisible defaultVisibleMonth={() => startValue} onChange={val => ret = val} />);
            wrapper.find('td[title="2017-11-09"] .next-calendar-date').simulate('click');
            assert(ret[0].format('YYYY-MM-DD HH:mm:ss') === '2017-11-09 09:00:00');
            wrapper.find('td[title="2017-12-09"] .next-calendar-date').at(1).simulate('click');
        ...
        it('should select a endDay less than the previous startDay', () => {
            let ret;
            wrapper = mount(<RangePicker defaultValue={[startValue, endValue]} defaultVisible onChange={val => ret = val} />);
            wrapper.find('.next-range-picker-panel-input-end-date input').simulate('focus');
        ...
        it('should select a startDay bigger than the previous endDay', () => {
            ...
            wrapper = mount(<RangePicker defaultValue={[startValue, endValue]} defaultVisible onChange={val => ret = val} />);
            wrapper.find('.next-range-picker-panel-input-start-date input').simulate('focus');
            wrapper.find('td[title="2017-12-30"] .next-calendar-date').simulate('click');
        ...
        it('should select endDate firstly', () => {
            let ret;
            wrapper = mount(<RangePicker defaultVisibleMonth={() => startValue} defaultVisible onChange={val => ret = val} />);
            wrapper.find('.next-range-picker-panel-input-end-date input').simulate('focus');
        ...
        it('should select time panel', () => {
            let ret;
            wrapper = mount(<RangePicker defaultValue={[startValue, endValue]} showTime defaultVisibleMonth={() => startValue} defaultVisible onChange={val => ret = val} />);
            wrapper.find('.next-date-picker-panel-footer .next-btn').at(0).simulate('click');
        ...
        it('should click onOk', () => {
            let ret;
            wrapper = mount(<RangePicker showTime defaultVisibleMonth={() => startValue} defaultVisible onOk={val => ret = val} />);
            wrapper.find('td[title="2017-11-09"] .next-calendar-date').simulate('click');
            wrapper.find('td[title="2017-11-11"] .next-calendar-date').simulate('click');
            wrapper.find('.next-date-picker-panel-footer .next-btn').at(1).simulate('click');
            assert(ret[0].format('YYYY-MM-DD HH:mm:ss') === '2017-11-09 00:00:00');
    ...
    describe('with date string', () => {
        it('should defaultValue as string', () => {
            ...
            assert(wrapper.find('.next-range-picker-trigger-input input').at(0).instance().value === '2017-11-11');
            assert(wrapper.find('.next-range-picker-trigger-input input').at(1).instance().value === '2017-11-12');
        });

        it('should value as string', () => {
            wrapper = mount(<RangePicker value={['2017-11-11', '2017-11-12']} />);
            wrapper.setProps({ value: ['2017-12-11', '2017-12-12'] });
            assert(wrapper.find('.next-range-picker-trigger-input input').at(0).instance().value === '2017-12-11');
            assert(wrapper.find('.next-range-picker-trigger-input input').at(1).instance().value === '2017-12-12');
        });
    });
});
