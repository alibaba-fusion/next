...
describe('Step', () => {
    describe('render', () => {
        it('should render with default props', () => {
            const wrapper = mount(<Step current={1}>
                <StepItem title="步骤1" />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);
        ...
        it('should render with element title', () => {
            ...
            assert(wrapper.find('.next-step-item-title').at(0).html() === '<div class="next-step-item-title"><span>测试</span></div>');
        });
        ...
        it('should render with element content', () => {
            ...
            assert(wrapper.find('.next-step-item-content').at(0).html() === '<div class="next-step-item-content"><span>测试</span></div>');
        });

        it('should render with diffrent types', () => {
            const wrapper = mount(<Step current={1} shape="arrow">
                <StepItem title="步骤1" />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);
            const wrapper2 = mount(<Step current={1} shape="dot">
                <StepItem title="步骤1" />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);
        ...
        it('should render with diffrent directions', () => {
            const wrapper = mount(<Step current={1} direction="vertical">
                <StepItem title="步骤1" />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);
            const wrapper2 = mount(<Step current={1} shape="dot" direction="vertical">
                <StepItem title="步骤1" />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);
            const wrapper3 = mount(<Step current={1} shape="arrow" direction="vertical">
                <StepItem title="步骤1" />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);
        ...
        it('should render with labelPlacement', () => {
            const wrapper = mount(<Step current={1} labelPlacement="vertical">
                <StepItem title="步骤1" />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);
            const wrapper2 = mount(<Step current={1} shape="dot" labelPlacement="horizontal">
                <StepItem title="步骤1" />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);
        ...
        it('should render with custom node ', () => {
            function itemRender(index, status) {
                return <div className="custom-node"><span>{index + 1}</span></div>;
            }

            const wrapper = mount(<Step current={1} itemRender={itemRender} >
                <StepItem title="步骤1" icon="atm" />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);
        ...
        it('should render with progress ', () => {
            const wrapper0 = mount(<Step current={1}>
                <StepItem title="步骤1" percent={40} />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);
            const wrapper2 = mount(<Step current={1}>
                <StepItem title="步骤1" icon="atm" percent={40} />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);
            const wrapper3 = mount(<Step current={1} shape="dot">
                <StepItem title="步骤1" percent={40} />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);
        ...
        it('should render step.item with itemRender', () => {
            ...
            const wrapper = mount(<Step current={2} animation={false} itemRender={itemRender} >
                {
    ...
    describe('action', () => {
        ...
        it('should click step node with transitionEnd', () => {
            const wrapper = mount(<Step current={1}>
             ...
             assert(wrapper.find('.next-step-item-node').at(2).instance().className === 'next-step-item-node clicked');
             
             wrapper.find('.next-step-item-node').at(2).simulate('transitionEnd');
             assert(wrapper.find('.next-step-item-node').at(2).instance().className === 'next-step-item-node');
        });
        ...
        it('should trigger click event', () => {
            ...
            let ret_2 = -1;
            const wrapper2 = mount(<Step current={1} direction="vertical">
                <StepItem title="步骤1" onClick={(index) => ret_2 = index} />
                <StepItem title="步骤2" />
                <StepItem title="步骤3" />
            </Step>);

            wrapper2.find('.next-step-item-first').find('.next-step-item-node-placeholder').simulate('click');
            assert(ret_2 === 0);
        });
    });
});
