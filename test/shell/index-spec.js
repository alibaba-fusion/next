...
class App extends React.Component {
    ...
    btnClick = () => {
     ...
     render() {
        ...
        return (<div>
             <Radio.Group id="shell-device" style={{marginBottom: '10px'}} onChange={this.onChange} defaultValue="desktop">
             ...
             <Shell className={"iframe-hack"} device={this.state.device} style={{border: '1px solid #eee'}}>
                ...
                <Shell.Navigation collapse={this.state.navcollapse} onCollapseChange={this.onCollapseChange}>
                    ...
                    <div id="custom-nav-trigger" style={{textAlign: 'center', background: '#eee'}} onClick={this.btnClick}>
