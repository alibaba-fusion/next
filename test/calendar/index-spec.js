...
describe('Calendar', () => {
    ...
    describe('action', () => {
        it('should change mode', () => {
            wrapper = mount(<Calendar />);
            wrapper.find('.next-radio-wrapper input').at(1).simulate('change', { target: { checked: true } });
...
describe('RangeCalendar', () => {
    ...
    describe('render', () => {
        ...
        it('should render with defaultStartValue & defaultEndValue', () => {
            wrapper = mount(<RangeCalendar defaultVisibleMonth={() => defaultVal} defaultStartValue={defaultVal} defaultEndValue={defaultVal.clone().add(1, 'months')} />);
            assert(wrapper.find('td[title="2017-10-01"]').hasClass('next-selected'));
        ...
        it('should render with controlled value', () => {
            wrapper = mount(<RangeCalendar defaultVisibleMonth={() => defaultVal} startValue={defaultVal} endValue={defaultVal.clone().add(1, 'months')} />);
            wrapper.setProps({
