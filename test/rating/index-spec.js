...
describe('Rating', () => {
    ...
    describe('action', () => {
        ...
        it('should allowClear={true} work', () => {
            ReactDOM.render(<Rating allowClear defaultValue={3} onChange={onChange} id="action-test-1" />, parent);
            rect = document.querySelectorAll('#action-test-1 .next-rating-icon')[0].getBoundingClientRect();
        ...
        it('should render readonly rating', () => {
            ReactDOM.render(<Rating value={3} readOnly onChange={onChange} id="action-test-6" />, parent);
            rect = document.querySelectorAll('#action-test-6 .next-rating-icon')[0].getBoundingClientRect();
        ...
        it('should support rtl in half mode', () => {
            const wrapper = mount(<Rating rtl allowHalf defaultValue={3} onChange={onChange} id="action-test-1" />);
            assert(wrapper.find('.next-rating').props().dir === 'rtl');
        });
    });
});
