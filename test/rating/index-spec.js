...
describe('Rating', () => {
    describe('render', () => {
        ...
        it('should render correct when value < min value', () => {
            ...
            assert(
                document.querySelectorAll(
                    '#render-test-0 .next-rating-overlay'
                )[0].style.width <= '4px'
            );
        });
        ...
        it('should render correct rating', () => {
            ...
            assert(
                document.querySelectorAll(
                    '#render-test-1 .next-rating-overlay'
                )[0].style.width === '64px'
            );
        });
        ...
        it('should render correct when value > count', () => {
            ...
            assert(
                parseInt(
                    document.querySelectorAll(
                        '#render-test-2 .next-rating-overlay'
                    )[0].style.width
                ) >= 104
            );
        });
    ...
    describe('action', () => {
        ...
        it('should be controlled ', () => {
            ReactDOM.render(
                <Rating value={3} onChange={onChange} id="action-test-0" />,
                parent
            );
            rect = document
                .querySelectorAll('#action-test-0')[0]
                .getBoundingClientRect();

            ReactTestUtils.Simulate.click(
                document.querySelectorAll(
                    '#action-test-0 .next-rating-base'
                )[0],
                {
                    pageX: rect.left + 8,
                    pageY: rect.top + 8,
            ...
            assert(
                document.querySelectorAll(
                    '#action-test-0 .next-rating-overlay'
                )[0].style.width === '64px'
            );
        });
        ...
        it('should trigger mouse event', done => {
            ...
            ReactTestUtils.Simulate.mouseOver(
                document.querySelectorAll(
                    '#action-test-2 .next-rating-base'
                )[0],
                {
                    pageX: rect.left + 8,
                    pageY: rect.top + 8,
            ...
            setTimeout(() => {
                ...
                assert(
                    document.querySelectorAll(
                        '#action-test-2 .next-rating-overlay'
                    )[0].style.width === '24px'
                );
                done();
            }, 200);
        ...
        it('should trigger mouse event when allow half', done => {
            ...
            ReactTestUtils.Simulate.mouseOver(
                document.querySelectorAll(
                    '#action-test-3 .next-rating-base'
                )[0],
                {
                    pageX: rect.left + 2,
                    pageY: rect.top + 8,
            ...
            setTimeout(() => {
                ...
                assert(
                    document.querySelectorAll(
                        '#action-test-3 .next-rating-overlay'
                    )[0].style.width === '12px'
                );
                done();
            }, 200);
        ...
        it('should trigger twice mouse over', done => {
            ReactDOM.render(
                <Rating defaultValue={3} id="action-test-4" />,
                parent
            );
            rect = document
            ...
            ReactTestUtils.Simulate.mouseOver(
                document.querySelectorAll(
                    '#action-test-4 .next-rating-base'
                )[0],
                {
                    pageX: rect.left + 4,
                    pageY: rect.top + 8,
            ...
            setTimeout(() => {
                assert(
                    document.querySelectorAll(
                        '#action-test-4 .next-rating-overlay'
                    )[0].style.width === '64px'
                );
                done();
            }, 300);
        ...
        it('should trigger mouse leave', done => {
            ...
            ReactTestUtils.Simulate.mouseOver(
                document.querySelectorAll(
                    '#action-test-5 .next-rating-base'
                )[0],
                {
                    pageX: rect.left + 4,
                    pageY: rect.top + 8,
            ...
            setTimeout(() => {
                ...
                assert(
                    document.querySelectorAll(
                        '#action-test-5 .next-rating-overlay'
                    )[0].style.width === '64px'
                );
                done();
            }, 100);
        ...
        it('should trigger mouse over', done => {
            ReactDOM.render(
                <Rating id="action-test-7" onHoverChange={onHoverChange} />,
                parent
            );
            rect = document
            ...
            ReactTestUtils.Simulate.mouseOver(
                document.querySelectorAll(
                    '#action-test-7 .next-rating-base'
                )[0],
                {
                    pageX: rect.left + 4,
                    pageY: rect.top + 8,
