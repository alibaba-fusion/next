...
describe('Checkbox.Group', () => {
    ...
    describe('[render] nest', () => {
        const wrapper = shallow(<CheckboxGroup value={['pear', 'watermelon']}>
                    <Checkbox id="apple" value="apple" className="apple">苹果</Checkbox>
                    <Checkbox id="pear" value="pear">梨子</Checkbox>
                    <Checkbox id="watermelon" value="watermelon">西瓜</Checkbox>
                </CheckboxGroup>).dive();
        ...
        it('should have two children with nest <Checkbox />', () => {
            const wrapper = mount(
                <CheckboxGroup value={['watermelon']}>
                    <Checkbox id="apple" value="apple" disabled>苹果</Checkbox>
                    <Checkbox id="pear" value="pear">梨子</Checkbox>
                    <Checkbox id="watermelon" value="watermelon">西瓜</Checkbox>
                </CheckboxGroup>
            );
