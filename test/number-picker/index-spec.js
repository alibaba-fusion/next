...
describe('number-picker', () => {
    describe('render', ()=> {
        ...
        it('should accept type ', () => {
            let wrapper = mount(<NumberPicker type="inline"/>)
    ...
    describe('behavior', () => {
        ...
        it('should support input with -/-0/-0./0./0.0 ', () => {
            const onChange = sinon.spy();
            let wrapper = mount(<NumberPicker defaultValue={0} onChange={onChange}/>);
        ...
        it('should accept disabled ', () => {
            let wrapper = mount(<NumberPicker defaultValue={0} disabled/>);
        ...
        it('should support editable', (done) => {
            let onChange = (value) => {
                assert(value === 20);
            }, wrapper = mount(<NumberPicker defaultValue={123} editable={true} onChange={onChange}/>);
        ...
        it('should support max & min', (done) => {
            let onChange = (value) => {
                assert(value === 20);
            }, wrapper = mount(<NumberPicker defaultValue={19} max={20} step={3} onChange={onChange}/>);
            ...
            let onChange2 = (value) => {
                assert(value === 18);
            }, wrapper2 = mount(<NumberPicker defaultValue={19} max={20} min={18} step={3} onChange={onChange2}/>);
        ...
        it('should support onCorrect', (done) => {
            ...
            let wrapper = mount(<NumberPicker defaultValue={1} min={1} max={3} onCorrect={onCorrect}/>);
        ...
        it('should support onKeyDown & onFocus & onBlur', (done) => {
            ...
            let wrapper2 = mount(<NumberPicker defaultValue={19} onChange={(value) => {
                assert(value === 18);
            }} />);
            wrapper2.find('input').simulate('keydown', {keyCode: 40});

            let wrapper3 = mount(<NumberPicker defaultValue={19} onChange={(value) => {
                assert(value === 19);
            }} />);
        ...
        it('should support e.triggerType ', (done) => {
            let upClicked = false, downClicked = false;
    ...
    describe('react api', () => {
        it('calls componentWillReceiveProps', (done) => {
            let wrapper = mount(<NumberPicker defaultValue={19} />);
