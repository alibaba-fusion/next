...
const defaultTrigger = <span className="triggerSpan" style={{margin: '5px'}}>trigger</span>;

describe('Balloon', () => {
    let defaultWrapper = null;

    beforeEach(function() {
        defaultWrapper = mount(<Balloon
            closable={false}
            type="normal"
    ...
    describe('safeNode', () => {
        it('safeNode', () => {
            function Demo(props) {
                return (<div>
                    <button id="safe" className="safeButton">safeButton</button>
                    <Balloon trigger={<span className="balloon">trigger</span>}
                                id="balloon"
                                safeNode="safe"
                                triggerType="click">
                        i am balloon content
    ...
    describe('onPosition', (done) => {
        it('should update on position updated', () => {
            const instance = defaultWrapper.find('Balloon').at(0).instance();
    ...
    describe('align', () => {
        it('balloon align', () => {
            ...
            //top
            const wrapperT = mount(<Balloon trigger={<span>trigger</span>}
                                           align="t"
                                           triggerType="click">
                i am balloon content
            </Balloon>);
            ...
            const wrapperTL = mount(<Balloon trigger={<span>trigger</span>}
                                              align="tl"
                                              triggerType="click">
                i am balloon content
            </Balloon>);
            ...
            const wrapperTR = mount(<Balloon trigger={<span>trigger</span>}
                                              align="tr"
                                              triggerType="click">
                i am balloon content
            </Balloon>);
            ...
            //bottom
            const wrapperB = mount(<Balloon trigger={<span>trigger</span>}
                                              align="b"
                                              triggerType="click">
                i am balloon content
            </Balloon>);
            ...
            const wrapperBL = mount(<Balloon trigger={<span>trigger</span>}
                                              align="bl"
                                              triggerType="click">
                i am balloon content
            </Balloon>);
            ...
            const wrapperBR = mount(<Balloon trigger={<span>trigger</span>}
                                              align="br"
                                              triggerType="click">
                i am balloon content
            </Balloon>);
            ...
            //left
            const wrapperL = mount(<Balloon trigger={<span>trigger</span>}
                                              align="l"
                                              triggerType="click">
                i am balloon content
            </Balloon>);
            ...
            const wrapperLT = mount(<Balloon trigger={<span>trigger</span>}
                                              align="lt"
                                              triggerType="click">
                i am balloon content
            </Balloon>);
            ...
            const wrapperLB = mount(<Balloon trigger={<span>trigger</span>}
                                              align="lb"
                                              triggerType="click">
                i am balloon content
            </Balloon>);
            ...
            //right
            const wrapperR = mount(<Balloon trigger={<span>trigger</span>}
                                              align="r"
                                              triggerType="click">
                i am balloon content
            </Balloon>);
            ...
            const wrapperRT = mount(<Balloon trigger={<span>trigger</span>}
                                              align="rt"
                                              triggerType="click">
                i am balloon content
            </Balloon>);
            ...
            const wrapperRB = mount(<Balloon trigger={<span>trigger</span>}
                                              align="rb"
                                              triggerType="click">
                i am balloon content
            </Balloon>);
    ...
    describe('onClose ComponentWillReceiveProps closeIcon', () => {
        it('onClose ComponentWillReceiveProps closeIcon', () => {
            ...
            class App extends React.Component {
                ...
                render() {
                    const visibleTrigger = <Button className="trigger-btn" type="primary">点击弹出卡片</Button>;

                    const content = (<div>
                        点击按钮操作<br/>
                        <a style={{right: 0}} onClick={this.hide.bind(this)}>确认</a>
                        <a style={{marginLeft: '4px'}} onClick={this.hide.bind(this)}>关闭</a>
                    </div>);
                    return (
                        <div>
            ...
            setTimeout(function() { //TODO:此处测试有问题,单测里,浮层关闭后overlay元素没有去掉
                assert(document.querySelector('.next-balloon') === null);
                // done();
            }, 1000);
