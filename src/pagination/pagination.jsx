...
class Pagination extends Component {
    static propTypes = {
         ...
         * 页码下拉框弹层挂载的容器节点
         */
        selectPopupContainer: PropTypes.any,
        /**
         * 弹层组件属性，透传给Popup
         */
    ...
    static defaultProps = {
        ...
        selectPopupContainer: node => node.parentNode,
    };
    ...
    renderPageSizeDropdown() {
        const { prefix, size, pageSizeList, selectPopupContainer, locale, popupProps } = this.props;
        const { currentPageSize } = this.state;
        ...
        return (
            <Select
                ...
                popupContainer={selectPopupContainer}
