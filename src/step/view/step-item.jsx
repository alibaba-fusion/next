...
class StepItem extends Component {
    ...
    getNode(args) {
        ...
        return (
            <div tabIndex="0" aria-current="step" {...others} style={this.getStyle()} className={stepCls} ref={this._refHandlerCreator('step')}>
                {finalNodeElement}
    ...
    render() {
        ...
        const arrowElement = (
            <div tabIndex="0" aria-current="step" {...others} style={this.getStyle()} className={stepCls} onClick={this.onClick}>
                <div className={`${prefix}step-item-container`}>
