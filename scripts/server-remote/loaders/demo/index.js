...
module.exports = function(content) {
    ...
    const { dir, lang, links, disableAnimation, componentName } = options;
    ...
    ejs.renderFile(demoTplPath, {
        ...
        if (err) {
            ...
            const htmlPath = replaceExt(path.relative(path.join(cwd, 'docs', componentName), this.resourcePath), '.html');
