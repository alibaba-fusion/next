...
function getLiveDemoOp(name, componentName) {
    const liveCodePen = `
    <Balloon.Tooltip
        align="b"
        style={{ maxWidth: 400 }}
...
function getDemoRenderScript(js, name, body, noImportJs, rawCss, rawImportJs, componentName) {
