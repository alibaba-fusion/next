...
| pageNumberRender | Custom page number rendering function, function for page number button and digital rendering of current page/total page count                                                                                                               | (index: number) => React.ReactNode                           | index =\> index |          |
