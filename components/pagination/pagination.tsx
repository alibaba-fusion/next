...
class Pagination extends Component<PaginationProps, PaginationState> {
    ...
    renderPageJump() {
        ...
        return [
            ...
            <Input
                ...
                type="text"
                aria-label={locale.inputAriaLabel as string}
                size={size}
                value={inputValue}
    ...
    renderPageList(current: number, totalPage: number) {
        ...
        if (totalPage <= pageShowCount) {
            ...
            const halfCount = Math.floor(othersCount / 2);
            let start, end;
    ...
    renderPageSizeDropdown() {
        ...
        return (
            <Select
                ...
                aria-label={locale.selectAriaLabel as string}
                autoWidth={false}
                size={size}
    ...
    render() {
        ...
        const buildComponent = (...coms: (React.JSX.Element | null)[]) => (
...
export default polyfill(Pagination);
