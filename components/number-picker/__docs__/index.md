...
| onChange          | 数值被改变的事件<br/><br/>**签名**:<br/>**参数**:<br/>_value_: 新的数值。<br/>_e_: DOM 事件对象。                                                  | (value: number \| string \| undefined, e: object) => void          | func.noop |          | -        |
| onKeyDown         | 键盘按下<br/><br/>**签名**:<br/>**参数**:<br/>_e_: DOM 事件对象。                                                                                  | (e: React.KeyboardEvent<HTMLInputElement>, ...args: any[]) => void | func.noop |          | -        |
| onFocus           | 焦点获得<br/><br/>**签名**:<br/>**参数**:<br/>_e_: DOM 事件对象。                                                                                  | (e: React.FocusEvent<HTMLInputElement>, ...args: any[]) => void    | -         |          | -        |
| onBlur            | 焦点失去<br/><br/>**签名**:<br/>**参数**:<br/>_e_: DOM 事件对象。                                                                                  | (e: React.FocusEvent<HTMLInputElement>, ...args: any[]) => void    | func.noop |          | -        |
| onCorrect         | 数值订正后的回调<br/><br/>**签名**:<br/>**参数**:<br/>_obj_: 包含 currentValue 和 oldValue 的对象。                                                | (obj: object) => void                                              | func.noop |          | -        |
...
| renderPreview     | 预览态模式下渲染的内容<br/><br/>**签名**:<br/>**参数**:<br/>_value_: 当前值。<br/>_props_: 传入的组件参数。<br/>**返回值**:<br/>Element 渲染内容。 | (value: number \| string, props: object) => React.ReactNode        | -         |          | -        |
| device            | 预设屏幕宽度                                                                                                                                       | 'phone' \| 'tablet' \| 'desktop'                                   | -         |          | -        |
| hasTrigger        | 是否展示点击按钮                                                                                                                                   | boolean                                                            | true      |          | -        |
| stringMode        | 开启大数支持，输入输出均为string类型                                                                                                               | boolean                                                            | false     |          | 1.24     |
| state             | 状态                                                                                                                                               | 'error' \| 'success' \| undefined                                  | -         |          | -        |
