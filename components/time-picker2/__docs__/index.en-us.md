...
| hasBorder           | Has border                                                                                                                   | boolean                                                                                                                                        | true          |          |
...
| disabledHours   | Disable hour function                                                 | (index?: number) => boolean \| number[]                | -             |          |
| disabledMinutes | Disable minute function                                               | (index?: number) => boolean \| number[]                | -             |          |
| disabledSeconds | Disable second function                                               | (index?: number) => boolean \| number[]                | -             |          |
| onChange        | Callback when the time value changes                                  | (value: ValueType) => void                             | -             |          |
| preset          | Preset value, will be displayed below the time panel                  | PresetType \| PresetType[]                             | -             |          |
...
| preset       | Preset value, will be displayed below the time panel                  | PresetType[]                   | -             |          |
