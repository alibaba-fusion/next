...
| locale               | Customized internationalized text                                                                                                                                                                                                                                                               | {<br/> ok: string;<br/> cancel: string;<br/> }                                     | -                                      |          | -                 |
...
| closeIcon            | [v2] Customize the close button icon                                                                                                                                                                                                                                                            | React.ReactNode                                                                    | -                                      |          | 1.25              |
| width                | [v2] Dialog width                                                                                                                                                                                                                                                                               | string \| number                                                                   | -                                      |          | 1.25              |
