...
| locale               | 自定义国际化文案对象                                                                                                                                                             | {<br/> ok: string;<br/> cancel: string;<br/> }                                     | -                                      |          | -        |
| height               | 对话框的高度样式属性                                                                                                                                                             | string \| number                                                                   | -                                      |          | -        |
| popupContainer       | 自定义弹窗挂载位置                                                                                                                                                               | string \| HTMLElement \| ((target?: HTMLElement) => HTMLElement)                   | -                                      |          | -        |
| v2                   | 开启 v2 版本弹窗                                                                                                                                                                 | boolean                                                                            | false                                  |          | -        |
| closeIcon            | [v2] 定制关闭按钮 icon                                                                                                                                                           | React.ReactNode                                                                    | -                                      |          | 1.25     |
| width                | [v2] 弹窗宽度 v2 生效                                                                                                                                                            | string \| number                                                                   | -                                      |          | 1.25     |
