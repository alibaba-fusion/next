...
describe('Submit', () => {
    ...
    it('Submit && validate: minmaxLengthMessage', () => {
        ...
        cy.get('input#first').type('1');
        cy.get('.next-form-item-help:first-of-type').should('have.text', 'min length is 10');
        cy.get('button').click();
    });
