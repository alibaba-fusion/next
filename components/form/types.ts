...
import { Spacing } from '../responsive-grid/types';
...
export interface ItemProps extends React.HTMLAttributes<HTMLElement>, CommonProps {
     ...
     */
    children?: React.ReactNode | ((values: FieldValues) => void);
     ...
     */
    requiredTrigger?: string | Array<unknown>;
     ...
     */
    minmaxTrigger?: string | Array<unknown>;
     ...
     */
    minmaxLengthTrigger?: string | Array<unknown>;
     ...
     */
    lengthTrigger?: string | Array<unknown>;
     ...
     */
    patternTrigger?: string | Array<unknown>;
     ...
     */
    formatTrigger?: string | Array<unknown>;
     ...
     */
    validatorTrigger?: string | Array<unknown>;
...
export interface SubmitProps extends ButtonProps {
     ...
     * @params value - 数据 - data
     * @params errors - 错误数据 - errors data
     * @params field - 实例 - instance
     * @defaultValue func.noop
     */
    onClick?: (value?: unknown, errors?: unknown, field?: unknown) => void;

    /**
     * 是否校验/需要校验的 name 数组
     * @en Is the name array of the check/need to check
     */
    validate?: boolean | Array<unknown>;
...
type HTMLAttributesWeak = Omit<React.FormHTMLAttributes<HTMLElement>, 'onChange'>;
...
export interface FormProps extends CommonProps, HTMLAttributesWeak {
     ...
     */
    field?: boolean | NextField | Field | null;
     ...
     * @defaultValue func.noop
     */
    saveField?: (field?: Field | null) => void;
     ...
     * @param item - 表单项 - form item
     * @param item.name - 发生变化的组件的名称 - The name of the component that changed。
     * @param item.value - 变化的组件的新数据 - The new data of the changed component。
     * @param item.field - 与变化的组件关联的 field 实例 - The field instance associated with the changed component。
     */
    onChange?: (
