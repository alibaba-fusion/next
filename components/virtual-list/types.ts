...
type itemsRendererRefTarget<T> =
    | T
    | Element
    | React.ReactElement
    | ConfiguredComponent<unknown, unknown>
...
export interface VirtualListProps extends React.HTMLAttributes<HTMLElement>, CommonProps {
     ...
     */
    itemsRenderer?: <T>(
        items: Array<itemsRendererRefTarget<T>>,
        ref: (instance: itemsRendererRefTarget<T>) => itemsRendererRefTarget<T>
    ) => React.ReactNode;
