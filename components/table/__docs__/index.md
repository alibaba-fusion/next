...
| filterParams          | 当前过滤的 keys，使用此属性可以控制表格的头部的过滤选项中哪个菜单被选中，格式为 \{dataIndex: \{selectedKeys:[]\}\}                                                                                     | { [propName: string]: { selectedKeys?: string[]; visible?: boolean } } \| null                                                                                                                                                                                                                                                                                                                                      | -                            |          | -        |
| sort                  | 当前排序的字段，使用此属性可以控制表格的字段的排序，格式为\{dataIndex: 'asc'\}                                                                                                                         | { [key: string]: SortOrder } \| null                                                                                                                                                                                                                                                                                                                                                                                | -                            |          | -        |
...
| openRowKeys           | 展开的行，传入后展开状态只受此属性控制                                                                                                                                                                 | Array\<string \| number \| null> \| null                                                                                                                                                                                                                                                                                                                                                                            | -                            |          | -        |
| defaultOpenRowKeys    | 默认展开的行                                                                                                                                                                                           | Array\<string \| number \| null>                                                                                                                                                                                                                                                                                                                                                                                    | -                            |          | 1.23.22  |
| hasExpandedRowCtrl    | 是否显示点击展开额外渲染行的 + 号按钮                                                                                                                                                                  | boolean                                                                                                                                                                                                                                                                                                                                                                                                             | true                         |          | -        |
| getExpandedColProps   | 设置额外的列属性                                                                                                                                                                                       | (<br/> record: RecordItem,<br/> index: number<br/> ) =><br/> \| (React.DetailedHTMLProps\<React.HTMLAttributes\<HTMLSpanElement>, HTMLSpanElement> & {<br/> disabled?: boolean;<br/> })<br/> \| void                                                                                                                                                                                                                | -                            |          | -        |
...
| colSpan         | header cell 横跨的格数，设置为 0 表示不出现此 th                                                              | number \| string                                                                                       | -                              |          | -        |
...
| --------------------- | ------------------- | ----------------------------------- | ------ | -------- |
| className             | 自定义类名          | string                              | -      |          |
| value                 | 赋给这个 cell 的值  | unknown                             | -      |          |
| record                | 当前行的值          | RecordItem                          | -      |          |
| colIndex              | 当前列的索引        | number                              | -      |          |
| rowIndex              | 当前行的索引        | number                              | -      |          |
| style                 | 自定义内联样式      | React.CSSProperties                 | -      |          |
| expandedIndexSimulate | 参考 Table 中的说明 | TableProps['expandedIndexSimulate'] | -      |          |
| primaryKey            | 参考 Table 中的说明 | TableProps['primaryKey']            | -      |          |
| rowSpan               | 跨越的行数          | number                              | -      |          |
...
| ------------ | ---------------------- | ------------------------------------------------------------------- | ------ | -------- |
| className    | 自定义类名             | string                                                              | -      |          |
| rowIndex     | 当前行的索引           | number                                                              | -      | 是       |
| onClick      | 当前行被点击时的回调   | (record: RecordItem, rowIndex: number, e: React.MouseEvent) => void | -      | 是       |
| onMouseEnter | 鼠标进入当前行时的回调 | (record: RecordItem, rowIndex: number, e: React.MouseEvent) => void | -      | 是       |
| onMouseLeave | 鼠标离开当前行时的回调 | (record: RecordItem, rowIndex: number, e: React.MouseEvent) => void | -      | 是       |
| record       | 当前行的值             | RecordItem                                                          | -      | 是       |

### RowSelection

| 参数            | 说明                                                                                                                   | 类型                                                                                                             | 默认值     | 是否必填 |
| --------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------- | -------- |
| getProps        | 获取 selection 的默认属性                                                                                              | (<br/> record: RecordItem,<br/> index: number<br/> ) => CheckboxProps \| RadioProps \| void \| undefined \| null | -          |          |
...
RecordItem 也可能是单纯 string 的情况，但考虑到这样业务的适配成本比较高，因此这里不加入
