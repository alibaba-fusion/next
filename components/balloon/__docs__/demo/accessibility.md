...
const App = () => (
    <div className="container nested">
        <Balloon v2 id="inner-a11y-balloon-1" autoFocus trigger={<Button type="primary">Fill in sub-form</Button>} popupContainer={(trigger) => trigger.parentNode} triggerType="click">
        ...
        <Balloon v2 id="a11y-balloon" type="primary" autoFocus trigger={innerButton} triggerType="click">
            <Balloon v2 id="inner-a11y-balloon" autoFocus trigger={<Button type="primary">Fill in sub-form</Button>} popupContainer={(trigger) => trigger.parentNode} triggerType="click">
                please input your age:
