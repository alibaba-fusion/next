...
export class TreeNode extends Component<NodeProps, NodeState> {
    ...
    handleSelect(e: React.MouseEvent) {
        ...
        // @ts-expect-error e is not compatible with root.handleSelect
    ...
    addCallbacks(props: { [key: string]: unknown }) {
    ...
    renderLabel() {
        ...
        return (
            // @ts-expect-error labelWrapperProps.tabIndex above should be number type
            <div
    ...
    addAnimationIfNeeded(node: React.JSX.Element) {
        ...
        return root && root.props.animation ? (
            // @ts-expect-error animationAppear does not exist in Expand
    ...
    render() {
        ...
        return this.addAnimationIfNeeded(
            <li role="presentation" className={newClassName} {...others}>
                {/* @ts-expect-error aria-label and style should be undefined */}
                <div
                    ref={this.saveRef}
                    role="treeitem"
