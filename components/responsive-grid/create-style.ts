...
import type { ResponsiveGridProps, Spacing } from './types';

type StyleType = { [key: string]: unknown };
...
const filterOuterStyle = (style: StyleType) => {
    const props: StyleType = {};
...
const filterHelperStyle = (style: StyleType) => {
    const props: StyleType = {};
...
const filterInnerStyle = (style: StyleType) => {
    const props: StyleType = {};
