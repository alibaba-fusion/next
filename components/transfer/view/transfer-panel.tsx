...
import { PositionType, TransferDataItem, TransferPanelProps, TransferPanelState } from '../types';
...
export default class TransferPanel extends Component<TransferPanelProps, TransferPanelState> {
    ...
    getListDOM(ref: unknown) {
        this.list = ref as HTMLDivElement;
    }
    ...
    renderSearch() {
        ...
        return (
            <Search
                ...
                placeholder={searchPlaceholder || (locale!.searchPlaceholder as string)}
    ...
    renderList(dataSource: TransferDataItem[]) {
        ...
        const newClassName = cx({
            ...
            [listClassName as string]: !!listClassName,
        });
